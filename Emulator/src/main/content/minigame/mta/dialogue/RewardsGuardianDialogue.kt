...
class RewardsGuardianDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            1 -> options("Who are you?", "Can I trade my Pizazz Points please?", "Got anything else I can buy?").also { stage++ }
            2 -> when (buttonId) {
            ...
            3 -> npc(FaceAnim.OLD_NORMAL, "Me? I'm here to grant you rewards for any of the", "Pizazz Points you may have earned in this training", "arena. Like my fellow Guardians, I am part of the", "arena and live to ensure its safe running.").also { stage++ }
            ...
            7 -> npc(FaceAnim.OLD_NORMAL, "Well, we do stock a special book that you may be", "interested in, which provides a comprehensive guide to", "this training arena. It costs 200gp. Would like", "one?").also { stage++ }
            8 -> {
                end()
