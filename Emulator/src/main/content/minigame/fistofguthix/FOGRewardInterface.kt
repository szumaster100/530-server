...
class FOGRewardInterface : InterfaceListener {
    ...
    override fun defineInterfaceListeners() {
        on(732) { player, _, opcode, button, _, _ ->
            ...
            when (button) {
                ...
                else -> log(this::class.java, Log.WARN, "Unhandled button ID for FOG interface: $button").also {
                    return@on true
                }
            }
    ...
    private fun handlePurchase(player: Player, stock: ShopItem, opcode: Int) {
