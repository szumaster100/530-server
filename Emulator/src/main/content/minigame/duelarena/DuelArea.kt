...
@JvmOverloads constructor(
    ...
    override fun startDeath(entity: Entity, killer: Entity): Boolean {
        if (entity is Player) {
            val k =
                if (killer is Player) killer.asPlayer() else if (killer is content.global.skill.summoning.familiar.Familiar) killer.owner else null
            if (k != null) {
    ...
    companion object {
        ...
        private val FIGHT_OPTION = Option("Fight", 0).setHandler(
