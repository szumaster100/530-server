...
@Initializable
class BountyHunterActivity @JvmOverloads constructor(val type: CraterType = CraterType.LOW_LEVEL) :
    ActivityPlugin("BH " + type.name.lowercase(Locale.getDefault()), false, false, false, ZoneRestriction.FOLLOWERS) {
