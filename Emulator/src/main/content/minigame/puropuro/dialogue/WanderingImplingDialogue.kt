...
class WanderingImplingDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npc(FaceAnim.OLD_DEFAULT, "We want things you people want. They are tasty to us!", "The more you want them, the tastier they are!").also { stage++ }
            ...
            8 -> npc(FaceAnim.OLD_DEFAULT, "Don't do that! That would be cruel. But chase us, yes!", "That is good. Implings that are not easy to catch. Especially", "ones with tasty food.").also { stage = END_DIALOGUE }
        }
        return true
    }
