...
class FairyAerykaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            20 -> npc(FaceAnim.OLD_DEFAULT, "Well, no-one know for sure. The mischievous little", "creatures are probably related to imps. And they fly as", "well.").also { stage++ }
            21 -> npc(FaceAnim.OLD_DEFAULT, "Also, like imps, they love collecting things. I'm not sure", "why, though. They also seem to like being chased.").also { stage++ }
            22 -> player("So how would I get hold of what they are carrying,", "then?").also { stage++ }
            23 -> npc(FaceAnim.OLD_DEFAULT, "Catch them, I suppose I don't know really. Why would", "you want to?").also { stage = END_DIALOGUE }
            30 -> npc(FaceAnim.OLD_DEFAULT, "Really? You humans like that stuff a lot, don't you? I", "don't like really old stuff myself.").also { stage = END_DIALOGUE }
