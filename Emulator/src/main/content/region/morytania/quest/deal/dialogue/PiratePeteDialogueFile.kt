...
class PiratePeteDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            7 -> npc(FaceAnim.SAD, "I am a poor, dispossessed nobleman, forced by", "circumstance to lurk in the middle of nowhere, soliciting", "help from passers-by.").also { stage++ }
            8 -> npc(FaceAnim.SAD, "You see, my fiendish half-brother has seized my estates", "and forced me into exile.").also { stage++ }
            9 -> npc(FaceAnim.SAD, "The simple lemon farmers suffer under his tyrannous", "yoke, and only a brave adventurer can lift his iron boot", "from the neck of the poor.").also { stage++ }
            10 -> npc(FaceAnim.SAD, "To reclaim my lands I will need to have my family", "sword returned to me so that I may present it as proof", "of my rulership.").also { stage++ }
            ...
            17 -> npc(FaceAnim.SAD, "But, alas, my half brother has a powerful ally, the", "mighty demon...").also { stage++ }
            18 -> npc(FaceAnim.SUSPICIOUS, "Err...").also { stage++ }
            19 -> npc(FaceAnim.SUSPICIOUS, "Err...Barrelor!").also { stage++ }
            20 -> npc(FaceAnim.SAD, "Yes, the mighty, fearsome, tall, deadly, oaken, round", "demon Barrelor the Destroyer.").also { stage++ }
            21 -> player(FaceAnim.HALF_ASKING, "Barrelor?").also { stage++ }
            22 -> npc(FaceAnim.ANGRY, "That's what I said!").also { stage++ }
            23 -> npc(FaceAnim.SAD, "Barrelor is an awesome opponent, and to reclaim my", "family sword you will need to defeat him, for he guards", "it within the deadly Trapped Pit of Barrelor.").also { stage++ }
            ...
            28 -> npc(FaceAnim.HAPPY, "When I am reinstated in my rightful place, I will not", "be a very wealthy man, as my half-brother has", "squandered my family fortune.").also { stage++ }
            29 -> npc(FaceAnim.HAPPY, "However, I will gladly give you every bent penny of", "what is left, and starve in the gutter with my many,", "adorable children, if you say you will help me.").also { stage++ }
