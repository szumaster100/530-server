...
class InSearchOfTheMyreque :
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        if (stage >= 2) {
            ...
            line(player, "and answering a guards questions I eventually found the group called !!the Myreque??.", line++, stage >= 1)
            line(player, "However, it seems that I was tricked by Vanstrom who turned out to be a vampyre following me to the Myreque's hideout.", line++, stage >= 1)
        ...
        if (stage >= 3) {
            ...
            line(player, "and I feel that I better understand the reason for the darkness of Morytania.", line++, stage >= 1)
