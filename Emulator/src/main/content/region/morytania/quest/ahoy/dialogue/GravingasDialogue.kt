...
class GravingasDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (questStage) {
            ...
            in 2..10 -> when (stage) {
                0 ->
                    if (!inInventory(player!!, Items.PETITION_FORM_4283) && getAttribute(player!!, GhostsAhoyUtils.petitionstart, false)) {
                        ...
                        npc("Not doing too badly I see! You need ${getAttribute(player!!, GhostsAhoyUtils.petitionsigns, score.toString())} more signature's.").also { stage++ }
