...
class RufusDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FaceAnim.DISGUSTED, "What? Why, what else would you want to eat? What", "kind of lycanthrrope are you anyway?").also { stage++ }
            ...
            7 -> npc(FaceAnim.EVIL_LAUGH, "Cooked food? Who would want that? You lose all the", "flavourrr of the meat when you can't taste the blood!").also { stage = END_DIALOGUE }
