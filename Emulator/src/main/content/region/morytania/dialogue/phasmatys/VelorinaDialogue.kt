...
class VelorinaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when {
            isQuestComplete(player, Quests.GHOSTS_AHOY) -> options("I thought you were going to pass over to the next world.", "Can I have another Ectophial?")

            !isQuestComplete(player, Quests.GHOSTS_AHOY) -> openDialogue(player, VelorinaDialogueFile())
