...
class CatapultRoom : MapZone("wg catapult", true), Plugin<Any> {
    ...
    private enum class CatapultAttack(val graphicId: Int, val objectId: Int, val success: Animation, val fail: Animation) {
        ...
        SLASHING_BLADES(graphicId = 681, objectId = 15620, success = Animation.create(4170), fail = Animation.create(4174)),
        MAGIC_MISSILE(graphicId = 682, objectId = 15618, success = Animation.create(4171), fail = Animation.create(4175));
    }
