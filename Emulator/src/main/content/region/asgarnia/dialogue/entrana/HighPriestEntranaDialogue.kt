...
class HighPriestEntranaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    private fun hasSilverPot(): Boolean {
        val silverPots = listOf(
            Items.SILVER_POT_4658, Items.SILVER_POT_4660, Items.SILVER_POT_4662,
            Items.SILVER_POT_4664, Items.SILVER_POT_4666
        )
        return silverPots.any { inInventory(player, it) }
    }

    private fun handleBlessing() {
        val silverToBlessedMap = mapOf(
