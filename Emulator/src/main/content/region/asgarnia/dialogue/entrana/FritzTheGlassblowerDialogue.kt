...
class FritzTheGlassblowerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            112 -> npc(FaceAnim.HALF_GUILTY, "I guess you've never heard of a rhetorical question", "then. I'll make it simple for you. You bring glass, me", "pay shiny gold coins.").also { stage = END_DIALOGUE }
            120 -> npc(FaceAnim.HALF_GUILTY, "Oh.").also { stage++ }
            121 -> npc(FaceAnim.HALF_GUILTY, "...errr, well should you get any I'm quite happy to pay", "for it. Remember, I'll pay you 20 gold pieces for each", "piece of molten glass you get for me.").also { stage = END_DIALOGUE }
        }
        return true
    }
