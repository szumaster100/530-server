        ...
        when (quest!!.getStage(player)) {
            100 -> {
                ...
                if (player.getSavedData().questData.getDragonSlayerAttribute("ship")) {
                    npc(FaceAnim.NEUTRAL, "Hello, captain! Here to inspect your new ship? Just a", "little work and she'll be seaworthy again.")
                    stage = 400
                    return true
                }
                npc(FaceAnim.NEUTRAL, "So, are you interested in buying the Lady Lumbridge?", "Now, I'll be straight with you: she's not quite seaworthy", "right now, but give her a bit of work and she'll be the", "nippiest ship this side of Port Khazard.")
                stage = 1
            }
        }
        return true
            ...
            20 -> when (stage) {
                ...
                11 -> {
                    ...
                    2 -> when (buttonId) {
                        ...
                        3 -> player(FaceAnim.HALF_GUILTY, "Ah, well, never mind.").also { stage = END_DIALOGUE }
                    }
                    ...
                    23 -> npc(FaceAnim.NEUTRAL, "but once she's patched up, she'll be good as new!").also {
                        stage = END_DIALOGUE
                    }
