...
class LordDaquariusDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            14 -> player.dialogueInterpreter.sendDialogues(
                NPCs.SAVANT_2748,
                FaceAnim.NEUTRAL,
                "${player.username}?",
            ...
            16 -> player.dialogueInterpreter.sendDialogues(
                NPCs.SAVANT_2748,
                FaceAnim.NEUTRAL,
            ...
            27 -> player.dialogueInterpreter.sendDialogues(
                NPCs.SAVANT_2748,
                FaceAnim.NEUTRAL,
            ...
            29 -> player.dialogueInterpreter.sendDialogues(
                NPCs.SAVANT_2748,
                FaceAnim.NEUTRAL,
            ...
            33 -> player.dialogueInterpreter.sendDialogues(
                NPCs.SAVANT_2748,
                FaceAnim.NEUTRAL,
