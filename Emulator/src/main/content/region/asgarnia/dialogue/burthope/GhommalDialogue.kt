...
class GhommalDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npc(FaceAnim.HALF_GUILTY, "Heehee... he say he warrior... I not heard that one", "for... at leas' 5 minutes!").also { stage++ }
            2 -> player(FaceAnim.HALF_GUILTY, "Go on, let me in, you know you want to. I could...", "make it worth your while...").also { stage++ }
            3 -> npc(FaceAnim.HALF_GUILTY, "No! You is not a strong warrior, you not enter till you", "bigger, Ghommal does not takes bribes.").also { stage++ }
            4 -> npc(FaceAnim.HALF_GUILTY, "Ghommal stick to Warrior's Code of Honour. When", "you a bigger, stronger warriror, you come back.").also { stage = END_DIALOGUE }
