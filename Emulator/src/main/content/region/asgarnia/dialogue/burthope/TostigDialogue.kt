...
class TostigDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npcl(FaceAnim.FRIENDLY, "Well ${if (player.isMale) "mister" else "miss"}, our speciality is Asgarnian Ale, we also serve Wizard's Mind Bomb and Dwarven Stout.").also { stage++ }
            ...
            21 -> showTopics(Topic(FaceAnim.FRIENDLY, "Huh?", 30), Topic(FaceAnim.FRIENDLY, "Yes, and the black cat dances in the sink.", 40), Topic(FaceAnim.FRIENDLY, "No, squirrels can't sing.", 50))
