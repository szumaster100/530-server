        ...
        when (stage) {
            ...
            8 -> {
                if (freeSlots(player) < 1) {
                    playerl(FaceAnim.NEUTRAL, "I don't have enough space in my backpack right this second.").also { stage = END_DIALOGUE }
            ...
            9 -> npc(FaceAnim.FRIENDLY, "We are expert guides that take adventurers such as", "yourself, on mountaineering expeditions.").also { stage = END_DIALOGUE }
            10 -> npcl(FaceAnim.FRIENDLY, "I used to take adventurers up Death Plateau and further north before the trolls came. I know these mountains well.").also { stage = END_DIALOGUE }
            11 -> npcl(FaceAnim.FRIENDLY, "Thanks, I built it myself! I'm usually self sufficient but I can't earn any money with the trolls camped on Death Plateau,").also { stage = END_DIALOGUE }
