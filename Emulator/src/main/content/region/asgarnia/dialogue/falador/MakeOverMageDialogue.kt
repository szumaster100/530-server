...
class MakeOverMageDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        npc = args[0] as NPC
        if (args.size == 2) {
            npc(FaceAnim.HALF_ASKING, "Hmm... you didn't feel any unexpected growths", "anywhere around your head just then did you?").also { stage = 600 }
            return true
        }
        npc(FaceAnim.HAPPY, "Hello there! I am known as the make-over mage! I", "have spent many years researching magics that can", "change your physical appearance!").also { stage = 0 }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            0 -> npc(FaceAnim.HAPPY, "I can alter your physical form for a small fee of", "only 3000 gold coins! Would you like me to perform my", "magics upon you?").also { stage++ }
            ...
            10 -> npc(FaceAnim.HAPPY, "Why, of course! Basically, and I will try and explain", "this so that you will understand it correctly,").also { stage++ }
            11 -> npc(FaceAnim.FRIENDLY, "I use my secret magical technique to melt your body", "down into a puddle of its elements.").also { stage++ }
            12 -> npc(FaceAnim.FRIENDLY, "When I have broken down all trace of your body, I", "then rebuild it into the form I am thinking of.").also { stage++ }
            ...
            15 -> npc(FaceAnim.LAUGH, "It's as safe as houses! Why, I have only had thirty-six", "major accidents this month!").also { stage++ }
            ...
            20 -> npc(FaceAnim.HAPPY, "You of course agree that if by some accident you", "are turned into a frog you have no rights for", "compensation or refund.").also { stage = 25 }
            ...
            40 -> npc(FaceAnim.HAPPY, "No problem, but please remember that the amulet I will", "sell you is only a copy of my own. It contains no", "magical powers; and as such will only cost you 100", "coins.").also { stage++ }
            ...
            400 -> npc(FaceAnim.HALF_GUILTY, "That's fair enough, my jewellery is not to everyone's", "taste.").also { stage = END_DIALOGUE }
