...
class SirReniteeDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            100 -> npc(FaceAnim.HALF_GUILTY, "Hmm, well, mmm, do you have a family crest? I keep", "track of every " + ServerConfig.SERVER_NAME + " family, you know, so I might", "be able to find yours.").also { stage = 110 }
            110 -> npc(FaceAnim.HALF_GUILTY, "I'm also something of an, mmm, a painter. If you've", "met any important persons or visited any nice places I", "could paint them for you.").also { stage = 120 }
            ...
            230 ->
                if (getStatLevel(player, Skills.CONSTRUCTION) >= 16) {
                    if (getAttribute(player, "sir-renitee-assigned-crest", false)) {
                        npc(FaceAnim.HALF_GUILTY, "According to my records, your crest is the symbol of ", "${
                    ...
                    npc(FaceAnim.HALF_GUILTY, "First thing's first, young " + (if (player.appearance.isMale) "man" else "woman") + "! There is not much point", "in having a family crest if you cannot display it.").also { stage = 235 }
                }
            235 -> npc(FaceAnim.HALF_GUILTY, "You should train construction until you can build a wall", "decoration in your dining room.").also { stage = END_DIALOGUE }
            240 -> options("I don't like that crest. Can I have a different one?", "Thanks!").also { stage = 250 }
            250 -> when (buttonId) {
                1 -> player(FaceAnim.HALF_GUILTY, "I don't like that crest. Can I have a different one?").also {
                    stage = 300
                }
                2 -> player(FaceAnim.HALF_GUILTY, "Thanks!").also { stage = 260 }
            }
            260 -> npc(FaceAnim.HALF_GUILTY, "You're welcome, my " + (if (player.appearance.isMale) "boy." else "girl.")).also { stage = END_DIALOGUE }
            300 -> npc(FaceAnim.HALF_GUILTY, "Mmm, very well. Changing your crest will cost", "5,000 coins.").also { stage++ }
            301 ->
                if (amountInInventory(player, Items.COINS_995) < 5000) {
                    ...
                    npc(FaceAnim.HALF_GUILTY, "There are sixteen different symbols; which one would", "you like?").also { stage = 310 }
                }
            ...
            320 -> when (buttonId) {
                1 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Ah yes, the shield that you helped to retrieve. You have certainly earned the right to wear its symbol.")
                    } else {
                        npcl(FaceAnim.HALF_GUILTY, "But that legendary shield is still lost! I don't think it would be proper for you to wear its symbol.").also { stage = 310 }
                    }
                }
                2 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Ah, splendid, splendid. There is no better symbol than that of our fair land!")
                    } else {
                ...
                3 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Ah yes, our new neighbours under Lumbridge. I hear you were the one who made contact with them, jolly good.")
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "Hmm, have you ever even met the Dorgeshuun? I don't", "think you should wear their symbol until you have", "made contact with that lost tribe.").also { stage = 310 }
                    }
                }
                4 -> {
                    val c = Crests.DRAGON
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "I see you are a mighty dragon-slayer! You have certainly earned the right to wear a dragon symbol.")
                    } else {
                        npcl(FaceAnim.HALF_GUILTY, "When the dragon on Crandor Isle remains undefeated? I think you should prove yourself a dragon-slayer before you can wear a dragon symbol!").also { stage = 310 }
                    }
                }
            ...
            330 -> when (buttonId) {
                1 -> {
                    val c = Crests.FAIRY
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(
                            player,
                ...
                2 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Guthix, god of balance! I'm a Saradominist myself, you know, but we all find meaning in our own way, what?")
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "You do not seem to be very devoted to any god.", "I will not let you have a divine symbol", "unless you have level 70 prayer.").also { stage = 310 }
                    }
                }
                ...
                3 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npc(FaceAnim.HALF_GUILTY, "Hmm, I'm not sure I like that HAM group, their beliefs are", "a little extreme for me. But if that's what you want.")
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "[MISSING DIALOGUE - NOT ELIGIBLE]").also { stage = 310 }
                    }
                }
                ...
                4 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Ah, I see you've brought a toy horse for me to see. An interesting beast. Certainly you can use that as your crest if you like, although it seems a bit strange to me.")
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "A horse? I know people talk about them, but I'm not at all sure", "they ever existed. I don't think I could let you use as", "your symbol unless you can fetch me some kind of model of one.").also { stage = 310 }
                    }
                }
            ...
            340 -> when (buttonId) {
                ...
                4 -> npc(FaceAnim.HALF_GUILTY, "You wish to represent yourself by a moneybag?", "I think to make that meaningful I should increase", "the price to 500,000 coins. Do you agree?").also { stage = 341 }
            ...
            350 -> when (buttonId) {
                1 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npcl(FaceAnim.HALF_GUILTY, "Ah, the great god Saradomin! May he smile on your house as you adorn it with his symbol!")
                ...
                2 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npc(FaceAnim.HALF_GUILTY, "Of, of course you can have a skull symbol, " + (if (player.appearance.isMale) "sir!" else "madam!"))
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "A symbol of death? You do not seem like a killer to me;", "perhaps some other symbol would suit you better.").also { stage = 310 }
                    }
                }
                ...
                4 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))
                        ...
                        npc(FaceAnim.HALF_GUILTY, "The god of Chaos? It is a terrible thing to worship", "that evil being. But if that is what you wish...")
                    } else {
                        npc(FaceAnim.HALF_GUILTY, "You do not seem to be very devoted to any god.", "I will not let you have a divine symbol", "unless you have level 70 prayer.").also { stage = 310 }
                    }
                }
            ...
            500 -> npc(FaceAnim.ASKING, "Would you like a portrait or an, mmm, a landscape?", "Or a map, maybe?").also { stage++ }
            501 -> options("a portrait", "a landscape", "a map").also { stage++ }
            502 -> when (buttonId) {
                1 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, well, there are a few portraits I can paint. I can only let you have one if you've got some connection with that person though. Who would you like?").also { stage++ }
                2 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, well, I can paint a few places. Where have you had your adventures?").also { stage = 514 }
                3 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, yes, ah, I have painted maps of the known world on several different sizes of parchment. you like?").also { stage = 526 }
            }
            ...
            504 -> when (buttonId) {
                1 -> {
                    if (!hasRequirement(player, Quests.HOLY_GRAIL, false)) {
                        npcl(FaceAnim.HALF_GUILTY, "Do you have, mmm, a connection with King Arthur? He wouldn't like me to just give his picture to anyone.")
                ...
                2 -> {
                    if (!isQuestComplete(player, Quests.PLAGUE_CITY)) {
                        npcl(FaceAnim.HALF_GUILTY, "The last I heard, Elena was, mmm, trapped in West Ardougne. I wouldn't feel right selling her portrait while she was in danger.")
                        sendMessage(player, "To buy the portrait of Elena you must have completed the ${Quests.PLAGUE_CITY} quest.")
                        stage = 700
                    } else {
            ...
            515 -> when (buttonId) {
                1 -> {
                    if (!isQuestComplete(player, Quests.COOKS_ASSISTANT) || !isQuestComplete(player, Quests.RUNE_MYSTERIES) || !isQuestComplete(player, Quests.THE_RESTLESS_GHOST)) {
                        npcl(FaceAnim.HALF_GUILTY, "Mmm, I'm not sure you've had enough adventures in Lumbridge to deserve a painting of it.")
                ...
                2 -> {
                    if (!isQuestComplete(player, Quests.THE_TOURIST_TRAP) || !hasRequirement(player, Quests.THE_FEUD, false) || !isQuestComplete(player, Quests.THE_GOLEM)) {
                        npcl(FaceAnim.HALF_GUILTY, "Mmm, I'm not sure you've had enough adventures in the desert to deserve a painting of it.")
                ...
                3 -> {
                    if (!isQuestComplete(player, Quests.CREATURE_OF_FENKENSTRAIN) || !hasRequirement(player, Quests.SHADES_OF_MORTTON, false) || !isQuestComplete(player, Quests.GHOSTS_AHOY) || !hasRequirement(player, Quests.HAUNTED_MINE, false)) {
                        npcl(FaceAnim.HALF_GUILTY, "Mmm, I'm not sure you've had enough adventures in Morytania to deserve a painting of it.")
                ...
                4 -> {
                    if (!isQuestComplete(player, Quests.PIRATES_TREASURE) || !hasRequirement(player, Quests.TAI_BWO_WANNAI_TRIO, false) || !hasRequirement(player, Quests.SHILO_VILLAGE, false)) {
                        npcl(FaceAnim.HALF_GUILTY, "Mmm, I'm not sure you've had enough adventures in Karamja to deserve a painting of it.")
                ...
                5 -> {
                    if (!isQuestComplete(player, Quests.ROVING_ELVES)) {
                        npcl(FaceAnim.HALF_GUILTY, "Mmm, I'm not sure you've had enough adventures in Isafdar to deserve a painting of it.")
            ...
            601 -> when (buttonId) {
                1 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, well, there are a few portraits I can paint. I can only let you have one if you've got some connection with that person though. Who would you like?").also { stage = 503 }
                2 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, well, I can paint a few places. Where have you had your adventures?").also { stage = 514 }
                3 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, yes, ah, I have painted maps of the known world on several different sizes of parchment. you like?").also { stage = 526 }
                4 -> npcl(FaceAnim.HALF_GUILTY, "Mmm, well, see you some other time maybe.").also { stage = END_DIALOGUE }
            }
