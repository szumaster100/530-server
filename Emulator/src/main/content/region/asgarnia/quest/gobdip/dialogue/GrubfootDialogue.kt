...
class GrubfootDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when (quest!!.getStage(player)) {
            ...
            20 -> npc(FaceAnim.OLD_NORMAL, "Me not like this orange armour. Make me look like that", "thing.").also { stage = 0 }
            else -> npc(FaceAnim.OLD_NORMAL, "Grubfoot wear red armour! Grubfoot wear green", "armour!").also { stage = 0 }
        }
        return true
    }
