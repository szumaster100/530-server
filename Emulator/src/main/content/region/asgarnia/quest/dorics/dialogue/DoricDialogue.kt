...
class DoricDialogue(private val questStage: Int) : DialogueFile() {
    ...
    private fun handleQuestStartDialogue(player: Player?, isWhetstone: Boolean) {
        ...
        when (stage) {
            ...
            40 -> npc(FaceAnim.OLD_NORMAL, "Clay is what I use more than anything, to make casts.", "Could you get me 6 clay, 4 copper ore, and 2 iron ore,", "please? I could pay a little, and let you use my anvils.", "Take this pickaxe with you just in case you need it.").also { stage++ }
            ...
            100 -> npcl(FaceAnim.OLD_NORMAL, "That is your choice. Nice to meet you anyway.").also {
                stage = END_DIALOGUE
            }
        }
    }
    ...
    private fun handleGiveDoricItemsDialogue(player: Player?) {
        ...
        when (stage) {
            ...
            1 -> {
                if (inInventory(player, Items.CLAY_434, 6) && inInventory(
                        player,
