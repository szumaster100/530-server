    ...
    override fun create(b: DialogueBuilder) {
        b
            ...
            .let { optionBuilder ->
                ...
                optionBuilder
                    .option_playerl("Who are all those people in there?")
                ...
                optionBuilder
                    .option_playerl("Is there any way I can get the rank of master thief?")
                    ...
                    .npcl(
                        "Well, some of the MOST coveted prizes in thiefdom right now are in the pirate town of Brimhaven on Karamja.",
        ...
        b
            ...
            .npcl(
                "Some of the MOST coveted prizes in thiefdom right now are in the pirate town of Brimhaven on Karamja.",
            ).npcl("The pirate leader Scarface Pete has a pair of extremely valuable candlesticks.")
            .npcl("His security is VERY good.")
            .npcl("We, of course, have gang members in a town like Brimhaven who may be able to help you.")
            .npcl("Visit our hideout in the alleyway on palm street.")
                ...
                branch
                    ...
                    .let { optionBuilder ->
                        optionBuilder
                            ...
                            .end()
                        optionBuilder
                            .option("I have a candlestick now.")
