        ...
        when (getQuestStage(player!!, Quests.DEATH_PLATEAU)) {
            21 -> {
                when (stage) {
                    ...
                    2 -> playerl(FaceAnim.FRIENDLY, "Tenzing has asked me to bring you his climbing boots, he needs to have spikes put on them.").also { stage++ }

                    3 -> npcl(FaceAnim.FRIENDLY, "He does, does he? Well I won't do it till he pays for the last set I made for him!").also { stage++ }

                    4 -> playerl(FaceAnim.FRIENDLY, "This is really important!").also { stage++ }
                    5 -> npcl(FaceAnim.FRIENDLY, "How so?").also { stage++ }
                    6 -> playerl(FaceAnim.FRIENDLY, "Well, I need the Sherpa to show me a secret way up Death Plateau so that the Imperial Guard can destroy the troll camp! He won't help me till I've got the spikes!").also { stage++ }

                    7 -> npcl(FaceAnim.FRIENDLY, "Hmm. That's different!").also { stage++ }
                    8 -> npcl(FaceAnim.FRIENDLY, "Tell you what, I'll make them for you on one condition.").also { stage++ }

                    9 -> playerl(FaceAnim.FRIENDLY, "*sigh* What's the condition?").also { stage++ }
                    10 -> npcl(FaceAnim.FRIENDLY, "My son has just turned 16 and I'd very much like him to join the Imperial Guard. The Prince's elite forces are invite only so it's very unlikely he'll get in. If you can arrange that you have a deal!").also { stage++ }

                    11 -> playerl(FaceAnim.FRIENDLY, "That won't be a problem as I'm helping out the Imperial Guard!").also { stage++ }

                    12 -> npcl(FaceAnim.FRIENDLY, "Excellent! You'll need to bring an Iron bar for the spikes!").also {
            ...
            22 -> {
                when (stage) {
                    START_DIALOGUE -> playerl(FaceAnim.FRIENDLY, "Hi!").also { stage++ }
                    1 -> npcl(FaceAnim.FRIENDLY, "Have you managed to get my son signed up for the Imperial Guard?").also { stage++ }

                    2 -> playerl(FaceAnim.FRIENDLY, "Not yet! I just need to speak to Denulth!").also {
                        stage = END_DIALOGUE
                    }
                }
            }
            ...
            23 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.FRIENDLY, "Good but I need to have the certificate.").also {
                        stage = END_DIALOGUE
                    }

                    5 -> npcl(FaceAnim.FRIENDLY, "Thank you!").also {
            ...
            24 -> {
                when (stage) {
                    ...
                    5 -> playerl(FaceAnim.FRIENDLY, "I don't have the iron bar or the climbing boots.").also {
                        stage = END_DIALOGUE
                    }

                    7 -> sendDoubleItemDialogue(
                        player!!,
                        Items.IRON_BAR_2351,
                    ...
                    10 -> npcl(FaceAnim.FRIENDLY, "No problem.").also {
