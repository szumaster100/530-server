        ...
        when (getQuestStage(player!!, Quests.DEATH_PLATEAU)) {
            in 5..9 -> {
                when (stage) {
                    ...
                    13 -> player(FaceAnim.FRIENDLY, "Thanks!").also {
                        setQuestStage(player!!, Quests.DEATH_PLATEAU, 10)
                        content.region.asgarnia.quest.death.dialogue.HaroldDialogueFile.Companion.resetNpc(player!!)
                        stage = END_DIALOGUE
                    }
            ...
            10 -> {
                when (stage) {
                    ...
                    10 -> npc(FaceAnim.FRIENDLY, "Harold is staying at the Toad and Chicken.").also {
                        stage = END_DIALOGUE
                    }
            ...
            11 -> {
                when (stage) {
                    ...
                    4 -> playerl(FaceAnim.FRIENDLY, "Thanks, I'll try that!").also {
