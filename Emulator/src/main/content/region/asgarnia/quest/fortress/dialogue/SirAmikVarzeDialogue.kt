    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            100 -> when (stage) {
                ...
                0 ->
                    if (isQuestComplete(player!!, Quests.BLACK_KNIGHTS_FORTRESS) && isQuestComplete(
                            player!!,
                            Quests.DRUIDIC_RITUAL
                        ) && getQuestStage(player, Quests.RECRUITMENT_DRIVE) == 0
                    ) {
                        playerl(FaceAnim.THINKING, "Do you have any other quests for me to do?").also { stage = 112 }
                ...
                109 -> npc("So am I, young ${if (player!!.isMale) "man" else "woman"}.", "So am I.").also { stage = 0 }
            ...
            10 -> when (stage) {
                ...
                2 ->
                    if (!player.inventory.containsItem(Item(Items.DOSSIER_9589)) && !player.bank.containsItem(Item(Items.DOSSIER_9589))) {
            ...
            0 -> when (stage) {
                ...
                1 -> when (buttonId) {
                    ...
                    2 -> player(FaceAnim.NEUTRAL, "I don't I'm just looking around.").also { stage = END_DIALOGUE }
                }
                ...
                13 -> npc(FaceAnim.NEUTRAL, "Come see me again if you change your mind.").also { stage = END_DIALOGUE }
                14 -> end()
                15 -> npc(FaceAnim.NEUTRAL, "Well that's good. Don't get too overconfident though.").also { stage++ }
                16 -> npc(
                    FaceAnim.NEUTRAL,
                ...
                29 -> npc(FaceAnim.NEUTRAL, "Come see me again if you change your mind.").also { stage = END_DIALOGUE }
                30 -> end()
                31 -> npc(
                    FaceAnim.NEUTRAL,
            ...
            else -> sendDialogue(player, "Sir Amik Varze is not interested in talking right now.").also {
                stage = END_DIALOGUE
            }
        }
        return true
