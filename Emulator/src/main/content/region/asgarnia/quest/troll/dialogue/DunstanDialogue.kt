        ...
        when (getQuestStage(player!!, Quests.TROLL_STRONGHOLD)) {
            in 1..10 -> {
                when (stage) {
                    ...
                    2 -> npcl(FaceAnim.FRIENDLY, "Please hurry! Who knows what they will do to him? Is there anything I can do in the meantime?").also { stage++ }
            ...
            11 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.FRIENDLY, "I have very little to offer you by way of thanks, but perhaps you will accept these family heirlooms. They were found by my great-great-grandfather, but we still don't have any idea what they do.").also { stage++ }
