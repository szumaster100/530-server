    ...
    class StikkletrixDialogue : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                ...
                2 -> player(FaceAnim.NEUTRAL, "Let's see what he has in his pack: three unfinished", "Strength potions, two burnt lobsters, a guam leaf with a", "footprint on it...").also { stage++ }
