...
public class WolfWhistle extends Quest {
    ...
    public void drawJournal(Player player, int stage) {
        ...
        switch (stage) {
            case 0:
                line(player, BLUE + "I can begin this quest by talking to " + RED + "Pikkupstix" + BLUE + ", who lives in", 5 + 7);
                line(player, RED + "Taverley</col>.", 6 + 7);
                break;
            case 10:
    ...
    public int[] getConfig(Player player, int stage) {
        int val = getVarp(player, Vars.VARP_QUEST_WOLF_WHISTLE_PROGRESS_1178);
