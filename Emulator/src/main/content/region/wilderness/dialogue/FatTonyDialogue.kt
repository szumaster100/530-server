...
class FatTonyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npc(FaceAnim.HALF_GUILTY, "Well, I'm an outlaw. I was accused of giving the king food", "poisoning!").also { stage++ }
            7 -> npc(FaceAnim.HALF_GUILTY, "The thought of it! I think he just drank too much wine", "that night.").also { stage++ }
            8 -> npc(FaceAnim.HALF_GUILTY, "I had to flee the kingdom of Misthalin. The bandits", "give me refuge here as long as I cook for them.").also { stage = 4 }
            9 -> npc(FaceAnim.HALF_GUILTY, "Well, this pizza is really meant to be for the bandits.", "I guess I could sell you some pizza bases though.").also { stage++ }
