                    ...
                    override fun handle(componentID: Int, buttonID: Int) {
                        ...
                        when (stage) {
                            0 -> {
                                ...
                                npcl(FaceAnim.HALF_ASKING, "I'll give you ${jewellery.price * invAmount} coins each for that ${getItemName(used.id)}. Do we have a deal?").also { stage++ }
                            }
                            ...
                            3 -> {
                                if (invAmount >= 10000) {
                                    ...
                                    npcl(FaceAnim.FRIENDLY, "Whoa, that's quite a bit of jewellery you've got there! Please try to keep it in amounts smaller than 10000. Big numbers make my head hurt.")
                                    ...
                                    npcl(FaceAnim.FRIENDLY, "It was a pleasure doing business with you. Come back if you have more jewellery to sell.")
                                } else {
                                    end()
                                    npcl(FaceAnim.HALF_ASKING, "Sorry, but I don't deal with those. I only trade unenchanted gold jewellery, nothing else. Bring notes if you like, but I prefer the real deal.")
                                }
                            }
                        }
                    }
