        ...
        on(Items.BARBARIAN_SKILLS_11340, IntType.ITEM, "read") { player, _ ->
            val guideType = when {
                ...
                getAttribute(player, BarbarianTraining.FISHING_FULL, false) ->
                    ...
                    ) GuideType.FISH_FM_FULL else GuideType.FISH_FULL
                ...
                getAttribute(player, BarbarianTraining.FM_FULL, false) ->
                    ...
                    ) GuideType.PS_FULL else GuideType.FM_FULL
                ...
                getAttribute(player, BarbarianTraining.HERBLORE_FULL, false) ->
                    ...
                    ) GuideType.FISH_FM_H_FULL else GuideType.H_FULL
                ...
                getAttribute(player, BarbarianTraining.SPEAR_BASE, false) ->
                    ...
                    ) GuideType.SMITH_M_REQS else GuideType.SMITH_N_REQS
                ...
                getAttribute(player, BarbarianTraining.SPEAR_FULL, false) ->
                    ...
                    ) GuideType.SMITH_H_BASE else GuideType.SMITH_S_FULL
...
enum class GuideType {
    ...
    FM_BASE, FM_FULL,
    H_BASE, H_FULL,
    FISH_FM_FULL, FISH_FM_H_FULL,
    SMITH_N_REQS, SMITH_M_REQS, SMITH_S_FULL,
    SMITH_H_BASE, SMITH_H_FULL,
    PS_BASE, PS_FULL,
    BARE_H_BASE, BARE_H_FULL,
    DEFAULT
}