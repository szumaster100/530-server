...
class SquireDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when {
            getAttribute(player, KnightWaveAttributes.KW_BEGIN, false) -> npc("Good day, my lord. Is there anything I can do", "for you?").also { stage = 14 }
            getAttribute(player, KnightWaveAttributes.KW_COMPLETE, false) -> npc("Congratulations on succeeding in the Knight Waves,", "${if (!player.isMale) "my lady" else "my lord"}.").also { stage = 29 }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npc(FaceAnim.HAPPY, "That door leads to the training ground for the Knights", "of the Round Table.").also { stage++ }
            ...
            30 -> npcl(FaceAnim.NEUTRAL, "I'm afraid not. Once you have won, you cannot re-enter.").also { stage = END_DIALOGUE }
        }
        return true
    }
