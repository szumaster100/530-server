        ...
        when {
            ...
            questStage == 30 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.OLD_NORMAL, "They caught me spying on the stronghold. They beat and tortured me.").also { stage++ }
                    2 -> npcl(FaceAnim.OLD_NORMAL, "But I didn't crack. I told them nothing. They can't break me!").also { stage++ }
            ...
            questStage >= 40 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.OLD_NORMAL, "When will this battle end? I feel like I've been locked up my whole life.").also { stage = END_DIALOGUE }
                }
            }
            ...
            questStage > 30 -> {
                if (inInventory(player!!, Items.ORB_OF_PROTECTION_587)) {
                    when (stage) {
                        ...
                        1 -> npcl(FaceAnim.OLD_NORMAL, "Now we have the orb I'm much better. Soon my comrades will come and free me.").also { stage = END_DIALOGUE }
                    }
                } else {
                    when (stage) {
