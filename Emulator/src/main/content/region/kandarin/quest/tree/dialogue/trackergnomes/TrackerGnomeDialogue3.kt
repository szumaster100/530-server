        ...
        when {
            ...
            questStage == 30 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.OLD_NORMAL, "You can't see me, no one can. Monsters, demons, they're all around me!").also { stage++ }
                    ...
                    7 -> playerl(FaceAnim.HALF_ASKING, "Do you have the coordinate for the Khazard stronghold?").also { stage++ }
            ...
            questStage == 31 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.OLD_NORMAL, "Don't talk to me, you can't see me. No one can, just the demons.").also { stage = END_DIALOGUE }
                }
            }
            ...
            questStage > 31 -> {
                when (stage) {
                    ...
                    1 -> npcl(FaceAnim.OLD_NORMAL, "I feel dizzy, where am I? Oh dear, oh dear I need some rest.").also { stage++ }
