        ...
        when {
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) && followLocation == "exit" -> {
                when (stage) {
                    ...
                    6 -> npcl(FaceAnim.OLD_NORMAL, "Here we are. Please don't lose the orb!").also {
                        stage = END_DIALOGUE
                    }
                }
            }
            ...
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) || questStage == 100 -> {
                when (stage) {
                    ...
                    10 -> npcl(FaceAnim.OLD_NORMAL, "Here we are. Feel free to have a look around.").also {
                        stage = END_DIALOGUE
                    }
                }
            }
            ...
            questStage in 1..39 -> {
                when (stage) {
                    ...
                    7 -> npcl(FaceAnim.OLD_NORMAL, "Here we are. I hope you get the orb back soon.").also {
                        stage = END_DIALOGUE
                    }
                }
            }
