    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (tracker1 && tracker2 && tracker3) {
            ...
            when (stage) {
                ...
                2 -> playerl("I've got no hope of hitting the stronghold without knowing any of the coordinates. Maybe I should ask Montai's tracker gnomes for more coordinates.").also {
                    stage = END_DIALOGUE
                }
            }
        }
