        ...
        when (questStage) {
            0 -> {
                when (stage) {
                    ...
                    3 -> when (buttonID) {
                        ...
                        2 -> playerl(FaceAnim.FRIENDLY, "Sorry! I'm too busy to hear your problems!").also {
                            stage = END_DIALOGUE
                        }
                    }
            ...
            10 -> {
                when (stage) {
                    ...
                    32 -> npcl(FaceAnim.SAD, "*yawn*..I'm off to bed! Farewell brave traveller!").also {
            ...
            20 -> {
                when (stage) {
                    ...
                    997 -> npcl(FaceAnim.NEUTRAL, "Of course, but we need the wine first.").also {
                        stage = END_DIALOGUE
                    }

                    42 -> npcl(FaceAnim.FRIENDLY, "Oh, he won't be far. Probably out in the forest.").also { stage++ }
                    43 -> playerl(FaceAnim.FRIENDLY, "Ok, I'll go and find him.").also {
            ...
            30 -> {
                when (stage) {
                    ...
                    52 -> npcl(FaceAnim.FRIENDLY, "Well, keep looking, we need that wine!").also {
                        stage = END_DIALOGUE
                    }
                }
            }
            ...
            40 -> {
                when (stage) {
                    ...
                    61 -> npcl(FaceAnim.FRIENDLY, "Well, try your best to get him back here!").also {
                        stage = END_DIALOGUE
                    }
                }
            }
