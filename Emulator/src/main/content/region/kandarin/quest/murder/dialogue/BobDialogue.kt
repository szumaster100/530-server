    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when (questStage) {
            in 1..4 -> when (stage) {
                ...
                3 -> npcl(FaceAnim.ANGRY, "I don't really care as long as no one thinks it's me. Maybe it was that strange poison seller who headed towards the seers village.").also { stage = END_DIALOGUE }
                ...
                7 -> npcl(FaceAnim.ANNOYED, "It's some $threadColor thread. I suppose you think that's some kind of clue? It looks like the material my trousers are made of.").also { stage = END_DIALOGUE }
                8 -> npcl(FaceAnim.HALF_GUILTY, "What's it to you anyway?").also { stage++ }
                9 -> npcl(FaceAnim.ANGRY, "If you absolutely must know, we had a problem with the beehive in the garden, and as all of our servants are so pathetically useless, I decided I would deal with it myself. So I did.").also { stage++ }
                10 -> {
                    end()
            ...
            100 -> when (stage) {
                0 -> npcl(FaceAnim.HALF_GUILTY, "Apparently you aren't as stupid as you look.").also {
                    stage = END_DIALOGUE
                }
            }
        }
