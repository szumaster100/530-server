...
object MurderMysteryUtils {
    ...
    val EVIDENCE_ITEMS_2 = intArrayOf(
    ...
    val GUILTY_NPC_PRINT_ITEMS = intArrayOf(
    ...
    val MANSION_OBJECTS = intArrayOf(
    ...
    val CRIME_SCENE_OBJECTS = intArrayOf(
