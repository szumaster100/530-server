    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when (questStage) {
            in 1..4 -> when (stage) {
                ...
                3 -> npcl(FaceAnim.NEUTRAL, "Could have been anyone. The old man was an idiot. He's been asking for it for years.").also { stage = END_DIALOGUE }
                4 -> npcl(FaceAnim.NEUTRAL, "I was out.").also { stage++ }
                5 -> playerl(FaceAnim.ASKING, "Care to be any more specific?").also { stage++ }
                6 -> npcl(FaceAnim.NEUTRAL, "Not really. I don't have to justify myself to the likes of you, you know. I know the King personally you know. Now are we finished here?").also { stage = END_DIALOGUE }
                7 -> npcl(FaceAnim.THINKING, "It's some thread. You're not very good at this whole investigation thing are you?").also { stage = END_DIALOGUE }
                8 -> npcl(FaceAnim.NEUTRAL, "There was a nest of mosquitos under the fountain in the garden, which I killed with poison the other day. You can see for yourself if you're capable of managing that, which I somehow doubt.").also { stage++ }
