...
class KentDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when {
            ...
            getQuestStage(player, Quests.SEA_SLUG) < 15 -> npc("Oh thank Saradomin! I thought I'd be left out here", "forever.").also { stage = 0 }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FaceAnim.HALF_GUILTY, "Five days ago we pulled in a huge catch. As well as fish", "we caught small slug like creatures, hundreds of them.").also { stage++ }
            4 -> npc(FaceAnim.HALF_GUILTY, "That's when the fishermen began to act strange.").also { stage++ }
            5 -> npc(FaceAnim.HALF_GUILTY, "It was the sea slugs, they attack themselves to your", "body and somehow take over the mind of the carrier.").also { stage++ }
            6 -> npc(FaceAnim.HALF_GUILTY, "I told Kennith to hide until I returned but I was", "washed up here.").also { stage++ }
            7 -> npc(FaceAnim.HALF_GUILTY, "Please go back and get my boy, you can send help for", "me later.").also { stage++ }
            8 -> npc(FaceAnim.SCARED, "${player.username} wait!").also {
            ...
            203 -> npcl(FaceAnim.FRIENDLY, "Play it down if you will. It was a truly brave thing you did.").also { stage++ }
            204 -> player(FaceAnim.FRIENDLY, "I only did what anyone would have done in my position. I have to go now, take care.").also { stage++ }
