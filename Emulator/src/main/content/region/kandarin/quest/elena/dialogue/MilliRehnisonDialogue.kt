    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            ...
            in 10..98 -> when (stage) {
                ...
                2 -> npcl(FaceAnim.CHILD_NORMAL, "I wish you luck, she did a lot for us.").also { stage = END_DIALOGUE }
            }

            in 99..100 -> when (stage) {
                1 -> playerl(FaceAnim.FRIENDLY, "Yes, she is safe at home now.").also { stage++ }
                2 -> npcl(FaceAnim.CHILD_NORMAL, "That's good to hear, she helped us a lot.").also {
                    stage = END_DIALOGUE
                }
            }
        }
