    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            ...
            9 -> when (stage) {
                1 -> npcl(
                    FaceAnim.FRIENDLY,
                    "Yes she was staying here, but slightly over a week ago she was getting ready to go back."
                ).also { stage++ }

                2 -> npcl(
                    FaceAnim.FRIENDLY,
                    "However she never managed to leave. My daughter Milli was playing near the west wall when she saw some shadowy figures jump out and grab her. Milli is upstairs if you wish to speak to her."
            ...
            in 99..100 -> when (stage) {
                ...
                2 -> npcl(FaceAnim.FRIENDLY, "That's good to hear, she helped us a lot.").also { stage = END_DIALOGUE }
            }
        }
        return true
    }
