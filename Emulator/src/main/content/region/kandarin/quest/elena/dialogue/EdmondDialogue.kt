...
import content.region.kandarin.quest.elena.PlagueCityListener
import content.region.kandarin.quest.elena.UndergroundCutscene
import core.api.*
        ...
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            0 -> when (stage) {
                ...
                5 -> when (buttonID) {
                    ...
                    2 -> playerl(FaceAnim.FRIENDLY, "Well, good luck finding her.").also { stage = END_DIALOGUE }
                }
            ...
            1 -> when (stage) {
                ...
                6 -> npcl(FaceAnim.NEUTRAL, "Take them to my wife Alrena, she's inside.").also { stage = END_DIALOGUE }
            }
            ...
            99 -> when (stage) {
                1 -> npcl(FaceAnim.NEUTRAL, "Thank you, thank you! Elena beat you back by minutes.").also { stage++ }
                2 -> npcl(
                    FaceAnim.NEUTRAL,
