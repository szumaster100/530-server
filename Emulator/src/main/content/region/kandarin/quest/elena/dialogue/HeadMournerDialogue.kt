    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (getQuestStage(player!!, Quests.PLAGUE_CITY)) {
            ...
            11 -> when (stage) {
                ...
                3 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "But I think a kidnap victim is in here.").also { stage = 5 }
            ...
            in 13..16 -> when (stage) {
                ...
                18 -> npcl(FaceAnim.FRIENDLY, "You're wasting my time, I have a lot of work to do!").also {
                    stage = END_DIALOGUE
                }
            }
