    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, Quests.TOWER_OF_LIFE)) {
            ...
            2 -> when (stage) {
                ...
                5 -> npcl(FaceAnim.FRIENDLY, "How many nails does it take to make a rocking chair?").also { stage++ }
                ...
                8 -> npcl(FaceAnim.FRIENDLY, "One? How do you suppose to use a single nail?").also {
                    stage = END_DIALOGUE
                }
