        ...
        when (getQuestStage(player!!, Quests.TOWER_OF_LIFE)) {
            7 -> when (stage) {
                ...
                18 -> when (buttonID) {
                    ...
                    2 -> playerl(FaceAnim.FRIENDLY, "With the help of the magical dragonstones!").also { stage++ }
                    3 -> playerl(
                        FaceAnim.FRIENDLY,
                        "By ignition of gas in their belly as they exhale."
                    ).also { stage++ }
                ...
                20 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "Runecraft, enchant jewellery, perform alchemy.").also { stage++ }
                ...
                24 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "I'm not really much of a traveller, sorry.").also { stage++ }
                ...
                30 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "Perhaps. I've never seen it myself, though.").also { stage++ }

                    2 -> playerl(FaceAnim.FRIENDLY, "Yep, you can use the Telekinetic Grab spell.").also { stage++ }

                    3 -> playerl(FaceAnim.FRIENDLY, "Sure. Use your brain to tell someone to move it!").also { stage++ }
                }
                ...
                32 -> when (buttonID) {
                    ...
                    3 -> playerl(FaceAnim.FRIENDLY, "It's a simple case of combining materials.").also { stage++ }
                }
                ...
                40 -> when (buttonID) {
                    ...
                    3 -> playerl(FaceAnim.FRIENDLY, "Your very existence speaks of mystical forces.").also { stage++ }
                }
            ...
            8 -> when (stage) {
                ...
                3 -> npcl(FaceAnim.OLD_NORMAL, "Please, alchemists you speak, me appear to surprise.").also { stage++ }
                4 -> playerl(
                    FaceAnim.FRIENDLY,
