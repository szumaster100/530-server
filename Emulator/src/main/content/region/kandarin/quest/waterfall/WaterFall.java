...
import content.region.kandarin.quest.waterfall.dialogue.WaterfallTreeDialogue;
...
public class WaterFall extends Quest {
    ...
    public WaterFall() {
        super(Quests.WATERFALL_QUEST, 65, 64, 1, Vars.VARP_QUEST_WATERFALL_PROGRESS_65, 0, 1, 10);
    }
    ...
    public void finish(Player player) {
        ...
        player.getInventory().add(new Item(1601, 2));
        player.getInventory().add(new Item(2357, 2));
        player.getInventory().add(new Item(299, 40));
    ...
    public Quest newInstance(Object object) {
        ClassScanner.definePlugins(new GolrieDialogue(), new HadleyDialogue(), new HudonDialogue(), new WaterfallPlugin(), new WaterfallTreeDialogue());
        return this;
    }
