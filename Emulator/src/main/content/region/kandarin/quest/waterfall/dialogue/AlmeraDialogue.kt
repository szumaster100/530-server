        ...
        when (stage) {
            0 ->
                if (quest.getStage(player) == 0) {
                    npc(FaceAnim.ASKING, "Ah, hello there. Nice to see an outsider for a change,", "are you busy? I have a problem.")
                    stage = 1
            ...
            3 -> {
                npc(FaceAnim.DISGUSTED, "It's my son Hudon, he's always getting into trouble, the", "boy's convinced there's hidden treasure in the river and", "I'm a bit worried about his safety, the poor lad can't", "even swim.")
                stage = 4
            }
            ...
            5 -> {
                npc(FaceAnim.DISGUSTED, "Would you? You are kind. You can use the small raft", "out back if you wish, do be careful, the current down", "stream is very strong.")
                quest.start(player)
                stage = 100
            }

            6 -> {
                npc(FaceAnim.HALF_GUILTY, "Perhaps you can speak to Hadley a further bit down", "south for more information on how to find the treasure.")
                stage = 100
            }
            ...
            8 -> {
                npc(FaceAnim.HALF_GUILTY, "Ah, very well done, adventurer!", "My boy Hudon was searching for that treasure too.")
                stage = 9
            }
            ...
            203 -> {
                npc(FaceAnim.HALF_GUILTY, "Yes he told me, the foolish lad came in drenched to the", "bone, he had fallen into the waterfall, lucky he wasn't", "killed! Now he can spend the rest of the summer in his", "room.")
                stage = 204
            }
