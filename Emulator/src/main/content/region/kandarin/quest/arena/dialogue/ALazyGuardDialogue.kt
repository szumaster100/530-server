    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (getQuestStage(player!!, Quests.FIGHT_ARENA)) {
            in 40..49 -> when (stage) {
                ...
                2 -> npcl(FaceAnim.DRUNK, "Have you come to laugh at the fight slaves? I used to really enjoy it, but after a while they become quite boring. ").also { stage++ }
            ...
            in 50..67 -> when (stage) {
                0 -> {
                    if (!allInEquipment(player!!, Items.KHAZARD_HELMET_74, Items.KHAZARD_ARMOUR_75) && !inInventory(player!!, Items.KHALI_BREW_77)
                        ...
                        npcl(FaceAnim.DRUNK, "Go away. Thish areash resh... restricted! We don't like strangersh, 'specially ones who sway. Oooh!").also { stage = END_DIALOGUE }
                ...
                5 -> npcl(FaceAnim.DRUNK, "Blimey this stuff is pretty good. It's not too strong is it?").also { stage++ }
                ...
                10 -> npcl(FaceAnim.DRUNK, "Yeesshh, hiccup! Oooh, maybe I sshould relax for a while.").also { stage++ }
                11 -> playerl(FaceAnim.NEUTRAL, "Good idea. I'll look after the prisoners.").also { stage++ }
                12 -> npcl(FaceAnim.DRUNK, "Yeesh, yes that shounds reasonable. Here, hiccup', take the keysch. Any trouble, you give... you givem a good beating.").also { stage++ }
            ...
            in 68..99 -> when (stage) {
                ...
                1 -> npcl(FaceAnim.DRUNK, "Please, leave me alone. I'm sure the walls never used to sway that much.").also { stage = END_DIALOGUE }
            ...
            100 -> when (stage) {
                ...
                1 -> npcl(FaceAnim.DRUNK, "Please, leave me alone. I'm sure the walls never used to sway that much.").also { stage++ }
