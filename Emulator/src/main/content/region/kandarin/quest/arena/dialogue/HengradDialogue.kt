    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (getQuestStage(player!!, Quests.FIGHT_ARENA)) {
            in 72..88 -> when (stage) {
                ...
                6 -> npcl(FaceAnim.FRIENDLY, "I've been in Khazard's prisons ever since I can remember. I was a child when his men kidnapped me. My whole life as been spent killing and fighting, all in the hope that, one day, I might escape.").also { stage++ }
                7 -> playerl(FaceAnim.FRIENDLY, "Don't give up.").also { stage++ }
                8 -> npcl(FaceAnim.FRIENDLY, "Thanks friend.").also { stage++ }
                9 -> npcl(FaceAnim.SILENT, "Wait... Shhh, the guard is coming. Looks like you'll be going into the arena. Good luck, friend.").also { stage++ }
