    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        if (getQuestStage(player!!, Quests.FIGHT_ARENA) in 50..100) {
            when (stage) {
                ...
                1 -> npcl(FaceAnim.FRIENDLY, "Hi, what can I get you? We have a range of quality brews.").also { stage++ }
                ...
                5 -> npcl(FaceAnim.NEUTRAL, "If you want to see the action around here you should visit the famous Khazard fight arena. I've seen some grand battles in my time. Ogres, goblins, even dragons have fought there.").also { stage++ }
                6 -> npcl(FaceAnim.WORRIED, "Although you have to feel sorry for some of the slaves sent in there.").also { stage = END_DIALOGUE }
                7 -> npcl(FaceAnim.FRIENDLY, "There you go, that's five gold coins. I suggest lying down before you drink it. That way you have less distance to collapse.").also { stage = 9 }
                8 -> {
