...
class CandleMakerDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            3 -> npcl(FaceAnim.THINKING, "Hmmm. In the candle making trade, we have a tradition that it's very bad luck to make black candles.").also { stage++ }
            ...
            8 -> npcl(FaceAnim.THINKING, "IF you can bring me a bucket FULL of wax.").also {
