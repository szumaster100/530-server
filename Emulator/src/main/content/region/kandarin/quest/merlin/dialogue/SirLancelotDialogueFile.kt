...
class SirLancelotDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> npcl(FaceAnim.NEUTRAL, "Greetings! I am Sir Lancelot, the greatest Knight in the land! What do you want?").also {
            ...
            STAGE_FULL_OF_YOURSELF -> npcl(FaceAnim.NEUTRAL, "I have every right to be proud of myself.").also { stage++ }
            ...
            STAGE_GET_MERLIN_OUT -> npcl(FaceAnim.NEUTRAL, "Well, if the Knights of the Round Table can't manage it, I can't see how a commoner like you could succeed where we have failed.").also { stage = END_DIALOGUE }
            ...
            23 -> npcl(FaceAnim.NEUTRAL, "There are two ways in that I know of, the large heavy front doors, and the sea entrance, only penetrable by boat.").also { stage++ }
