    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(
                ...
                ) "---${Quests.JUNGLE_POTION}./--" else "!!${Quests.JUNGLE_POTION}.??",
                line++
            )
            line(
                player,
                ...
                ) "---${Quests.BIG_CHOMPY_BIRD_HUNTING}./--" else "!!${Quests.BIG_CHOMPY_BIRD_HUNTING}.??",
                line++
            )
            ...
            line(
                ...
                ) "---Fletching level : 30/--" else "!!Fletching level : 30??",
                line++
            )
            line(
                player,
                ...
                ) "---Smithing level : 4/--" else "!!Smithing level : 4??",
                line++
            )
            line(
                player,
                ...
                ) "---Herblore level : 8/--" else "!!Herblore level : 8??",
                line++
            )
