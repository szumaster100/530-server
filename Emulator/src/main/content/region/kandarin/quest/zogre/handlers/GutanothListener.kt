    ...
    override fun defineListeners() {
                    ...
                    override fun pulse(): Boolean {
                        when (counter++) {
                            ...
                            3 -> {
                                ...
                                teleport(
                                    player,
                                    if (node.location == Location(2443, 9417, 2)) Location(2442, 9418, 0) else Location(
                                        2477,
                                        9437,
                                        2
                                    )
        ...
        on(STAND, IntType.SCENERY, "search") { player, _ ->
            ...
            when {
                ...
                else -> if (getVarbit(player, Vars.VARBIT_QUEST_ZORGE_FLESH_EATERS_PROGRESS_487) >= 8) spawnZogreBoss(
                    player
                )
            }
            return@on true
