...
class GrishFinishDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            14 -> npc(FaceAnim.OLD_DEFAULT, "Why you's not say so creature...me's shows you how to", "make da bigger stabber chucker...", "~ ${BLUE}Grish gets a couple of items out of his back pack.</col>~").also { stage++ }
