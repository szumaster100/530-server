    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            11 -> npc("Hmm, yes, but someone could have stolen that from him", "and then gone and cast it without his permission or to", "try and deliberately implicate him.").also {
                setAttribute(player!!, ZUtils.TALK_AGAIN_1, true); setAttribute(
                player!!,
            ...
            13 ->
                if (getAttribute(player!!, ZUtils.TALK_ABOUT_NECRO_BOOK, false)) {
                    ...
                    npcl("So what, hating monsters isn't a crime in itself...although I suppose that it does give a motive if Sithik was involved. On its own, it's not enough evidence though.").also {
                        setAttribute(player!!, ZUtils.TALK_AGAIN_2, true); setAttribute(
                        player!!,
            ...
            17 -> npcl("Who the demonikin is that? Is it meant to be a portrait of Sithik, it doesn't look anything like him!").also {
                setAttribute(
                    player!!,
                    ZUtils.TALK_AGAIN_4,
                    true
            ...
            19 -> playerl("This is a portrait of Sithik, signed by the landlord of the Dragon Inn saying that he saw Sithik and Brentle Vahn together.").also {
                setAttribute(
                    player!!,
                    ZUtils.TALK_AGAIN_5,
                    true
            ...
            23 -> npcl("It'll bring on a change which should solicit some answers - tell him the effects won't revert until he's told the truth.").also {
                setAttribute(
                    player!!,
                    ZUtils.TALK_AGAIN_6,
                    true
            ...
            30 -> npcl("So what, hating monsters isn't a crime in itself...although I suppose that it does give a motive if Sithik was involved. On its own, it's not enough evidence though.").also {
                setAttribute(
                    player!!,
                    ZUtils.TALK_AGAIN_2,
                    true
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            11 -> npcl(FaceAnim.HALF_ASKING, "Did you find anything else there?").also {
                setAttribute(player!!, "/save:${ZUtils.SITHIK_DIALOGUE_UNLOCK}", true); setAttribute(player!!, ZUtils.TALK_ABOUT_BLACK_PRISM, true); setAttribute(
                player!!,
...
class ZavisticRarveTankardDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.THINKING, "Hmmm, no, that's not really associated with this to be honest.").also { setAttribute(player!!, ZUtils.TALK_ABOUT_TANKARD, true); stage++ }
...
class ZavisticRarveTornPageDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 ->
                if (inInventory(player!!, Items.BLACK_PRISM_4808) && !getAttribute(player!!, ZUtils.SITHIK_DIALOGUE_UNLOCK, false)) {
...
class ZavisticRarveBlackPrismDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 ->
                if (getAttribute(player!!, ZUtils.TALK_WITH_ZAVISTIC_DONE, false)) { playerl("I found this black prism at Jiggig where the undead ogre activity was happening?").also { stage = 5
                    }
                } else {
            ...
            3 -> npcl(FaceAnim.HALF_ASKING, "Did you find anything else there?").also { stage++ }
            4 ->
                if (inInventory(player!!, Items.TORN_PAGE_4809) && !getAttribute(player!!, ZUtils.SITHIK_DIALOGUE_UNLOCK, false)) {
