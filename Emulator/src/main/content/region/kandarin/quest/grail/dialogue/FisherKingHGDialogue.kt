        ...
        when (stage) {
            ...
            0 -> {
                if (getQuestStage(player!!, Quests.HOLY_GRAIL) >= 50) {
                    ...
                    npcl(FaceAnim.NEUTRAL, "Ah! You got inside at last! You spent all that time fumbling around outside, I thought you'd never make it here.")
                    stage++
                }
            }
            ...
            STAGE_LOOK_AROUND -> npcl(FaceAnim.NEUTRAL, "No, not at all. Please, be my guest.").also {
                stage = END_DIALOGUE
            }

            STAGE_SEEK_GRAIL -> npcl(
                FaceAnim.HAPPY,
            ...
            26 -> playerl(FaceAnim.NEUTRAL, "I shall go and see if I can find him.").also {
                stage = END_DIALOGUE
