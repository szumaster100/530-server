...
class FishermanHGDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.NEUTRAL, "Not amazing. Not many fish can live in this gungey stuff. I remember when this was a pleasant river teeming with every sort of fish...").also { stage = END_DIALOGUE }
            ...
            8 -> npcl(FaceAnim.NEUTRAL, "You must be blind then. There's ALWAYS bells there when I go to the castle.").also {
                GroundItemManager.create(Item(Items.GRAIL_BELL_17, 1), Location.create(2762, 4694, 0), player!!)
                stage = END_DIALOGUE
            }
            10 -> npcl(FaceAnim.NEUTRAL, "This place used to be very beautiful, however, as our king grows old and weak, the land seems to be dying too.").also { stage = END_DIALOGUE }
        }
    }
}