    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (forced) {
            when (stage) {
                ...
                3 -> npcl(FaceAnim.NEUTRAL, "Go to where the six heads face, blow the whistle and away you go!").also { stage++ }
                ...
                STAGE_SIX_HEADS -> npcl(FaceAnim.NEUTRAL, "The six stone heads have appeared just recently in the world. They all face the point of realm crossing. Find where two of the heads face,").also { stage++ }
                ...
                STAGE_FISHER_KING -> npcl(FaceAnim.NEUTRAL, "The Fisher King is the owner and slave of the Grail...").also { stage++ }
                ...
                STAGE_WHISTLE -> npcl(FaceAnim.NEUTRAL, "You don't know about the whistles yet? The whistles are easy.").also { stage++ }

                21 -> npcl(FaceAnim.NEUTRAL, "You will need one to get to and from the Fisher King's realm. They reside in a haunted manor house in Misthalin, though you may not perceive them unless you carry something from the realm of the Fisher").also { stage++ }
                ...
                STAGE_REALM_CROSSING -> npcl(FaceAnim.NEUTRAL, "The realm of the Fisher King is not quite of this reality. It is of a reality very close to ours though... Where it is easiest to cross, THAT is a point of realm crossing.").also { stage = END_DIALOGUE }
            }
        } else {
            when (stage) {
