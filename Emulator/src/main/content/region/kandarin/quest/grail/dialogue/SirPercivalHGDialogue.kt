...
class SirPercivalHGDialogue(val interactionType: String) : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 -> npcl(FaceAnim.NEUTRAL, "After going on a long and challenging quest to retrieve the boots of Arkaneeses, defeating many powerful enemies on the way, I fell into a goblin trap!").also { stage++ }
            5 -> npcl(FaceAnim.NEUTRAL, "I've been kept as a slave here for the last 3 months!").also { stage++ }
            6 -> npcl(FaceAnim.NEUTRAL, "A day or so ago, they decided it was a fun game to put me in this sack: then they forgot about me!").also { stage++ }
            ...
            12 -> playerl(FaceAnim.NEUTRAL, "Your father is apparently someone called the Fisher King. He is dying and wishes you to be his heir.").also { stage++ }
            ...
            15 -> playerl(FaceAnim.NEUTRAL, "Well, I do have the means to get us there - a magic whistle!").also { stage++ }
            16 -> {
            ...
            31 -> playerl(FaceAnim.NEUTRAL, "He is dying and wishes you to be his heir.").also {
