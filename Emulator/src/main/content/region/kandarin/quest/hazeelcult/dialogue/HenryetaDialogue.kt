    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when {
            (questStage == 0) -> when (stage) {
                0 -> npcl(FaceAnim.FRIENDLY, "Oh, hello. If you wish to look around the Carnillean family home please refrain from touching anything with those grubby hands of yours.").also { stage = END_DIALOGUE }
            }

            (questStage in 0..2) -> when (stage) {
                0 -> npcl(FaceAnim.FRIENDLY, "Oh, hello. I'm afraid I'm not very presentable at the moment. I've been under incredible stress of late! It's ruining my complexion!").also { stage++ }
                1 -> playerl(FaceAnim.FRIENDLY, "Why? What's wrong?").also { stage++ }
                2 -> npcl(FaceAnim.FRIENDLY, "It's those awful cultists! I just don't feel safe here anymore!").also { stage = END_DIALOGUE }
            }
