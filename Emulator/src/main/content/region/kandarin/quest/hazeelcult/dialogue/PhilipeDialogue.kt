    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when {
            ...
            (questStage in 1..2) -> when (stage) {
                0 -> npcl(FaceAnim.FRIENDLY, "Mommy said you're here to kill all the nasty people that keep breaking in.").also { stage++ }
            ...
            (questStage == 3) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.SAD, "Someone killed Scruffy. I liked Scruffy. He never told me off.").also { stage++ }
            ...
            (questStage == 100) -> when (stage) {
                ...
                4 -> npcl(FaceAnim.FRIENDLY, "Daddy says you don't like Mr. Jones. Mr. Jones is nice. He brings me toys and sweets.").also { stage++ }
                5 -> playerl(FaceAnim.FRIENDLY, "Jones is a bad man, Philipe.").also { stage++ }
                6 -> npcl(FaceAnim.FRIENDLY, "You're a bad " + (if (player.isMale) "man" else "lady") + " I don't like you!").also { stage++ }
