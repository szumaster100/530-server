    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when {
            ...
            (questStage == 1) -> when (stage) {
                ...
                2 -> playerl(FaceAnim.ANNOYED, "Look I KNOW you're hiding something. I've heard there's a cult hideout down here.").also { stage++ }
                ...
                5 -> npcl(FaceAnim.HALF_ASKING, "So... that two faced cold hearted snob has made you fall for his propaganda, eh?").also { stage++ }
                6 -> playerl(FaceAnim.FRIENDLY, "Sir Ceril Carnillean is a man of honour!").also { stage++ }
                7 -> npcl(FaceAnim.ANNOYED, "Is he now? Is he REALLY? there's a lot more to the Carnilleans than meets the eye you fool...").also { stage++ }
                ...
                11 -> npcl(FaceAnim.ANNOYED, "The Carnillean home does not belong to them. The builder of the house was Lord Hazeel one of the Mahjarrat followers of Zamorak. Many years ago there was a civil war").also { stage++ }
                12 -> npcl(FaceAnim.ANNOYED, "in this land, and the hateful Saradominists declared war upon, all Zamorakians who lived here. Lord Hazeel nobly would not response his beliefs and the Carnilleans harrased").also { stage++ }
                13 -> npcl(FaceAnim.ANNOYED, "Hazeel and his followers for many decades. One fateful night, vader cover of darkness, they stormed his home in an angry mob torturing and butchering all loyal").also { stage++ }
                14 -> npcl(FaceAnim.ANNOYED, "Zamorakians they encountered inside. The following morning, the Carnillean forefathers moved into the empty household and claimed it as their own.").also { stage++ }
                15 -> npcl(FaceAnim.ANNOYED, "They have grown fat on the hard work of Lord Hazeel ever since, Unluckily for them Lord Hazeel as a Mahjarrat had access to powers and enchantments they knew nothing").also { stage++ }
                16 -> npcl(FaceAnim.ANNOYED, "about, and made preparations for his return when first they began to storm his home. Soon the day will come when he will return to wreak his vengeance upon the thieves!").also { stage++ }
                17 -> playerl(FaceAnim.ANNOYED, "The politics and histories of Ardougne do not concerns me. I have been given a job and intent to see it through to the end.").also { stage++ }
                18 -> npcl(FaceAnim.ANNOYED, "Well then friend, perhaps I can offer you a different job then? Sooner as later Our mmaster WILL return to this land, those faithful to him will be well rewarded.").also { stage++ }
                19 -> npcl(FaceAnim.ANNOYED, "Join our cult and assist us in his restoration, and you will be well rewarded, try and preserve his return and suffer the wrath of Zamorak and the Mahjarrat.").also { stage++ }
                20 -> options("You're crazy, i'd never help you.", "So what would i have to do?").also { stage++ }
                21 -> when (buttonID) {
                    1 -> playerl(FaceAnim.DISGUSTED_HEAD_SHAKE, "You're crazy, i'd never help you.").also { stage++ }
                ...
                24 -> npcl(FaceAnim.ANNOYED, "I can already tell I was right about you. I can see you are of exactly the right character to join the followers of Hazeel.").also { stage++ }
            ...
            (questStage == 2) -> when (stage) {
                ...
                4 -> npcl(FaceAnim.ANNOYED, "You're more of a fool than you look if you think you will ever find it. When Lord Hazeel is revived you will be the first to grovel for his mercy!").also { stage = END_DIALOGUE }
            }
            ...
            (questStage == 3) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.NEUTRAL, "Yes, we heard all about it from one of our sources. It's a shame that Ceril Carnillean survived, but that is no fault of yours. You have proven your loyalty to Hazeel.").also { stage++ }
                2 -> playerl(FaceAnim.HALF_ASKING, "So what now?").also { stage++ }
                3 -> npcl(FaceAnim.NEUTRAL, "I would like you to meet with our leader, Alomone. You'll find him in our hideout, deeper in the sewers. You can use this raft to get there.").also { stage++ }
                4 -> npcl(FaceAnim.FRIENDLY, "However, be warned that reaching the hideout is impossible unless the flow of water down here is set correctly. You'll need to use the sewer valves above to do that.").also { stage++ }
                ...
                8 -> {
                    ...
                    npcl(FaceAnim.NEUTRAL, "Going from left to right, turn each of the five sewer valves above so that they follow the design of the amulet. Once you've done that, you'll be able to use the raft here to enter our hideout.")
                    stage = END_DIALOGUE
                }
            }
            ...
            (questStage == 100) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.FRIENDLY, "It is good to see you once more, adventurer. Glory to Hazeel!").also { stage = END_DIALOGUE }
                4 -> npcl(FaceAnim.ANNOYED, "You may have won this battle meddler, but the war rages on. Go bother some goblins or something for when Hazeel returns your destruction is assured.").also { stage = END_DIALOGUE }
            }
        }
        return true
    }
