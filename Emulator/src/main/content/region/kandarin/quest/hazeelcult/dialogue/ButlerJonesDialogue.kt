    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        ...
        when {
            ...
            (questStage == 3) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.NEUTRAL, "Hello, adventurer. Such a terrible shame about Scruffy. I wonder if the family will ever fully recover.").also { stage++ }
            ...
            (questStage == 100) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.NEUTRAL, "It's an honour to be in your presence again, adventurer. I hope things are well?").also { stage++ }
                2 -> playerl(FaceAnim.FRIENDLY, "Not bad, thanks. Yourself?").also { stage++ }
                3 -> npcl(FaceAnim.ANNOYED, "Unfortunately, I am still forced to deal with this insufferable family. Many generations have passed, but they are still the enemy. As such, they must be kept a close eye on.").also { stage++ }
                4 -> npcl(FaceAnim.ANNOYED, "Still, I have no doubt that the time will soon come for me to leave this place. Our lord will certainly have need of me elsewhere once his current work is complete.").also { stage++ }
                ...
                8 -> npcl(FaceAnim.ANNOYED, "That's right. I hear that they had some problems with the last one.").also { stage++ }
