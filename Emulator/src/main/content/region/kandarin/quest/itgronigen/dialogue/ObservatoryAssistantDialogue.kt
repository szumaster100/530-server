    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (planks) {
            0 -> when (stage) {
                ...
                4 -> npcl("There are some at the Barbarian Outpost, too. Failing that, you could always ask the Sawmill Operator. He's to the north-east of Varrock, by the Lumber Yard.").also {
                    stage = END_DIALOGUE
                }
            }
...
class AssistantTalkAboutObservatoryLensDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            7 -> npcl("Stop! You can't confuse me with big words. Just pray the professor doesn't notice.").also {
                stage = END_DIALOGUE
            }
        }
    }
