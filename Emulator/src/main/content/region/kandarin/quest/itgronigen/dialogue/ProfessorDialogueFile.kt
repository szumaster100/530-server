    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> when {
                ...
                getQuestStage(player!!, Quests.OBSERVATORY_QUEST) == 11 -> npc("Is the lens finished?").also {
                    stage = 82
                }
...
class ProfessorConstellationsDialogue() : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            6 -> player("Libra!").also {
                setAttribute(player!!, ObservatoryListener.CONSTELLATION_ATTRIBUTE, 6); stage = 16
            }

            7 -> player("Virgo!").also {
                setAttribute(player!!, ObservatoryListener.CONSTELLATION_ATTRIBUTE, 7); stage = 16
            }

            8 -> player("Leo!").also {
                setAttribute(player!!, ObservatoryListener.CONSTELLATION_ATTRIBUTE, 8); stage = 16
            }
            ...
            20 -> npcl("Capricorn will surely reward your insight with an increase to your Strength.").also {
                stage = 100
            }
            ...
            26 -> npcl("An armoured creature - I think I shall reward you with an amulet of protection.").also {
                stage = 100
            }

            27 -> npcl("With the double nature of Gemini, I can't offer you anything more suitable than a two-handed weapon.").also {
                stage = 100
            }

            28 -> npcl("This Strength potion should be a suitable reward.").also { stage = 100 }
            29 -> npcl("A fierce fighter. I'm sure he'll look down on you and improve your Attack for such insight.").also {
                stage = 100
            }
