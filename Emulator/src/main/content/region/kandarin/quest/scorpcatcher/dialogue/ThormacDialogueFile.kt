        ...
        when (questStage) {
            ...
            in 1..50 -> {
                when (stage) {
                    ...
                    4 -> npc(FaceAnim.NEUTRAL, "Well remember to go speak to the Seers, ", "North of here, if you need any help.").also { stage = END_DIALOGUE }
            ...
            100 -> {
                when (stage) {
                    ...
                    3 -> npc(FaceAnim.NEUTRAL, "Yes, although it'll cost you " + (if (wearHeadBand) "27,000" else "40,000") + " coins for the", "materials. What kind of staff did you want enchanting?").also { stage++ }
                    4 -> {
                        end()
