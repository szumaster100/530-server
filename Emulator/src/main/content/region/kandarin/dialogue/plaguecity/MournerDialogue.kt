...
class MournerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FaceAnim.NEUTRAL, "If I find you attempting to cross the wall I'll make sure you never return.").also { stage = END_DIALOGUE }
            ...
            6 -> npcl(FaceAnim.NEUTRAL, "You will be surprised at how much help the brute force of the Guard can be.").also { stage++ }
            7 -> playerl(FaceAnim.FRIENDLY, "Well I'll be sure to ask if I'm in need of some muscle.").also { stage = END_DIALOGUE }
        }
        return true
    }
