    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.HALF_ASKING, "Can you tell me about this copper-coloured pool?").also { stage = 8 }
            }
            ...
            7 -> playerl(FaceAnim.HALF_ASKING, "Didn't your mother ever teach you not to talk to strangers?").also { stage = END_DIALOGUE }
            8 -> npcl(FaceAnim.CHILD_NORMAL, "Yeah, sure, human! De water flows fast from underground. When you bathe here, it make you flow fast overground for long, long time.").also { stage++ }
            9 -> playerl(FaceAnim.HALF_ASKING, "Flow fast?").also { stage++ }
            10 -> npcl(FaceAnim.CHILD_NORMAL, "You know, flow on your feetsies. Fast-like. Quick, like a bunny!").also { stage++ }
            11 -> playerl(FaceAnim.HALF_ASKING, "Are you talking about running?").also { stage++ }
            12 -> npcl(FaceAnim.CHILD_NORMAL, "Yeah, run, flow - same thing. Have bath here, it not matter how heavy you are, how much you carry - you can flow long time!").also { stage++ }
