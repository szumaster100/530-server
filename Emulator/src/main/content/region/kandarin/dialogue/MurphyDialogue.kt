...
class MurphyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FaceAnim.FRIENDLY, "I've got all the supplies I need from the shop at the end of the pier. They sell good rope, although their bailing buckets aren't too effective.").also { stage++ }
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "I get all sorts, anything that lies on the sea bed, you never know what you're going to get until you pull up the net!").also { stage = 4 }
            ...
            9 -> npcl(FaceAnim.FRIENDLY, "Oh no, I don't let a few holes stop an experienced sailor like me. I could sail these seas in a barrel, I'll be going out soon enough.").also { stage = 4 }
            10 -> npcl(FaceAnim.FRIENDLY, "Well of course you can! I'll warn you though, the seas are merciless and without fishing experience you won't catch much.").also { stage++ }
            11 -> npcl(FaceAnim.FRIENDLY, "You need a fishing level of 15 or above to catch any fish on the trawler.").also { stage++ }
            12 -> npcl(FaceAnim.FRIENDLY, "On occasions the net rips, so you'll need some rope to repair it.").also { stage++ }
            13 -> npcl(FaceAnim.FRIENDLY, "Repairing the net is difficult in the harsh conditions so you'll find it easier with a higher Crafting level.").also { stage++ }
            ...
            23 -> npcl(FaceAnim.FRIENDLY, "Aye aye! Meet me on board the trawler. I just need to get a few things together.").also { stage = END_DIALOGUE }
            24 -> npcl(FaceAnim.FRIENDLY, "Swamp tar mixed with flour which is then heated over a fire.").also { stage++ }
            25 -> playerl(FaceAnim.HALF_ASKING, "Where can I find swamp tar?").also { stage++ }
            26 -> npcl(FaceAnim.FRIENDLY, "Unfortunately the only supply of swamp tar is in the swamps below Lumbridge.").also { stage = END_DIALOGUE }
        }
        return true
    }
