...
@Initializable
class HermanCaranosDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            30 -> {
                sendDialogue("Herman describes the Wise Old Man’s greatest feats. A cutscene plays, showing the Wise Old Man slaying various creatures.")
                stage++
            }
