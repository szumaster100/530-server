...
class GnomeWaiterDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> npcl(FaceAnim.OLD_NORMAL, "Hello " + (if (player.isMale) "sir" else "madam") + ", can I tempt you with any of the dishes on our new menu?").also { stage++ }
            1 ->
            ...
            3 -> npcl(FaceAnim.OLD_NORMAL, "That's your choice " + (if (player.isMale) "sir" else "madam") + ", enjoy your stay.").also { stage = END_DIALOGUE }
            4 -> npcl(FaceAnim.OLD_NORMAL, "I hope you like what you see. Although all these premade dishes are good to eat - they were made by the last human assistant chef. He wasn't up to Chef's exacting standards - and you may find that they will").also { stage++ }
            ...
            7 -> npcl(FaceAnim.OLD_NORMAL, " Mr Gianne is the one to talk to if you want to sell any dishes you've made yourself. He is the owner and head chef of this establishment. If on the other hand you are more interested in making food to deliver").also { stage++ }
            8 -> npcl(FaceAnim.OLD_NORMAL, "which can be quite lucrative, you should talk to Mr Giannes son Aluft Gianne jnr. Just don't call him Lufty, he doesn't like it.").also { stage++ }
