...
class GnomeCoachDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            14 -> npcl(FaceAnim.OLD_NORMAL, "A great many years ago, before I was even born, there were two young Gnomes. Brothers to be exact.").also { stage++ }
            15 -> npcl(FaceAnim.OLD_NORMAL, "They were always arguing with each other over the most trivial things - who was the faster runner or who was the tallest.").also { stage++ }
            16 -> npcl(FaceAnim.OLD_NORMAL, "One day they were up at the swamp throwing stones at the toads.").also { stage++ }
            ...
            20 -> npcl(FaceAnim.OLD_NORMAL, "Anyway, they decided to compete to see who could kill the most toads. This gradually became a daily game, to which they invited friends and family to join in. It all evolved from there.").also { stage++ }
            ...
            26 -> npcl(FaceAnim.OLD_NORMAL, "What with the swamp nearby, and their robust skin, there is nothing better to stretch over some common sand.").also { stage++ }
            27 -> playerl(FaceAnim.HALF_GUILTY, "I'd never have guessed.").also { stage++ }
            28 -> npcl(FaceAnim.OLD_NORMAL, "Well, of course. You humans know nothing! Anything else?").also { stage = 4 }
            ...
            33 -> npcl(FaceAnim.OLD_NORMAL, "I have no time for jokes. It's a serious matter, we go through plenty of nets every day.").also { stage++ }
            34 -> playerl(FaceAnim.HALF_GUILTY, "So that's why you don't see many Gnomes with long hair?").also { stage++ }
            ...
            43 -> npcl(FaceAnim.OLD_NORMAL, "You don't know anything do you? You pass the ball onto a team mate, giving him all the attention of your opposition, and giving you the chance to run further ahead.").also { stage++ }
            44 -> playerl(FaceAnim.HALF_GUILTY, "Then what?").also { stage++ }
            45 -> npcl(FaceAnim.OLD_NORMAL, "Well, he passes back to you and you've made an advantage. It's useful in a variety of situations!").also { stage++ }
            46 -> playerl(FaceAnim.HALF_GUILTY, "I'll remember that one.").also { stage++ }
            47 -> npcl(FaceAnim.OLD_NORMAL, "Anything else?").also { stage = 39 }
            48 -> npcl(FaceAnim.OLD_NORMAL, "Well, don't forget that you can block the opposition whilst a team mate has the ball. Very useful if you want to stop or slow down anyone approaching him.").also { stage++ }
            ...
            53 -> npcl(FaceAnim.OLD_NORMAL, "I see. Your agility is important if you want to avoid being tackled, so that would be a good attribute to improve.").also { stage++ }
            54 -> npcl(FaceAnim.OLD_NORMAL, "Also many Gnomes say that being able to attack well with a ranged weapon makes you better at scoring goals.").also { stage++ }
            55 -> playerl(FaceAnim.HALF_GUILTY, "I suppose I should go away and work on those skills.").also { stage++ }
            56 -> npcl(FaceAnim.OLD_NORMAL, "Yes, although playing the game itself will improve these skills too.").also { stage++ }
            57 -> npcl(FaceAnim.OLD_NORMAL, "Also you should remember that your distance from the goal affects your chance of scoring, so get close enough and your ranged ability won't matter as much.").also { stage++ }
            ...
            61 -> npcl(FaceAnim.OLD_NORMAL, "OK. Have you noticed the different colour clothes for your opposing Gnomes?").also { stage++ }
            62 -> playerl(FaceAnim.HALF_GUILTY, "Nope.").also { stage++ }
            63 -> npcl(FaceAnim.OLD_NORMAL, "The colours correspond to their skill level. The red ones are the professionals. They've been playing since before you were born!").also { stage++ }
            64 -> npcl(FaceAnim.OLD_NORMAL, "The orange ones are in the middle of their careers, whereas the yellow players know very little. Just like you!").also { stage++ }
            65 -> playerl(FaceAnim.HALF_GUILTY, "Thanks... Anything else?").also { stage++ }
            66 -> npcl(FaceAnim.OLD_NORMAL, "It's always good to get a group of friends to play with you. That way you can score goals more easily, and if you take it in turns to score the goals you'll all reap the rewards.").also { stage = END_DIALOGUE }
            67 -> npcl(FaceAnim.OLD_NORMAL, "You mean you've never heard of Speedy Sam The Striker or Norda 'Steal Arms' van Druman?").also { stage++ }
