        ...
        when (stage) {
            1 -> when (buttonId) {
                1 -> {
                    ...
                    openDialogue(player, content.region.fremennik.quest.horror.dialogue.GunnjornDialogueFile(), npc).also { stage = END_DIALOGUE }
                }
            ...
            2 -> when (buttonId) {
                ...
                3 -> playerl(FaceAnim.FRIENDLY, "Can I talk about rewards?").also {
                    stage = 16
                }
                4 -> playerl(FaceAnim.FRIENDLY, "Nothing.").also { stage = 15 }
            }
            ...
            16 -> npcl(FaceAnim.FRIENDLY, "There's no reward for you just yet. Your lap count is only 0. It's 250 successful laps or no reward.").also { stage = END_DIALOGUE }
        }
        return true
    }
