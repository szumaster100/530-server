    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> if (player.inventory.containsItem(silk)) {
                player(FaceAnim.FRIENDLY, "Hello. I have some fine silk from Al-Kharid to sell to", "you.").also { stage++ }
            ...
            1 -> npc(FaceAnim.HAPPY, "Ah, I may be interested in that. What sort of price were", "you looking at per piece of silk?").also { stage++ }
            ...
            510 -> buy(50)
            520 -> npc(FaceAnim.FRIENDLY, "You drive a hard bargain, but", "I guess that will have to do.").also { stage++ }
            521 -> buy(60)
