...
object TutorialStage {
    ...
    fun rollback(player: Player) {
        val currentStage = getAttribute(player, GameAttributes.TUTORIAL_STAGE, -1)
    ...
    fun load(
        ...
        when (stage) {
            ...
            43 -> {
                hideTabs(player, login)
                registerHintIcon(player, Location.create(3094, 9502), 125)
                Component.setUnclosable(
                    player,
                    player.dialogueInterpreter.sendPlaneMessageWithBlueTitle(
            ...
            50 -> {
                hideTabs(player, login)
                setVarbit(player, 3756, 0)
                registerHintIcon(player, Location.create(3110, 9518, 0), 100)
                Component.setUnclosable(
                    player,
                    player.dialogueInterpreter.sendScrollMessageWithBlueTitle(
