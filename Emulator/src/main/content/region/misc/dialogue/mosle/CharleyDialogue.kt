...
class CharleyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            24 -> npcl(FaceAnim.FRIENDLY, "Then I don't have any, and yer wastin' my time!").also {
                stage = END_DIALOGUE
            }
            ...
            34 -> npcl(FaceAnim.FRIENDLY, "See, I was clingin' onto a barrel, me ship havin' just had an encounter with this albatross.").also { stage++ }
            35 -> npcl(FaceAnim.FRIENDLY, "The sea was thrashin' and wild, but not so wild that I didn't see the fins of some sharks closin' in on me.").also { stage++ }
            36 -> npcl(FaceAnim.FRIENDLY, "I managed to yank a sliver of wood from the barrel just as one of them grabbed me from below, but I slipped down the things throat by about two feet before I managed te kill it.").also { stage++ }
            37 -> player(FaceAnim.FRIENDLY, "How did you survive?").also { stage++ }
            38 -> npcl(FaceAnim.FRIENDLY, "A passin' ship saw the sharks and knew there would be survivors in the water. They sent a longboat and picked me up, but not before the sharks had taken off my legs.").also { stage++ }
            39 -> npcl(FaceAnim.FRIENDLY, "And that lad is why they call me two feet Charley, because they found me jammed two feet down a shark's throat.").also { stage++ }
