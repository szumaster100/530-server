...
class KjutDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            START_DIALOGUE -> npcl(FaceAnim.OLD_DEFAULT, "Kebabs! Get your kebabs here! One gold each!").also { stage++ }
            1 -> showTopics(
            ...
            8 -> npcl(FaceAnim.OLD_DEFAULT, "That's still not very helpful. But let me see. There is one particularly drunken dwarf just to the northeast of here.").also { stage++ }
            9 -> npcl(FaceAnim.OLD_DEFAULT, "He's scaring away my customers, he says there's something wrong with my kebabs. Quite annoying fellow.").also { stage++ }
            10 -> playerl(FaceAnim.FRIENDLY, "I don't think that's who I mean.").also { stage++ }
            11 -> npcl(FaceAnim.OLD_DEFAULT, "Well, he does have a relative who wanders all over Gielinor. Comes back from time to time to buy more kebabs. Don't see him very often though.").also { stage++ }
            12 -> playerl(FaceAnim.FRIENDLY, "Do you think I'll have any chance of catching him here?").also { stage++ }
            13 -> npcl(FaceAnim.OLD_DEFAULT, "I think he was back here quite recently, so I doubt he'll be back any time soon.").also { stage = END_DIALOGUE }
            14 -> playerl(FaceAnim.FRIENDLY, "How do you mean?").also { stage++ }
            15 -> npcl(FaceAnim.OLD_DEFAULT, "Oh come on! You in the Laughing Miner? The whole city knows about you and your dwarven drinking buddies!").also { stage++ }
            16 -> playerl(FaceAnim.FRIENDLY, "Right, right.").also { stage = END_DIALOGUE }
            17 -> npcl(FaceAnim.OLD_DEFAULT, "Not really! I have a steady supply of meat coming in through the carts and I don't really need anything else!").also { stage = END_DIALOGUE }
        }
        return true
    }
