...
class BarmaidDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            4 -> npcl(FaceAnim.OLD_DEFAULT, "Oh, him. Yes, we employ him to advertise our pub, he's the cheapest labour we could find. We don't have a lot of money to spare you know, we pay him in beer.").also { stage++ }
            ...
            17 -> showTopics(Topic(FaceAnim.FRIENDLY, "Pay.", 18, true), Topic(FaceAnim.FRIENDLY, "Don't pay.", 19, true))
            18 -> {
                end()
