    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when ((0..3).random()) {
            ...
            1 -> when (stage) {
                ...
                4 -> npcl(FaceAnim.OLD_NORMAL, "I'll leave you to your browsing, then.").also { stage = END_DIALOGUE }
            }

            2 -> when (stage) {
                0 -> npcl(FaceAnim.OLD_NORMAL, "There is a lot of knowledge stored in this library, you know.").also { stage++ }
            ...
            3 -> when (stage) {
                ...
                3 -> playerl(FaceAnim.FRIENDLY, "We've been having more human visitors in the city recently, there is another one over there. Perhaps you'll want to talk to her.").also { stage = END_DIALOGUE }
            }
        }
        return true
    }
