...
class BlueOpalSecretaryDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when ((0..7).random()) {
            ...
            5 -> npcl(FaceAnim.OLD_DEFAULT, "Do not test the patience of the Blue Opal, human. Say what you need!").also { stage++ }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            104 -> npcl(FaceAnim.OLD_DEFAULT, "We are the Blue Opal. We are part of the Consortium, rulers of Keldagrim and beyond.").also { stage = END_DIALOGUE }
            105 -> when ((0..3).random()) {
                ...
                2 -> npcl(FaceAnim.OLD_NORMAL, "I'd tell you, human, but you wouldn't understand anyway.").also { stage = END_DIALOGUE }
                3 -> npcl(FaceAnim.OLD_NORMAL, "These are the offices of the Blue Opal.").also { stage = 200 }
            }
            200 -> npcl(FaceAnim.OLD_DEFAULT, "We share this floor of the palace with the other companies of the Consortium. And trade with them on the Trade Octagon.").also { stage++ }
            201 -> player(FaceAnim.HALF_ASKING, "The Trade Octagon?").also { stage++ }
            202 -> npcl(FaceAnim.OLD_NORMAL, "See those traders standing out there, just out the door? They're all standing in the Trade Octagon.").also { stage++ }
            203 -> npcl(FaceAnim.OLD_DEFAULT, "There's an awful lot of trade going on in the palace, you know.").also { stage++ }
            204 -> player(FaceAnim.HALF_ASKING, "Anything else of interest in the palace?").also { stage++ }
            205 -> npcl(FaceAnim.OLD_DEFAULT, "You will have to find that out on your own, I'm afraid. I do have more work to do.").also { stage = END_DIALOGUE }
        }
        return true
    }
