...
class GaussDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            7 -> npc(FaceAnim.OLD_DEFAULT, "No no, get a pint of beer, jugs of wine aren't", "good to toast with Wine stains are terribly hard", "to wash out of a beard.").also { stage = END_DIALOGUE }
        }
        return true
    }
