...
class DrunkenDwarfDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> playerl(FaceAnim.FRIENDLY, "Hey, you look vaguely familiar... haven't I seen you somewhere before?").also { stage++ }
            ...
            6 -> npcl(FaceAnim.OLD_DRUNK_RIGHT, "I've been looking after thish houshe for my... my coushin? Or wash it my brother? A family member anyway.").also { stage++ }
            7 -> playerl(FaceAnim.FRIENDLY, "And where is this... family member of yours?").also { stage++ }
            8 -> npcl(FaceAnim.OLD_DRUNK_RIGHT, "All over, all over... he shaish he went off to wander all over Gielinor. Don't remember why.").also { stage++ }
            9 -> playerl(FaceAnim.FRIENDLY, "Hmm... I wonder, I may have met him...").also { stage++ }
            10 -> npcl(FaceAnim.OLD_DRUNK_RIGHT, "He comesh back sometimesh... saysh he needsh more kebabsh.").also { stage++ }
            11 -> npcl(FaceAnim.OLD_DRUNK_RIGHT, "Or ish that jusht a dream? Sometimesh I dream kebabsh invade Keldi... Keldu... Keldashomething.").also { stage++ }
            12 -> npcl(FaceAnim.OLD_DRUNK_RIGHT, "When you eatsh them, they take over your mind, they do! An army of mindlesh kebab eating dwarvesh!").also { stage++ }
