...
class LarrissaDialogueFile : DialogueFile() {
    override fun handle(
        ...
        when (getQuestStage(player!!, Quests.HORROR_FROM_THE_DEEP)) {
            0 ->
                when (stage) {
                    ...
                    16 ->
                        when (buttonID) {
                            1 ->
                                playerl(FaceAnim.FRIENDLY, "Okay, I'll help!").also {
            ...
            in 1..29 -> {
                if (inInventory(player!!, Items.LIGHTHOUSE_KEY_3848) &&
                ...
                } else if (!inInventory(player!!, Items.LIGHTHOUSE_KEY_3848) &&
                    getAttribute(player!!, HorrorFromTheDeepUtils.UNLOCK_BRIDGE, 0) >= 2
                ) {
                    when (stage) {
                    ...
                    getAttribute(player!!, HorrorFromTheDeepUtils.UNLOCK_BRIDGE, 0) == 0
                ) {
                    when (stage) {
                        0 -> playerl(FaceAnim.FRIENDLY, "I've got your key for you!").also { stage++ }
                        1 ->
            ...
            100 ->
                when (stage) {
                    ...
                    1 ->
                        playerl(FaceAnim.FRIENDLY, "Don't worry about it, I was glad to help out.").also {
                            stage =
                                END_DIALOGUE
                        }
                }
