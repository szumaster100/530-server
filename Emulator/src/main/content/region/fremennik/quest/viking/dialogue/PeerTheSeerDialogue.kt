...
class PeerTheSeerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            7 -> npcl(FaceAnim.HAPPY, "That is all.").also {
            ...
            151 -> npcl(FaceAnim.HAPPY, "Ahem, sorry about that.").also {
            ...
            155 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.HAPPY, "Nothing really, I just stopped by to say hello").also {
                    stage = 160
                }
            }
            ...
            157 -> npcl(FaceAnim.HAPPY, "Here is your prediction: ${PREDICTIONS[prediction]}").also {
                stage = 1000
            }
            ...
            201 -> when (buttonId) {
                ...
                3 -> playerl(FaceAnim.HAPPY, "Nothing really, I just stopped by to say hello").also {
                    stage = 160
                }
            }
