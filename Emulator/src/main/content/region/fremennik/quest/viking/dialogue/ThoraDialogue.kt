...
class ThoraDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> playerl(FaceAnim.ASKING, "But you still remember how to make it, right?").also { stage++ }
            7 -> npcl(FaceAnim.HAPPY, "Of course.").also { stage++ }
            8 -> playerl(
                FaceAnim.ASKING,
                "And you have all the ingredients here? I don't need to go chasing round the world for obscure ingredients to make it?"
            ).also { stage++ }

            9 -> npcl(FaceAnim.ASKING, "No, I have them all here. Why?").also { stage++ }
            ...
            18 -> playerl(FaceAnim.ASKING, "Any idea how I can get him to do that?").also { stage++ }
            19 -> npcl(
                FaceAnim.HAPPY,
            ...
            30 -> npcl(FaceAnim.NEUTRAL, "If it's not the note from Askeladden it isn't me, I'm afraid.").also {
                stage = 1000
            }
            ...
            53 -> when (buttonId) {
                1 -> playerl(FaceAnim.HAPPY, "Yes please").also { stage = 66 }
