...
class ChieftanBrundtDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (getAttribute(player, "sigmund-steps", 0) == 5) {
            ...
            npcl(FaceAnim.HAPPY, "Hello again, $gender $fName. I hope your travels have brought you wealth and joy! What compels you to visit me on this day?")
            stage = 600
            return true
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            321 -> {
                npc("If you can gain the support of seven of the twelve, then", "you will be accepted as one of us without question.");
                stage = END_DIALOGUE
            ...
            540 -> playerl(FaceAnim.HAPPY, "I only have ${getAttribute(player, "fremtrials:votes", 0)} votes so far.").also { stage++ }
            ...
            560 -> npcl(FaceAnim.HAPPY, "From this day onward, you are outerlander no more! In honour of your acceptance into the Fremennik, you gain a new name: ${
            ...
            602 -> npcl(FaceAnim.HAPPY, "Well met, $gender $fName. it is always good to see your face in glorious Rellekka once more!").also { stage = END_DIALOGUE }
            605 -> npcl(FaceAnim.HAPPY, "Not at the moment, $fName. Rest assured, should your services to the Fremennik be required, I will call upon you").also { stage = END_DIALOGUE }
            610 -> npcl(FaceAnim.HAPPY, "Aye that it is, $gender $fName. Should you desire one of your own, you should go to Skulgrimen's shop and see what they have available!").also { stage = END_DIALOGUE }
            615 -> npcl(FaceAnim.HAPPY, "Why, of course, $fName! Do not say 'your people' like that, for you are now a Fremennik yourself! What did you want to hear of?").also { stage++ }
            ...
            636 -> npcl(FaceAnim.HAPPY, "So my knowledge is not great, but I will happily share what little I do know with you, $fName. North of this town the atmosphere becomes bitterly cold.").also { stage++ }
            ...
            1202 -> npcl(FaceAnim.HAPPY, "Very well, $fName! Let me look you over and see if you're strong enough for this boon.").also { stage++ }
            1203 -> {
                if (player!!.hasItem(Item(Items.SEAL_OF_PASSAGE_9083)))
                    npcl(FaceAnim.HALF_GUILTY, "I'm sorry, $fName. You just don't have the experience needed for this gift. Please come back when you've learned more.").also { stage = END_DIALOGUE }
                else
