...
class OlafTheBardDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> player(
                "Well, I ask because I am currently doing the",
                "Fremennik trials so as to join you clan. I need seven",
                "of the twelve council of elders to vote for me."
            ).also { stage++ }

            3 -> npc(
                "Ahhh... and you wish to earn my vote? I will gladly",
                "accept you as a Fremennik should you be able to prove",
                "yourself to have a little musical ability!"
            ).also { stage++ }

            4 -> player("So how would I do that?").also { stage++ }
            5 -> npc(
                "Why, by playing in our longhall! All you need to do is",
            ...
            8 -> when (buttonId) {
                1 -> player(
                    "Sure! This certainly sounds pretty easy to accomplish.",
                    "I'll have your vote in no time!"
                ).also { stage++ }
            ...
            9 -> npc(
                ...
                "music lovers here!"
            ).also { stage++; setAttribute(player, "/save:fremtrials:olaf-accepted", true) }

            10 -> player("So how would I go about writing this epic?").also { stage++ }
            11 -> npc(
                "Well, first of all you are going to need an instrument.",
            ...
            13 -> npc(
                "Well, it is a long and drawn-out process. Just east of",
                "this village there is an unusually musical tree that can",
                "be used to make very high quality instruments."
            ).also { stage++ }

            14 -> npc(
                "Cut a piece from it, and then carve it into a special",
            ...
            16 -> npc(
                "Next you will need to string your lyre. There is a troll",
            ...
            18 -> npc(
                "Well, when you have crafted your lyre you will need",
            ...
            20 -> npc(
                "Fossegrimen is a lake spirit that lives just a little way",
                "South-west of this village. Make her an offering of fish,",
                "and you will then be ready for your performance."
            ).also { stage++ }

            21 -> npc(
                "Make sure you give her a suitable offering however. If",
            ...
            25 -> npc(
                "When you have crafted your lyre and been blessed by",
                "Fossegrimen, then you will finally be ready to make",
                "your performance to the revellers at the longhall."
            ).also { stage++ }

            26 -> npc(
                "Head past the bouncers and onto the stage, and then",
            ...
            27 -> npc(
                "I will observe both you and the audience, and if you",
            ...
            56 -> npcl(
                FaceAnim.NEUTRAL,
                "It is these old worn out shoes of mine... As a bard I am expected to wander the lands, singing of the glorious battles of our warriors."
            ).also { stage++ }
            ...
            71 -> npcl(
                FaceAnim.HAPPY,
                "Only a woman with a heart of icy stone could fail be to be moved by its beauty!"
            ).also { stage++ }
            ...
            100 -> npcl(
                FaceAnim.HAPPY,
                "Well that is an interesting question. Let me let you into a little secret. If you make another offering to the Fossegrimen you will learn a secret melody."
            ).also { stage++ }

            101 -> playerl(FaceAnim.ASKING, "What kind of melody?").also { stage++ }
            102 -> npcl(
                FaceAnim.HAPPY,
                "It is the song of Rellekka. When you play it, it will bring you back to this town where you are in this world."
            ).also { stage++ }

            103 -> npcl(
                FaceAnim.HAPPY,
                "We often go adventuring with bards for precisely this reason. No matter where we have ended up we can return safe and sound to home."
            ).also { stage++ }
