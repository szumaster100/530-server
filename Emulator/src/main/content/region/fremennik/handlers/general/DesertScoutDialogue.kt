...
class DesertScoutDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> player(FaceAnim.LAUGH, "You're pretty jumpy for a scout. I thought you'd be", "made of sterner stuff.").also { stage++ }
            ...
            14 ->
                ...
                } else if (isQuestComplete(player, Quests.ENAKHRAS_LAMENT) && !isQuestComplete(player, Quests.DESERT_TREASURE)) {
