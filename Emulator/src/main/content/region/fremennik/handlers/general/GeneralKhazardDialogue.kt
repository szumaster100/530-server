...
class GeneralKhazardDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (hasWeapon != null || hasShield != null || !hasGhostSpeakAmulet) {
            npc(FaceAnim.OLD_DISTRESSED2, "You can see into the Shadow Realm and yet you are", "not of it. Oh well, you will be of no use.").also { stage = END_DIALOGUE }
            return true
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            0 -> npc(FaceAnim.OLD_NORMAL, "What? You are not dead and yet you walk and talk in", "the Shadow Realm. Explain yourself.").also { stage++ }
            ...
            2 -> npc(FaceAnim.OLD_NORMAL, "This intrigues me. How do you know me? You look", "familiar but I can't place it.").also { stage++ }
            ...
            5 -> npc(FaceAnim.OLD_NORMAL, "True, I never can tell you humans apart. You're all", "ugly creatures, anyway.").also { stage++ }
            ...
            9 -> npc(FaceAnim.OLD_NORMAL, "It doesn't matter anyway. You are not of the blood", "and I cannot trust you.").also { stage++ }
            ...
            14 -> npc(FaceAnim.OLD_CALM_TALK1, " Hmm... There is one person's word I would believe. If", "you visited the Sin Seer, and she judged you", "trustworthy, then I would have use for you.").also { stage++ }
            15 -> player("Where would I find her?").also { stage++ }
            16 -> npc(FaceAnim.OLD_NORMAL, "Well, considering I told you she was a seer, of sorts, I", "would imagine you would find her in Seer's Village. It", "is to the south of here not far.").also { stage++ }
            17 -> npc(FaceAnim.OLD_NORMAL, "Go and see her, return with her report and I will see if", "I have use for you. You will be well rewarded.").also { stage++ }
            18 -> player("Okay! that sounds reasonable. Sin Seer, huh? How do", "you know someone like her?").also { stage++ }
            19 -> npcl(FaceAnim.OLD_NORMAL, "It's a long story, and I do not have the time to tell it.").also { stage++ }
            20 -> {
                end()
                setAttribute(player, GeneralShadowUtils.START_GENERAL_SHADOW, true)
            }
            21 -> npc(FaceAnim.OLD_NORMAL, "You goldfish! Go find the Sin Seer - she will determine if", "you are trustworthy. She lives in Seer's village to the", "south of here.").also { stage++ }
            22 -> end()
            23 -> npc(FaceAnim.OLD_NORMAL, "And?").also { stage++ }
            24 -> playerl(FaceAnim.FRIENDLY, "She said to give you this note to prove I went to see her.").also { stage++ }
            25 -> npcl(FaceAnim.OLD_NORMAL, "The note says you have committed many sins and atrocities in your life. I'm impressed; I will use you.").also { stage++ }
            26 -> npcl(FaceAnim.OLD_NORMAL, "It has been a long time since I have left my home in the south. I have lost track of what is going on in the world, but now it is imperative that I know.").also { stage++ }
            27 -> npcl(FaceAnim.OLD_NORMAL, "So I sent out four scouts to gather information for me. I brought them to walk like me in the Shadow Realm, so they would be safe from my enemies.").also { stage++ }
            28 -> npcl(FaceAnim.OLD_NORMAL, "I sent them on four missions. One was to go to the land of the gnomes and explore their holdings. One was to go to a jungle to the sound. One was to explore where the White Knights rule.").also { stage++ }
            29 -> npcl(FaceAnim.OLD_NORMAL, "And one was to the place that I once called home - a place of great heat.").also { stage++ }
            30 -> npcl(FaceAnim.OLD_NORMAL, "I am going to entrust you with a very important message, which you must deliver to each one of them.").also { stage++ }
            31 -> npcl(FaceAnim.OLD_NORMAL, "Tell them: The planets are nearing alignment; we will meet in the place of half light and ice soon. Beware the others, for though they are weak and few, they are cunning.").also { stage++ }
            ...
            36 -> npc(FaceAnim.OLD_NORMAL, "One was to go to the land of the gnomes and explore", "their holdings.").also { stage++ }
            ...
            39 -> npc(FaceAnim.OLD_NORMAL, "If I knew more of their locations I would go myself.", "Now go and finish the job.").also { stage++ }
            ...
            43 -> npc(FaceAnim.OLD_NORMAL, "Ah. Interesting. Well, you have served your purpose.", "Now to award you with something appropriate.").also { stage++ }
            44 -> npc(FaceAnim.OLD_NORMAL, "There is a cave near where the fish-men gather. Go to", "the east branch of this cave and seek out the one who lives", "in the Shadow Realm. He will reward you well.").also { stage++ }
            ...
            51 -> npc(FaceAnim.OLD_NORMAL, "Don't worry if you lose it, I can always get more to", "replace it.").also { stage++ }
            52 -> {
                end()
