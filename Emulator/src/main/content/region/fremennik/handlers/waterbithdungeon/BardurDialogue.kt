...
class BardurDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (!isQuestComplete(player, Quests.THE_FREMENNIK_TRIALS)) {
            npcl(FaceAnim.FRIENDLY, "Ah! Outerlander! Do not interrupt me in my business! I must cull these fiends!").also { stage = 0 }
            return true
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npcl(FaceAnim.FRIENDLY, "Only an outerlander would ask such a question! Is it not obvious what I am doing?").also { stage++ }
            ...
            5 -> npcl(FaceAnim.FRIENDLY, "Listen, ${getAttribute(player, "fremennikname", "name")}. I'm sorry about the way I acted while you were exiled.").also { stage++ }
            ...
            11 -> npcl(FaceAnim.FRIENDLY, "Aye, that I can $${getAttribute(player, "fremennikname", "name")}! Yonder lies the lair of the daggermouth kings, the three beasts of legend!").also { stage++ }
            ...
            14 -> npcl(FaceAnim.FRIENDLY, "Ah, you did not come prepared $${getAttribute(player, "fremennikname", "name")}?").also { stage++ }
