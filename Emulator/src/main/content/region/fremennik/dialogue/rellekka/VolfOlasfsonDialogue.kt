...
class VolfOlasfsonDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (!isQuestComplete(player, Quests.THE_FREMENNIK_TRIALS)) {
            ...
            npcl(FaceAnim.ASKING, "Hello again, friend! Does my father send any word... or treasures like before?").also { stage = 2 }
        }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> playerl(FaceAnim.HALF_GUILTY, "Not today, but if he does, you will be the first to know.").also { stage = END_DIALOGUE }
        }
        return true
    }
