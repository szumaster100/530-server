...
class MortenHoldstromDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npcl(FaceAnim.HAPPY, "Ah, today is a surströmming day! The herring I buried six months ago is ready to be dug up.").also { stage++ }
            ...
            5 -> npcl(FaceAnim.HAPPY, "Hmmm, tasty. I'm guessing you don't want to come round and try it?").also { stage++ }
