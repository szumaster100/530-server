    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                3 -> playerl(FaceAnim.THINKING, "Why do you have so much wool in your store? I haven't seen any sheep anywhere.").also { stage = 11 }
            }
            ...
            11 -> npcl(FaceAnim.FRIENDLY, "Ah, I have contacts on the mainland. I have a sailor friend who brings me crates of wool on a regular basis.").also { stage++ }
            12 -> playerl(FaceAnim.ASKING, "What do you trade for it?").also { stage++ }
            13 -> npcl(FaceAnim.FRIENDLY, "Rope of course! What else can we sell? Fish would go off before it got so far south.").also { stage++ }
            14 -> playerl(FaceAnim.ASKING, "Where does all this rope go?").also { stage++ }
            15 -> npcl(FaceAnim.THINKING, "Err, I don't remember the name of the place very well. Dreinna? Drennor? Something like that.").also { stage++ }
