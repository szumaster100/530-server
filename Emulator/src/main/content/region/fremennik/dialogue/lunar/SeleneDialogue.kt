...
class SeleneDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        npc = args[0] as NPC
        if (!teled) {
            if (inInventory(player, Items.SEAL_OF_PASSAGE_9083, 1) || inEquipment(
                    player,
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.NEUTRAL, "Let me see... We value knowledge of self because it is this that gives us our strength! It is most important!").also { stage++ }
            3 -> playerl(FaceAnim.FRIENDLY, "Well... I know things about myself. I know I like hot chocolate!").also { stage++ }
            4 -> npcl(FaceAnim.LAUGH, "I was meaning something a little deeper than that. We also like to see someone listen. You know how they say a wise man listens?").also { stage++ }
            ...
            13 -> {
                ...
                if (borders && !inInventory(player, Items.SEAL_OF_PASSAGE_9083, 1) || !inEquipment(player, Items.SEAL_OF_PASSAGE_9083, 1)) {
                    playerl(
                        FaceAnim.WORRIED,
