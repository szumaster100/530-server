...
class YrsaDiaryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> {
                if (player!!.achievementDiaryManager.getDiary(DiaryType.FREMENNIK)!!.isComplete(1, true) && !Diary.hasClaimedLevelRewards(player!!, DiaryType.FREMENNIK, 1)) {
            ...
            17 -> npc(FaceAnim.NEUTRAL, "Some of the Fremennik diary tasks are simple, some will", "require certain skill levels, and some might require", "quests to be started or completed.").also { stage = 13 }
