...
class CitizenDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FaceAnim.SAD, "That attempt at humour merely made me more depressed. Leave me alone.").also { stage = END_DIALOGUE }
            ...
            306 -> playerl(FaceAnim.HALF_THINKING, "I'll leave you to your sighing. It looks like you have plenty to do.").also { stage = END_DIALOGUE }
        }
        return true
    }
