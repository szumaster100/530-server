...
class AliTheBarmanDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            6 -> npcl(FaceAnim.HALF_ASKING, "I know what you're thinking, asps are a type of snake, right?").also { stage++ }
            7 -> npcl(FaceAnim.HALF_ASKING, "I admit it is a little confusing, but neither 'The Asp' nor 'The Snake' have quite the same ring to them.").also { stage++ }
