...
class ShirattiTheCustodianDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npcl(FaceAnim.FRIENDLY, "Be Careful in here and don't touch anything! There's some old and valuable artefacts around here. Careless outsiders.. you're always coming in and making a mess of things!").also { stage++ }
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "Such ignorance! I suppose I should come to expect it. People are forgetting the old ways of the desert around here. But then..").also { stage++ }
            7 -> npcl(FaceAnim.FRIENDLY, "What do those bureaucratic fools in Menaphos expect! If they're going to take so long to send us a new priestess of She. Do you know we haven't had one for five years now!").also { stage++ }
            8 -> playerl(FaceAnim.HALF_GUILTY, "Errm you still haven't told me what you mean by She.").also { stage++ }
            9 -> npcl(FaceAnim.FRIENDLY, "She! Otherwise known as Elidinis, Goddess of growth and fertility, Lady of the river, Wife of Tumeken, Flower of the desert, Mother of Itchlarin.").also { stage++ }
            10 -> playerl(FaceAnim.HALF_GUILTY, "That all sounds very confusing, I might just call her Elidinis for short.").also { stage = END_DIALOGUE }
        }
        return true
    }
