    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> when (buttonId) {
                ...
                4 -> playerl(FaceAnim.ASKING, "I hear you've been threatening the other shopkeepers.").also {
                    stage = 40
                }
            }
            ...
            37 -> npcl(FaceAnim.FRIENDLY, "Why not? He always likes to meet potential business partners.").also { stage = 1 }
