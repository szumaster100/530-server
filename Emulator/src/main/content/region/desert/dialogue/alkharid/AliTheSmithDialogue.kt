    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> when (buttonId) {
                ...
                4 -> playerl(FaceAnim.HALF_ASKING, "I hear you've been threatening the other shopkeepers.").also { stage = 40 }
            }
            ...
            14 -> npcl(FaceAnim.HALF_GUILTY, "A town to the south of the Shantay Pass, called Pollnivneach.").also { stage = 1 }
            20 -> npcl(FaceAnim.SAD, "Not very much, at the moment. I came from further south to set up a smithy here...").also { stage++ }
            21 -> npcl(FaceAnim.SAD, "...but we still haven't set up the shops, so we have no customers yet.").also { stage = 1 }
            ...
            33 -> npcl(FaceAnim.FRIENDLY, "Of course. He's always happy to talk to possible business partners.").also { stage = 1 }
