...
class ShantayDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (args.size == 2) {
            ...
            npc(FaceAnim.HALF_GUILTY, "If you want to be let out, you have to pay a fine of", "five gold. Do you want to pay now?")
            stage = 25
            return true
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> npc(FaceAnim.HALF_GUILTY, "I see you're new. Please read the billboard poster", "before going into the desert. It'll give yer details on the", "dangers you can face.").also { stage++ }

            1 -> npc(FaceAnim.HALF_GUILTY, "There is a heartbroken mother just past the gates and", "in the desert. Her name is Irena and she mourns her", "lost daughter. Such a shame.").also { stage++ }
            ...
            3 -> when (buttonId) {
                ...
                4 -> player(FaceAnim.HALF_GUILTY, "I want to buy a Shantay pass for 5 gold coins.").also { stage = 34 }
            }

            4 -> npc(FaceAnim.HALF_GUILTY, "So long...").also { stage = END_DIALOGUE }
            10 -> npc(FaceAnim.HALF_GUILTY, "This is the pass of Shantay. I guard this area with my", "men. I am responsible for keeping this pass open and", "repaired.").also { stage++ }

            11 -> npc(FaceAnim.HALF_GUILTY, "My men and I prevent outlaws from getting out of the", "desert. And we stop the inexeperienced from a dry death", "in the sands. Which would you say you were?").also { stage++ }
            ...
            24 -> {
                ...
                queueScript(player, 1, QueueStrength.SOFT) {
                    ...
                    npc(FaceAnim.NEUTRAL, "You'll have to stay in there until you pay the fine of", "five gold pieces. Do you want to pay now?")
                    stage = 25
            ...
            28 -> npc("You have a choice. You can either pay five gold pieces", "or... You can be transported to a maximum security", "prision in Port Sarim").also { stage++ }
            ...
            32 -> npc("You are to be transported to a maximum security", "prision in Port Sarim. I hope you've learn an important", "lesson from this.").also { stage = 35 }
            ...
            36 -> npc("Can I recommend that you purchase a full waterskin", "and a knife! These items will no doubt save your life. A", "waterskin will keep water from evaporating in the desert.").also { stage++ }
            37 -> npc("And a keen woodsman with a knife can extract juice", "from a cactus. Before you go into the desert, it's", "advisable to wear desert clothes. It's very hot in the", "desert and you'll surely cook if you wear amour.").also { stage = END_DIALOGUE }
            38 -> npc("Great, I have just the thing for you the desert adventurer.", "I sell desert clothes which will keep you cool in the heat", "of the desert. I also sell waterskins so that you won't", "die in the desert.").also { stage++ }
            39 -> npc("A waterskin and a knife help you survive from the juice", "of a cactus. Use the chest to store your items, we'll take", "them to the bank. It's hot in the desert, you'll bake in", "all that armour.").also { stage++ }
            40 -> npc("To keep the pass open we ask for 5 gold pieces. And", "we give you a Shantay Pass, just ask to see what I sell", "to buy one.").also { stage++ }
            ...
            43 -> npcl(FaceAnim.NEUTRAL, " Effendi, you insult me! I am not interested in making a profit from you! I merely seek to cover my expenses in keeping this pass open.").also { stage++ }
            44 -> npcl(FaceAnim.HALF_GUILTY, "There is repair work to carry out and also the men's wages to consider. For the paltry sum of 5 Gold pieces, I think we offer a great service.").also { stage = 2 }
        }
        return true
    }
