        ...
        when (quest!!.getStage(player)) {
            ...
            0 -> when (stage) {
                ...
                1 -> when (buttonId) {
                    ...
                    2 -> player(FaceAnim.HALF_GUILTY, "It's just too hot here. How can you stand it?").also {
                        stage = 20
                    }

                    3 -> player(FaceAnim.HALF_GUILTY, "Do you mind if I just kill your warriors?").also { stage = 30 }
                }
