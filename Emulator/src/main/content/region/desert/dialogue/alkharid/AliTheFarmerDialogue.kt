    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> when (buttonId) {
                ...
                4 -> playerl(FaceAnim.ASKING, "I hear you've been threatening the other shopkeepers.").also { stage = 40 }
            }
            ...
            17 -> playerl(FaceAnim.ASKING, "Well, can you at least sell me any gardening tools or seeds?").also { stage++ }
