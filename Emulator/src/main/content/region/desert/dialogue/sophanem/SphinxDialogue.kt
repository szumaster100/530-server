...
class SphinxDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FaceAnim.SAD, "A pity, they can be of great help in", "some adventures. I would like to talk to", "your cat. Would you bring it to me?").also { stage++ }
            4 -> player("I might, but I have a few things to sort out first.").also { stage = END_DIALOGUE }
            5 -> npc(FaceAnim.SUSPICIOUS, "Really? I'm generally quite good at knowing", "these things.").also { stage = END_DIALOGUE }
