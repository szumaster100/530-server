...
class EblisMirrorsDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b
            .onQuestStages(DesertTreasure.questName, 8)
        ...
        b
            .onQuestStages(DesertTreasure.questName, 9, 10)
            .branch { player ->
                ...
                branch
                    ...
                    .player(
                        FaceAnim.THINKING,
                        "So I have all four of these Diamonds of Azzanadra, now",
                        "what?",
                    ).npc(
                ...
                branch
                    ...
                    .let { optionBuilder ->
                        optionBuilder
                            .option("Yes please")
                            .branch { player ->
                                if (inInventory(player, Items.COINS_995, 80000)) {
                                    1
                                } else {
                                    0
                                }
