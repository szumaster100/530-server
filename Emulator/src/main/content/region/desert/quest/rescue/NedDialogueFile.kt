...
class NedDialogueFile(
    val questStage: Int,
) : DialogueFile() {
    private val WIG_WOOL = Item(Items.BALL_OF_WOOL_1759, 3)
    private val WIG = Item(Items.WIG_2421)
        ...
        when (stage) {
            ...
            4 ->
                when (buttonID) {
                    ...
                    3 ->
                        player("Could you repair the arrow holes in the", "back of my shirt?").also {
                            stage =
                                STAGE_REPAIR_HOLES
                        }
                }
            ...
            STAGE_KNIT_SWEATER.substage(1) ->
                npc("I dont't need to be laughted at just 'cos I am getting", "a bit old.").also {
                    stage =
                        END_DIALOGUE
                }
            STAGE_KNIT_WIG ->
            ...
            ->
                interpreter!!
                    .sendDialogue(
                        "You hand Ned 3 balls of wool. Ned works with the wool",
            ...
            -> interpreter!!.sendDialogue("Ned gives you a pretty good wig.").also { stage++ }
            STAGE_KNIT_WIG.substage(7) ->
                player("Thanks Ned, there's more to you than meets the eye.").also {
                    stage =
                        END_DIALOGUE
                }
            STAGE_REPAIR_HOLES ->
                interpreter!!
                    .sendDialogue(
                        "Ned pulls out a nettle and attacks your shirt.",
                    ).also { stage++ }
