...
class PirateJackieDiaryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> when {
                Diary.canClaimLevelRewards(player!!, DiaryType.KARAMJA, 0) -> playerl(
                    FaceAnim.NEUTRAL,
                    "I've done all the easy tasks in my Karamja Achievement Diary."
                ).also { stage = 2 }

                Diary.canReplaceReward(player!!, DiaryType.KARAMJA, 0) -> playerl(
                    FaceAnim.NEUTRAL,
            ...
            4 -> {
                ...
                npcl(
                    FaceAnim.FRIENDLY,
                    "These 'ere Karamja gloves be a symbol of yer explorin' on the island. All the merchants will recognise" + " 'em when yer wear 'em and mabe give ye a little discount. I'll ave a word with some of the seafarin' folk who "
                ).also { stage++ }
            }

            5 -> npcl(
                FaceAnim.FRIENDLY,
                "sail to Port Sarim and Ardougne, so they'll take ye on board half price if year wearin' them. Arrr, take this" + " lamp I found washed ashore too."
            ).also { stage++ }
            ...
            8 -> npcl(
                FaceAnim.FRIENDLY,
                "It's a diary that helps you keep track of particular achievements. Here on Karamja it can help " + "you discover some quite useful things. Eventually, with enough exploration, the people of Karamja will reward you."
            ).also { stage++ }
            ...
            12 -> npcl(
                FaceAnim.FRIENDLY,
                "To claim the different Karamja gloves, speak to Kaleb Paramaya in Shilo Village, one of the jungle " + "foresters near the Kharazi Jungle, or me."
            ).also { stage = 0 }
        }
    }
}