...
class YanniSalikaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            5 -> npc(FaceAnim.FRIENDLY, "You sound a bit bored of Shilo Village...", "what's wrong?").also {
                stage = 100
            }

            6 -> npcl(FaceAnim.FRIENDLY, "Fair enough, come back if you change your mind.").also {
                stage = END_DIALOGUE
            }
            ...
            104 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.FRIENDLY, "An adventurer of my calibre, isn't that overkill.").also {
                    stage = 106
                }
