...
class LubufuDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FaceAnim.HALF_GUILTY, "It's a whip. Which snaps. Like me. Now leave!").also { stage = END_DIALOGUE }
            4 -> npc(FaceAnim.HALF_GUILTY, "I am Lubufu - the only fisherman who knows the secret", "of the Karambwan!").also { stage++ }
