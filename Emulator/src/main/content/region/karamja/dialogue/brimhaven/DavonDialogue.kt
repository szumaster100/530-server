    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                3 -> player(FaceAnim.HALF_ASKING, "Why don't you ever restock some types of amulets?").also {
                    stage = 30
                }
            }
            ...
            30 -> npc(FaceAnim.HALF_GUILTY, "Some of these amulets are very hard to get. I have to", "wait until an adventurer supplies me.").also { stage = END_DIALOGUE }
        }
        return true
    }
