    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (it) {
            0 -> when (stage) {
                ...
                11 -> npcl(FaceAnim.NEUTRAL, "I were diggin for buried treasure when I found it! Amazed I was! It was a sight to behold!").also { stage++ }
                12 -> npcl(FaceAnim.NEUTRAL, "It were the biggest thing I'd ever seen! it must've been at least a league from side to side!").also { stage++ }
                13 -> npcl(FaceAnim.NEUTRAL, "It made me list, I were that excited!").also { stage++ }
                14 -> npcl(FaceAnim.NEUTRAL, "I'd found a huge cave with all these platforms. I reckon it be an ancient civilisation that made it. I had " + "to be mighty careful as there was these traps everywhere! Dangerous it was!").also { stage++ }
                15 -> npcl(FaceAnim.NEUTRAL, "Entrance is only 200 coins!").also { stage = 5 }
                20 -> npcl(FaceAnim.NEUTRAL, "Well, me hearty, it's simple. Ye can cross between two platforms by using the traps or obstacles " + "strung across 'em. Try and make your way to the pillar that is indicated by the flashing arrow.").also { stage++ }
                21 -> npcl(FaceAnim.NEUTRAL, "Ye receive tickets for tagging more than one pillar in a row. So ye won't get a ticket from the " + "first pillar but ye will for every platform ye tag in a row after that.").also { stage++ }
                22 -> npcl(FaceAnim.NEUTRAL, "If ye miss a platform ye will miss out on the next ticket so try and get every platform you can! " + "When ye be done, take the tickets to Jackie over there and she'll exchange them for more stuff!").also { stage++ }
                ...
                32 -> npcl(FaceAnim.AMAZED, "A word of warning me hearty! There are dangerous traps down there!").also { stage++ }
                ...
                43 -> npcl(FaceAnim.NEUTRAL, "So sad, too bad. Go and pickpocket some wealthy people and come back here once you're richer.").also { stage = END_DIALOGUE }
                44 -> {
                    when {
                        (!inInventory(player!!, Items.COINS_995, 99000)) -> {
                            playerl(FaceAnim.NEUTRAL, "But, unfortunately, I don't have enough money with me.").also { stage = 45 }
                        }

                        (freeSlots(player!!)) < 2 -> {
                            npcl(FaceAnim.NEUTRAL, "Unfortunately all Skillcapes are only available with a free hood, it's part of a skill promotion deal; " + "buy one get one free, you know. So you'll need to free up some inventory space before I can sell you one.").also { stage = END_DIALOGUE }
                        }
