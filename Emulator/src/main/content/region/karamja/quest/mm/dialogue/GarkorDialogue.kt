...
import content.region.karamja.quest.mm.DungeonPlanWithAwowogeiCutScene
import core.api.*
...
@Initializable
class GarkorDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            25 -> npcl(FaceAnim.OLD_DEFAULT, "Listen closely whilst I narrate the details...").also {
            ...
            46 -> npcl(FaceAnim.OLD_DEFAULT, "Yes - but do not do so until you are ready.").also {
                stage = END_DIALOGUE
            }
