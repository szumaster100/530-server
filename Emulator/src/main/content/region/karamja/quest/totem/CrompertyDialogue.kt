...
class CrompertyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            10 -> npcl(FaceAnim.HAPPY, "Ah! My latest invention is my patent pending teleportation block! It emits a low level magical signal,").also { stage++ }

            11 -> npcl(FaceAnim.HAPPY, "that will allow me to locate it anywhere in the world, and teleport anything directly to it! I hope to revolutionize the entire teleportation system!").also { stage++ }
            ...
            15 -> npcl(FaceAnim.THINKING, "Well...Hmm. I would guess somewhere between here and the Wizards' Tower in Misthalin.").also { stage++ }

            16 -> npcl(FaceAnim.HAPPY, "All I know is that it hasn't got there yet as the wizards there would have contacted me.").also { stage++ }

            17 -> npcl(FaceAnim.THINKING, "I'm using the GPDT for delivery. They assured me it would be delivered promptly.").also { stage++ }

            18 -> playerl(FaceAnim.ASKING, "Who are the GPDT?").also { stage++ }
            19 -> npcl(FaceAnim.HAPPY, "The Gielinor Parcel Delivery Team. They come very highly recommended.").also { stage++ }

            20 -> npcl(FaceAnim.HAPPY, "Their motto is: \"We aim to deliver your stuff at some point after you have paid us!\"").also { stage = 1000 }

            25 -> npcl(FaceAnim.HAPPY, "By all means! I'm afraid I can't give you any specifics as to where you will come out however. Presumably wherever the other block is located.").also { stage++ }
