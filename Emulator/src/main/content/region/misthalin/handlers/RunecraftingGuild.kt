...
class RunecraftingGuild : MapArea, InteractionListener, InterfaceListener {
    ...
    class WizardElrissDialogue(player: Player? = null) : Dialogue(player) {
        ...
        override fun open(vararg args: Any?): Boolean {
            npc = args[0] as NPC
            if (anyInInventory(player!!, *requiredTalismanItems.map { it.first }.toIntArray()) && !getAttribute(player, ACCESS_TO_OMNI_ITEMS, false)) {
            ...
            when (stage) {
                1 -> {
                    if (allItemsInInventory()) {
                        options("I've lost my omni-talisman.", "What can I do here?", "Can I buy some tokens?", "Never mind.")
                        stage++
                    } else {
                ...
                8 -> npc(FaceAnim.FRIENDLY, "Towards a greater understanding of Runecrafting, of", "course. The basics of Runecrafting may have been re-", "discovered, but many of the secrets of the first", "Wizards' Tower remain unknown.").also { stage++ }
                ...
                10 -> when (buttonId) {
                    ...
                    2 -> playerl(FaceAnim.HALF_ASKING, "Acantha and Vief are hardly working together!").also { stage++ }
                ...
                13 -> when (buttonId) {
                    ...
                    2 -> playerl(FaceAnim.HALF_ASKING, "Yeah, I'm not really interested.").also { stage = END_DIALOGUE }
                }
                ...
                21 -> when (buttonId) {
                    ...
                    3 -> playerl(FaceAnim.HALF_ASKING, "Tell me about Wizard Korvak's pouch repairs.").also { stage = 58 }
                    4 -> playerl(FaceAnim.HALF_ASKING, "Never mind.").also { stage = END_DIALOGUE }
                }
        ...
        private val requiredTalismanItems = listOf(
            1438 to "air", 1448 to "mind", 1444 to "water", 1440 to "earth", 1442 to "fire",
            1446 to "body", 1454 to "cosmic", 1452 to "chaos", 1462 to "nature", 1458 to "law",
            1456 to "death", 1450 to "blood"
        )
    ...
    class WizardAcanthaDialogue(player: Player? = null) : Dialogue(player) {
        ...
        override fun handle(interfaceId: Int, buttonId: Int): Boolean {
            when (stage) {
                ...
                23 -> npc(FaceAnim.ANNOYED, "You need your head right hand and two free", "inventory slots, or I can't give you the necessary", "equipment.").also { stage = END_DIALOGUE }
