        ...
        when (stage) {
            0 -> {
                showTopics(
                    ...
                    Topic("I have some tokens I'd like to cash in.", 1, !inInventory(player, Items.RUNECRAFTING_GUILD_TOKEN_13650)),
            ...
            2 -> {
                val talismans = xpPerTalisman.keys
                if (completeTask) {
                    npc("You've already shown me that you have all the", "talismans, which is why I've already given you an omni", "talisman!")
                    stage = 60
                    return true
                }
            ...
            13 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.HALF_ASKING, "Yeah, I'm not really interested.").also {
                    stage = END_DIALOGUE
                }
            }
