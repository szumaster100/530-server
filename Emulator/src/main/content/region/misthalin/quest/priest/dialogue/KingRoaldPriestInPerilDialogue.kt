        ...
        if (questStage == 0) {
            when (stage) {
                ...
                8 -> when (buttonID) {
                    ...
                    2 -> {
                        npc(
                            "Yes, I dare say it does. I wouldn't even have",
                            "mentioned it had you not seemed to be looking for",
            ...
            when (stage) {
                ...
                3 -> npc(FaceAnim.ANGRY, "YOU DID WHAT???").also { stage++ }
                4 -> npc(
                    FaceAnim.ANNOYED,
                ...
                7 -> player(FaceAnim.WORRIED, "B-but Drezel TOLD me to...!").also { stage++ }
                8 -> npc(
            ...
            when (stage) {
                1 -> npc(
                    "AND MORE IMPORTANTLY, WHY HAVEN'T",
                    "YOU ENSURED THE BORDER TO",
                    "MORYTANIA IS SECURE YET?"
                ).also { stage++ }

                2 -> player("Okay, okay, I'm going, I'm going.... There's no need to", "shout...").also { stage++ }
                3 -> npc("NO NEED TO SHOUT?!").also { stage++ }
                4 -> npc(
                    "Listen, and listen well, and see if your puny mind can",
                    "comprehend this; if the border is not protected, then we",
                    "are at the mercy of the evil beings"
                ).also { stage++ }

                5 -> npc(
                    "that live in Morytania. Given the most of the",
                    "inhabitants consider humans to be nothing more than",
                    "over talkative snack foods, I would"
                ).also { stage++ }

                6 -> npc(
                    "say that me shouting at you for your incompetence is",
                    "the LEAST of your worries right now, NOW GO!"
                ).also { stage = END_DIALOGUE }
            }
