...
class FatherAereckDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (isQuestComplete(player, Quests.THE_RESTLESS_GHOST)) {
            npc(FaceAnim.HAPPY, "Thank you for getting rid of that awful ghost for me!", "May Saradomin always smile upon you!")
            stage = 0
            return true
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                1 -> npc("Certainly. All proceeds are donated to the", "Varrockian Guards' Widows & Orphans Fund.").also { stage = 10 }
            ...
            20 -> npc("He who created the forces of goodness and purity in this", "world? I cannot believe your ignorance!").also { stage++ }

            21 -> npc("This is the god with more followers than any other ...at", "least in this part of the world.").also { stage++ }

            22 -> npc("He who forged the world as we know it, along with his", "brothers Guthix and Zamorak?").also { stage++ }
            ...
            27 -> npc("I thought things not from this world were all, you know,", "slime and tentacles.").also { stage++ }
            ...
            508 -> npc("Oh well. If you do have some spare time on your", "hands, come back and talk to me.").also { stage = END_DIALOGUE }

            509 -> npc("Thank you. The problem is, there is a ghost in the", "church graveyard. I would like you to get rid of it.").also {
            ...
            511 -> npc("I believe he is currently living as a hermit in Lumbridge", "swamp. He has a little shack in the south-west of the", "swamps.").also { stage++ }

            512 -> npc("Exit the graveyard through the south gate to reach the", "swamp. I'm sure if you told him that I sent you he'd", "be willing to help.").also { stage++ }

            513 -> npc("My name is Father Aereck by the way. Pleased to", "meet you.").also { stage++ }
            514 -> player("Likewise.").also { stage++ }
            515 -> npc("Take care travelling through the swamps, I have heard", "they can be quite dangerous.").also { stage++ }
            ...
            521 -> npc("Well, you can get to the swamp he lives in by going", "south through the cemetery.").also { stage++ }

            522 -> npc("You'll have to go right into the western depths of the", "swamp, near the coastline. That is where his house is.").also { stage = END_DIALOGUE }

            530 -> npc("I always wondered what that amulet was... Well, I hope", "it's useful. Tell me when you get rid of the ghost!").also { stage = END_DIALOGUE }
