    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (getQuestStage(player!!, Quests.IMP_CATCHER)) {
            0 -> when (stage) {
                ...
                2 -> options("Give me a quest please.", "Give me a quest or else!", "Just stop messing around and give me a quest!").also { stage++ }
            ...
            10 -> when (stage) {
                ...
                1 ->
                    if (!player!!.inventory.containsItem(Item(1476)) && !player!!.inventory.containsItem(Item(1470)) && !player!!.inventory.containsItem(
                            Item(1472)
                                    ...
                                    when (counter++) {
                                        ...
                                        2 -> {
                                            findLocalNPC(player!!, NPCs.WIZARD_MIZGOG_706)?.let {
                                                animate(
                                                    it,
                                                    Animation(Animations.WIZARD_MIZGOG_COLLECTS_BEADS_IMP_CATCHER_4285)
                                                )
                                            }
