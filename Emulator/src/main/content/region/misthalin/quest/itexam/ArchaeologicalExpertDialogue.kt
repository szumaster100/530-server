...
class ArchaeologicalExpertDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> playerl(FaceAnim.ASKING, "So what does the inscription say? Anything interesting?").also {
            ...
            100 -> npcl(FaceAnim.FRIENDLY, "Okay, give it to me and I'll have a look for you.").also {
                stage = END_DIALOGUE
            }

            200 -> npcl(FaceAnim.FRIENDLY, "Good, let me know if you find anything unusual.").also {
                stage = END_DIALOGUE
            }
