...
class WhatLiesBelow : Quest(Quests.WHAT_LIES_BELOW, 136, 135, 1) {
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (stage) {
            0 -> line(
                player,
                "<blue>I can start this quest by speaking to <red>Rat Burgiss <blue>on the<n><blue>road south of <red>Varrock.<n><blue>Before I begin I will need to:<n>" + getRequiredMessage(
                    player
                ),
                11
            )
