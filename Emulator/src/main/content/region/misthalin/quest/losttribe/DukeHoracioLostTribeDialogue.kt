    ...
    override fun handle(componentID: Int, buttonID: Int) {
        if (questStage == 20) {
            ...
            when (stage) {
                ...
                2 -> sendNormalDialogue(sigmund, FaceAnim.WORRIED, "It is unknown to me, your grace. But the fact it is", "there is enough to prove the Cook's story. It must have", "been dropped by a goblin as it fled.").also { stage++ }
                ...
                6 -> sendNormalDialogue(sigmund, FaceAnim.ANGRY, "That doesn't matter! You said yourself that goblins", "couldn't have made that, so they must have stolen it", "from somewhere.").also { stage++ }

                7 -> sendNormalDialogue(sigmund, FaceAnim.ANGRY, "Horrible, thieving goblins have broken into our cellar!", "We must retaliate immediately!").also { stage++ }

                8 -> sendNormalDialogue(sigmund, FaceAnim.ANGRY, "First we should wipe out the goblins east of the river,", "then we can march on the goblin village to the north-", "west...").also { stage++ }
            ...
            when (stage) {
                ...
                1 -> sendNormalDialogue(sigmund, FaceAnim.ANGRY, "What more proof do we need? Nasty, smelly goblins", "have been living under our feet all this time! We must", "crush them at once!").also { stage++ }

                2 -> npc("Hmm, perhaps you are right. I will send word to the", "army to prepare for an underground assault.").also { stage++ }

                3 -> {
                    npc(player!!.name.replaceFirstChar { if (it.isLowerCase()) it.titlecase() else it.toString() } + ", I would still like you to find out more",
            ...
            when (stage) {
                ...
                1 -> sendNormalDialogue(sigmund, FaceAnim.ANGRY, "And I suppose you believe them, goblin lover?").also { stage++ }
            ...
            when (stage) {
                ...
                2 -> sendNormalDialogue(sigmund, FaceAnim.WORRIED, "Of...of course not! The goblins must have, um, dropped", "the silverware as they ran away.").also { stage++ }
                ...
                4 -> sendNormalDialogue(sigmund, FaceAnim.THINKING, "But don't you see it was for the best? For goblins to be", "living under our feet like this... ugh. It doesn't matter", "how civilised they are: all sub-human species must be", "wiped out!").also { stage++ }
