...
class CalebDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when (qstage) {
            ...
            in 12..15 -> player("Where did you say I could find Avan again?").also { stage = 400 }
            in 16..19 -> player("How are you doing getting the crest pieces?").also { stage = 402 }
        }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            1 -> options(
                ...
                "I see you are a chef... could you cook me anything?"
            ).also { stage = 3 }
            ...
            3 -> when (buttonId) {
                1 -> npc(
                    "Why... yes I am, but I don't believe I know you... ",
                    "how did you know my name?"
                ).also { stage = 5 }

                2 -> player("Nothing I will be on my way.").also { stage = 1000 }
                3 -> npc(
                    "I would, but I am very busy. I am trying to increase ",
                    "my renown as one of the world's leading chefs ",
                    "by preparing a special and unique fish salad."
                ).also { stage = 1000 }
            }
            ...
            5 -> player(
                ...
                "He wishes the Fitzharmon Crest to be restored."
            ).also { stage++ }
            ...
            8 -> when (buttonId) {
                1 -> npc(
                    ...
                    "and we each ended up with a piece of the crest."
                ).also { stage = 100 }

                2 -> npc(
                    "Well, I am the oldest son, so by the rules of chivalry, ",
                    "I am most entitled to be the rightful bearer of the crest."
                ).also { stage = 200 }
            }

            100 -> npc(
                "None of us wanted to give up our rights to our brothers, ",
                "so we didn't want to give up our pieces of the crest, ",
                "but none of us wanted to face our father by returning to ",
                "him with an incomplete crest... "
            ).also { stage++ }

            101 -> npc(
                "We each went our separate ways many years past, ",
            ...
            203 -> npc(
                "so if you will assist me in my search for the ingredients, ",
                "then I will let you take my",
                "piece as reward for your assistance."
            ).also { stage++ }

            204 -> player("So what ingredients are you missing?").also { stage++ }
            205 -> npc(
                "I require the following cooked fish: ",
                "Swordfish, Bass, Tuna, Salmon and Shrimp."
            ).also { stage++ }
            ...
            207 -> when (buttonId) {
                ...
                2 -> npc(
                    ...
                    "of it before I hand it over."
                ).also { stage = 206 }
            }

            300 ->
                if (player.inventory.containItems(315, 329, 361, 365, 373)) {
                    player("Got them all with me.").also { stage++ }
                } else {
                    player("I didn't manage to get them all yet...").also { stage = 320 }
                }

            301 -> sendDialogue("You exchange the fish for Caleb's piece of the crest.").also {
            ...
            303 -> when (buttonId) {
                1 -> npc(
                    "Well... my brothers and I had a slight disagreement about it... ",
            ...
            304 -> npc(
                ...
                "by returning to him with an incomplete crest."
            ).also { stage++ }

            305 -> npc(
                "We each went our separate ways many years past,",
                "none of us seeing our father or willing to",
                "give up our fragments."
            ).also { stage++ }
            ...
            307 -> npc(
                ...
                "I did hear from my brother Avan a while ago though.."
            ).also { stage++ }

            308 -> npc(
                "He said he was on some kind of search for treasure,",
                "or gold, or something out near Al Kharid somewhere. ",
                "Avan always had expensive tastes, so you might try",
                "asking the gem trader for his wherebouts."
            ).also { stage++ }

            309 -> npc(
                "Be warned though. Avan is quite greedy, ",
                "and you may find he is not prepared to hand over ",
                "his crest piece to you as easily as I have."
            ).also { stage = 1000 }

            320 -> npc(
                "Remember, I want the following cooked fish: ",
                "Swordfish, Bass, Tuna, Salmon and Shrimp."
            ).also { stage = 1000 }

            400 -> npc(
                "Last I heard he was on some ",
                "stupid treasure hunt out in the desert somewhere. ",
                "Your best bet is asking around there."
            ).also { stage++ }

            401 -> npc("How are you doing getting the crest pieces?").also { stage++ }
            402 -> player("I am still working on it.").also { stage++ }
            403 ->
                if (player.inventory.containItems(CREST_PIECE.id, 782) || player.bank.containItems(
                        CREST_PIECE.id,
                        782
                    )
                ) {
            ...
            404 -> npc(
                ...
                "and recognised it as mine and returned it to me here."
            ).also { stage++ }
            ...
            406 -> npc(
                "I suggest you be less careless in the future. ",
                "The crest is extremely valuable, and utterly irreplaceable."
            ).also { stage = 1000 }
