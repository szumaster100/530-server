 ...
 *  - Johnathon direct you to kill Chronozon again.
 *  - Avan would also tell you that the previous piece he gave you was a worthless replica, but as the family crest is a symbolic item and given his expertise in jewellery,
 *    it is reasonable to assume he could make a convincing forgery that would still allow the quest to be completed.
 */
@Initializable
