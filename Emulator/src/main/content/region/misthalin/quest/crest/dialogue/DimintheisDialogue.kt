        ...
        when (stage) {
                ...
                when (buttonId) {
                    1 ->
                        npc(
                            ...
                            "until such time as I can show my family crest to him.",
                        ).also {
                            stage =
                                3
                        }
            ...
            5 ->
                when (buttonId) {
                    1 ->
                        npc(
                            "Well, there is a long standing rule of chivalry ",
                            "amongst the Varrockian aristocracy,",
                        ).also {
                            stage =
                                2000
                        }
            ...
            2000 ->
                npc(
                    ...
                    "which signifies the honour and lineage of the family. ",
                ).also {
                    stage++
                }
            2001 ->
                npc(
                    ...
                    "their wealth and lands. If the family crest is lost,",
                ).also {
                    stage++
                }
            2002 ->
            ...
            2003 ->
                npc(
                    ...
                    "devastating the ranks of the ruling classes at that time.",
                ).also {
                    stage++
                }
            2004 ->
            ...
            2006 ->
                when (buttonId) {
                    1 ->
                        npc(
                            "Well, my three sons took it ",
                            "with them many years ago when they rode out ",
                        ).also { stage++ }
            ...
            2009 ->
                npc(
                    ...
                    "trying to earn his fortune as a great fish chef in Catherby.",
                ).also {
                    stage++
                }
            ...
            2012 ->
                if (startQuest(player, Quests.FAMILY_CREST)) {
                    npc(
                        "If you find Caleb, or my other sons... please... ",
                        "let them know their father still loves them...",
                    ).also {
                        stage =
                            1000
                    }
            ...
            3000 ->
                npc(
                    ...
                    "is that he is trying to earn his fortune as a great fish chef.",
                ).also {
                    stage++
                }
            3001 ->
                npc(
                    ...
                    "who lives just outside the west gates of Varrock.",
                ).also {
                    stage =
                        1000
                }
            ...
            5000 ->
                npc(
                    "Adventurer... I can only thank you for your kindness, ",
            ...
            5001 ->
                npc(
                    ...
                    "patch the wounds that have torn this family apart...",
                ).also {
                    stage++
                }
            5002 ->
                npc(
                    ...
                    "have always returned to the head of the family whenever lost,",
                ).also {
                    stage++
                }
            5003 ->
            ...
            5004 ->
                npc(
                    ...
                    "they should be able to imbue them with a skill for you.",
                ).also {
                    stage = 1000
            ...
            6000 ->
                npc("Not to worry, here they are").also {
                    stage = 1000
