...
class AvanDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (qstage < 13) {
            ...
            when (qstage) {
                ...
                17 -> npc("Greetings again, adventurer. How are you doing on retrieving the crest pieces?").also {
                    stage = 400
                }

                18 -> npc("Greetings again, adventurer. How are you doing on retrieving the crest pieces?").also {
                    stage = 400
                }

                19 -> npc("Greetings again, adventurer. How are you doing on retrieving the crest pieces?").also {
                    stage = 400
                }
            }
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            3 -> player(
                "You have a part of your family crest. I am on a quest ",
                "to retrieve all of the fragmented pieces ",
                "and restore the crest."
            ).also { stage++ }
            ...
            101 -> npc(
                "I know how you feel... for such a long time ",
                "I have searched and searched for the elusive perfect gold... ",
                "I thought I had gotten a good lead on finding it "
            ).also { stage++ }

            102 -> npc(
                "when I heard talk of a dwarven expert on gold named Boot ",
                "some time back, but unfortunately for me,",
                "he has returned to his mountain home, which I cannot find."
            ).also { stage = 1000 }

            200 ->
                if (!player.inventory.containItems(774, 773)) {
                    npc(
                        "I have spoken to Boot the dwarf about the location ",
                        "of 'perfect gold', ",
                        "but haven't managed to make you your jewelry yet."
                    ).also { stage++ }
                } else {
            ...
            201 -> npc(
                "Well, I won't entrust you with my piece of the crest ",
                "until you have brought me a necklace of perfect gold ",
                "with a red precious stone, and a perfect gold ring to match."
            ).also { stage = 1000 }
            ...
            301 -> npc(
                "These... these are exquisite! E",
                "XACTLY what I was searching for all of this time! ",
                "Please, take my crest fragment!"
            ).also { stage++ }

            302 -> npc(
                "Now, I suppose you will be wanting to find my brother ",
                "Johnathon who is in possession of the ",
                "final piece of the family's crest?"
            ).also { stage++ }
            ...
            304 -> npc(
                ...
                "and trying to hunt some demon or other out in The Wilderness."
            ).also { stage++ }

            305 -> npc(
                "Unsurprisingly, I do not believe he is doing a particularly good job of things, ",
                "and spends most of his time recovering from his injuries ",
                "in some tavern or other near the eastern edge of The Wilderness. ",
                "You'll probably find him still there."
            ).also { stage++ }
            ...
            403 -> npc(
                "I have a confession myself adventurer... ",
                "I did not fully trust you with the actual part ",
                "of my family's crest before, and gave you a ",
                "worthless replica before... "
            ).also { stage++ }

            404 -> npc(
                "In hindsight, it seems I was right. ",
