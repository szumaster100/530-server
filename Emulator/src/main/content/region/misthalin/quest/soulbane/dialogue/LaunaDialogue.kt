...
class LaunaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> npc(FaceAnim.SAD, "Oh I wish I knew for sure... All I do know is that it", "opened seemingly by itself a few months ago. It was", "first discovered by the students over at the digsite, a", "few of which have gone down there but never returned.").also { stage++ }
            ...
            7 -> npc(FaceAnim.SAD, "I suppose it wouldn't hurt to tell you. I'm waiting to", "see my son Tolna. Don't suppose you've seen him?").also { stage++ }
            ...
            11 -> npc(FaceAnim.SAD, "No. You see, I haven't seen him for... for... 25 years", "now. He just ran away one day and never returned.", "I'm hoping he's down this rift as I know he headed in", "this direction. My husband went to look, but he hasn't").also { stage++ }
