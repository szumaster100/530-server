...
class DukeHoracioRMDialogue(val questStage: Int) : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        if (questStage == 0) {
            when (stage) {
                ...
                11 -> {
                    sendItemDialogue(
                        player!!,
                        talisman,
                        "The Duke hands you an " + Quest.BLUE + "air talisman</col>."
                    ).also { stage++ }
                ...
                20 -> npc(
                    "As you wish, stranger, although I have this strange",
            ...
            when (stage) {
                START_DIALOGUE -> npc(
                    "The only task remotely approaching a quest is the",
                    "delivery of the talisman I gave you to the head wizard",
                    "of the Wizards' Tower,"
                ).also { stage++ }

                1 -> npc(
                    "south-west of here. I suggest you deliver it to him as",
                    "soon as possible. I have the oddest feeling that is",
                    "important..."
                ).also { stage = END_DIALOGUE }
            }
        } else if (questStage > 10) {
