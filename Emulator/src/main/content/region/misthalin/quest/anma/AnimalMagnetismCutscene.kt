    ...
    override fun runStage(stage: Int) {
        when (stage) {
            ...
            2 -> {
                ...
                rotateCamera(44, 0)
                dialogueUpdate(FARMER, FaceAnim.NEUTRAL, "Here, chicky chicky!")
            }
            ...
            10 -> {
                ...
                dialogueUpdate(FARMER, FaceAnim.NEUTRAL, "Git 'ere yer pesky bird!")
            }
            ...
            16 -> {
                ...
                dialogueUpdate(FARMER, FaceAnim.NEUTRAL, "Where'd she go?")
            }
            ...
            18 -> {
                ...
                face(player, getNPC(FARMER)!!.location)
                move(getNPC(CHICKEN)!!, 45, 9)
                dialogueUpdate(FARMER, FaceAnim.ANNOYED, "Git oof my laaaaaand!")
            }

            19 -> {
                face(getNPC(FARMER)!!, getNPC(ALICE)!!.location)
                face(getNPC(ALICE)!!, getNPC(COWKILLER)!!.location)
                dialogueUpdate(ALICE, FaceAnim.ANNOYED, "You heard my husband: leave now!")
            }
            ...
            22 -> {
                dialogueUpdate(ALICE, FaceAnim.SAD, "You killed Bessie!")
            }
            ...
            31 -> {
                ...
                playerDialogueUpdate(FaceAnim.FRIENDLY, "Well, that's one way to catch a chicken, I suppose.")
            }
