        ...
        when (getQuestStage(player!!, Quests.RAG_AND_BONE_MAN)) {
            0 -> {
                when (stage) {
                    ...
                    1 -> playerl(FaceAnim.FRIENDLY, "Well, err...who are you, and what are all these bones doing here?").also { stage++ }
                    ...
                    7 -> playerl(FaceAnim.FRIENDLY, "Well that explains the bones...sort of...but what are you doing all the way out here?").also { stage++ }

                    8 -> npcl(FaceAnim.FRIENDLY, "Errr...").also { stage++ }
                    9 -> npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble. Mumblemumblemumble.").also { stage++ }

                    10 -> npcl(FaceAnim.FRIENDLY, "I'm collecting bones for the museum.").also { stage++ }
                    11 -> npcl(FaceAnim.FRIENDLY, "They have asked me to rig up some displays of second and third age creatures using their bones, so that people can come and...well, look at them.").also { stage++ }

                    12 -> npcl(FaceAnim.FRIENDLY, "I need to get them into some sort of order before I begin, but I've run into a bit of a snag.").also { stage++ }

                    13 -> playerl(FaceAnim.FRIENDLY, "What sort of a snag?").also { stage++ }
                    14 -> npcl(FaceAnim.FRIENDLY, "Well, I need to have all the bones I'm going to use here, and placed into some sort of order.").also { stage++ }

                    15 -> npcl(FaceAnim.FRIENDLY, "However, I seem to have discovered I am a few short.").also { stage++ }
                    ...
                    23 -> npcl(FaceAnim.FRIENDLY, "There is something you could do for me. I'm going to be busy...err...").also { stage++ }

                    24 -> npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumble").also { stage++ }
                    25 -> npcl(FaceAnim.FRIENDLY, "Sorting, yes, sorting these bones out ready for the museum, but I need a few more.").also { stage++ }
                    ...
                    35 -> npcl(FaceAnim.FRIENDLY, "I need some fresh, whole bones to replace ones that have become damaged.").also { stage++ }

                    36 -> playerl(FaceAnim.FRIENDLY, "What?").also { stage++ }
                    37 -> npcl(FaceAnim.FRIENDLY, "Err...").also { stage++ }
                    38 -> npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumblemumblemumblemumble. Mumblemumblemumblemumble. Mumble.").also { stage++ }
                    ...
                    42 -> npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble. Mumblemumblemumble.").also { stage++ }

                    43 -> npcl(FaceAnim.FRIENDLY, "Ok, got it.").also { stage++ }
                    44 -> npcl(FaceAnim.FRIENDLY, "Ok, here is the thing. While sorting out what bones I do have I managed to lose or damage a few. If you can get me some fresh, unbroken bones to use as replacements then I can get on with things.").also { stage++ }
                    ...
                    47 -> npcl(FaceAnim.FRIENDLY, "Great. If you can get me a bone from a Goblin, a Bear, a Big Frog, a Ram, a Unicorn, a Monkey, a Giant rat and a Giant Bat then I'll be able to move on with the...").also { stage++ }

                    48 -> npcl(FaceAnim.FRIENDLY, "Displays...").also { stage++ }
                    49 -> playerl(FaceAnim.FRIENDLY, "So you just want me to bring you these bones and that will be that?").also { stage++ }

                    50 -> npcl(FaceAnim.FRIENDLY, "Well, I wouldn't mind you sticking them in a pot and boiling them in vinegar first, if you don't mind.").also { stage++ }

                    51 -> npcl(FaceAnim.FRIENDLY, "There is a Wine Merchant in Draynor called Fortunato that sells the stuff you'll need.").also { stage++ }
                    ...
                    56 -> npcl(FaceAnim.FRIENDLY, "Just put the bone in a pot of vinegar, throw some logs on the fire, put the pot in the holder and light the logs.").also { stage++ }

                    57 -> npcl(FaceAnim.FRIENDLY, "It takes a while for the vinegar to evaporate, but the bone will be nice and clean in the end.").also { stage++ }

                    58 -> playerl(FaceAnim.FRIENDLY, "All right, I'll be back later.").also { stage++ }
                    59 -> npcl(FaceAnim.FRIENDLY, "Bye!").also {
                        setQuestStage(player!!, Quests.RAG_AND_BONE_MAN, 1)
                        stage = END_DIALOGUE
                    }

                    60 -> npcl(FaceAnim.FRIENDLY, "Oh...I see.").also { stage++ }
                    61 -> npcl(FaceAnim.FRIENDLY, "Well, never mind me young man, I'll just stagger over here under my massive burden, and continue my thankless task.").also { stage++ }
            ...
            in 1..3 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.FRIENDLY, "Come and see me when you have the rest.").also {
                        stage = END_DIALOGUE
                    }

                    4 -> npcl(FaceAnim.FRIENDLY, "The museum will be thrilled to know I've completed the collection.").also { stage++ }
                    ...
                    8 -> npcl(FaceAnim.FRIENDLY, "I'm always on the lookout for fresh bones, so if you see some bring them right over.").also { stage++ }

                    9 -> playerl(FaceAnim.FRIENDLY, "No problem, I'll be sure to bring anything you might like over if I find something.").also { stage++ }

                    10 -> playerl(FaceAnim.FRIENDLY, "I can't wait to see the displays once they are finished.").also { stage++ }
                    ...
                    30, 40, 50, 60, 70, 80, 90, 100, 110 -> {
                        if (!getAttribute(player!!, RagAndBoneMan.attributeGoblinBone, false) && stage <= 30) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 31
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeBearBone, false) && stage <= 40) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 41
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeBigFrogBone, false) && stage <= 50) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 51
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeRamBone, false) && stage <= 60) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 61
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeUnicornBone, false) && stage <= 70) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 71
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeMonkeyBone, false) && stage <= 80) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 81
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeGiantRatBone, false) && stage <= 90) {
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 91
                            ...
                            npcl(NPCs.BONES_3674, "Sack", FaceAnim.OLD_HAPPY, "Mumblemumble"); stage = 101
                        } else {
