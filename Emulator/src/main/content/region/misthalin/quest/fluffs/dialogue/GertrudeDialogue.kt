    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            7 -> when (buttonId) {
                ...
                2 -> player(FaceAnim.HALF_GUILTY, "Sorry, I'm to busy too play pet rescue.").also {
                    stage = END_DIALOGUE
                }
            }
            ...
            214 -> npcl(FaceAnim.HALF_GUILTY, "Hmmm...strange, he should be at the market.").also {
                stage = END_DIALOGUE
            }
