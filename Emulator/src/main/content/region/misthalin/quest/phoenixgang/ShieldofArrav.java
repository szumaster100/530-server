...
import content.region.misthalin.quest.phoenixgang.handlers.JohnnyBeardNPC;
import content.region.misthalin.quest.phoenixgang.handlers.ShieldArravPlugin;
...
public class ShieldofArrav extends Quest {
    ...
    public static final Item BOOK = new Item(Items.BOOK_757);

    public static final Item INTEL_REPORT = new Item(Items.INTEL_REPORT_761);

    public static final Item KEY = new Item(Items.WEAPON_STORE_KEY_759);

    public static final Item PHOENIX_SHIELD = new Item(Items.BROKEN_SHIELD_763);

    public static final Item BLACKARM_SHIELD = new Item(Items.BROKEN_SHIELD_765);

    public static final Item BLACKARM_CERTIFICATE = new Item(Items.HALF_CERTIFICATE_11174, 2);

    public static final Item PHOENIX_CERTIFICATE = new Item(Items.HALF_CERTIFICATE_11173, 2);

    public ShieldofArrav() {
        super(Quests.SHIELD_OF_ARRAV, 29, 28, 1, Vars.VARP_QUEST_SHIELD_OF_ARRAV_PROGRESS_145, 0, 1, 7);
    }

    @Override
    public Quest newInstance(Object object) {
        ClassScanner.definePlugins(new JohnnyBeardNPC(), new JonnytheBeardDialogue(), new KatrineDialogue(), new KingRoaldDialogue(), new ReldoDialogue(), new ShieldArravPlugin(), new StravenDialogue(), new WeaponsMasterDialogue());
        return this;
    }
    ...
    public void finish(Player player) {
        ...
        player.getPacketDispatch().sendItemZoomOnInterface(Items.PHOENIX_CROSSBOW_767, 1, 230, 277, 3 + 2);
