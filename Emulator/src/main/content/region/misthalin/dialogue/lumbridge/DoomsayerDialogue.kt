...
class DoomsayerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npc(FaceAnim.HALF_GUILTY, "All around us! I can feel it in the air, hear it on the", "wind smell it....also in the air!").also { stage = 2 }
            2 -> player(FaceAnim.HALF_GUILTY, "Is there anything we can do about this doom?").also { stage++ }
            3 -> npc(FaceAnim.HALF_GUILTY, "There is nothing you need to do my friend! I am the", "Doomsayer, although my real title could be something like", "the Danger Tutor.").also { stage++ }
            ...
            6 -> npc(FaceAnim.HALF_GUILTY, "If I find a dangerous area, then I put up warning signs", "that will tell you what is so dangerous about that area.").also { stage++ }
            7 -> npc(FaceAnim.HALF_GUILTY, "If you see the signs often enough, then you can", "turn them off; by that time you likely know what the", "area has in store for you.").also { stage++ }
            ...
            10 -> npc(FaceAnim.HALF_GUILTY, "If you want to see the warning messages again, I", "can turn them back on for you.").also { stage++ }
