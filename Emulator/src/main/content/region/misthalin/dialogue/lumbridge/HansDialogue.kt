...
class HansDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> options("I'm looking for whoever is in charge of this place.", "I have come to kill everyone in this castle!", "I don't know. I'm lost. Where am I?", "Have you been here as long as me?").also { stage++ }

            1 -> when (buttonId) {
                1 -> npc(FaceAnim.NEUTRAL, "Who, the Duke? He's in his study, on the first floor.").also {
                    stage = END_DIALOGUE
                }
                2 -> {
                ...
                4 -> npcl(FaceAnim.NEUTRAL, "I've been patrolling this castle for years, I remember you...").also { stage++ }
            }
            2 -> {
            ...
            4 -> npc(FaceAnim.LAUGH, "Haha, you could say I'm quite the veteran of these lands.", "Yes, I've been here a fair while...").also { stage = END_DIALOGUE }
        }
        return true
    }
