...
class GeeDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            12 -> npc(FaceAnim.HALF_GUILTY, "Yeah, unfortunately I don't seem to be able to look up.").also { stage = END_DIALOGUE }
            20 -> npc(FaceAnim.HALF_GUILTY, "Nope, sorry.").also { stage = END_DIALOGUE }
            30 -> npc(FaceAnim.FURIOUS, "It's not a stick! I'll have you know it's a very powerful", "staff!").also { stage++ }
            ...
            34 -> npc(FaceAnim.HALF_GUILTY, "...Ok it's a stick.. But only while I save up for a staff.", "Zaff in Varrock square sells them in his shop.").also { stage++ }
