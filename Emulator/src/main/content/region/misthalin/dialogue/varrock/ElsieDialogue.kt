...
class ElsieDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> npcl(
                FaceAnim.FRIENDLY,
                "He could do with something to keep his neck warm, standing in " + "that draughty old church all day."
            ...
            5 -> npcl(
                FaceAnim.NEUTRAL,
                "Well, dearie, I am probably not the best person to ask about money, but I think the best thing " + "would be for you to get a good trade."
            ).also { stage++ }
            ...
            7 -> npcl(
                FaceAnim.HALF_WORRIED,
                "Saradomin rest his soul. I hear people try to get rich by fighting in the Wilderness north of here " + "or the Duel Arena in the south... But that's no way for honest folk to earn a living!"
            ).also { stage++ }
            ...
            15 -> npcl(
                ...
                "I saw him here in the church quite often. Everyone said he was going to become a priest and " + "we girls were so sad about that..."
            ).also { stage++ }
            ...
            17 -> npcl(
                FaceAnim.NEUTRAL,
                "One night he gathered some lads together, and after the evening prayer-meeting " + "they all put their masks on..."
            ).also { stage++ }

            18 -> npcl(
                FaceAnim.NEUTRAL,
                "Then, they snuck down to the temple in the south of the city - the evil one. " + "The next day, there was quite a hubbub..."
            ).also { stage++ }
            ...
            22 -> npcl(
                FaceAnim.NEUTRAL,
                "Old Father Packett was furious, but Dissy just laughed it off. " + "Dissy left town after that, saying he wanted to see the world."
            ).also { stage++ }
            ...
            24 -> npcl(
                FaceAnim.HAPPY,
                "One day, a young man came here looking for stories about Dissy - of course, " + "that's not his proper name, but his friends called him Dissy - and I told " + "him that one. "
            ).also { stage++ }

            25 -> npcl(
                FaceAnim.HALF_WORRIED,
                "He said Dissy had become a really famous man and there was going to be a book about him. " + "That's good and all, but I do wish Dissy had just come back to Varrock. I did miss him so much... "
            ).also { stage++ }
            ...
            27 -> playerl(FaceAnim.FRIENDLY, "Thank you. I'll leave you to your knitting now.").also {
                stage = END_DIALOGUE
            }
        }
        return true
