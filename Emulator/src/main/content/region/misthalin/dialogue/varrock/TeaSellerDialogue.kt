...
class TeaSellerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FaceAnim.HALF_GUILTY, "Well, if you're sure. You know where to come if you do.").also { stage = END_DIALOGUE }
            4 -> npc(FaceAnim.HALF_GUILTY, "Only the most delicious infusion of the leaves of the tea", "plant. Grown in the exotic regions of this world. Buy", "yourself a cup.").also { stage = END_DIALOGUE }
        }
        return true
    }
