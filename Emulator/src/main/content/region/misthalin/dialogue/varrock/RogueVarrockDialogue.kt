...
class RogueVarrockDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                1 -> playerl(FaceAnim.HALF_ASKING, "Up at the Rogues' Castle, you mentioned a business. What was that about?").also { stage++ }
                2 -> playerl(FaceAnim.NEUTRAL, "Nothing.").also { stage = END_DIALOGUE }
            }
            2 -> npcl(FaceAnim.FRIENDLY, "Ah, yes, I run...what do you call it? Something of a little jewellery business. So, if you happen to come across any unenchanted gold jewellery, I'll gladly take it off your hands for a decent sum of coins.").also { stage++ }
            3 -> playerl(FaceAnim.HALF_ASKING, "Only gold jewellery?").also { stage++ }
            4 -> npcl(FaceAnim.FRIENDLY, "Correct. I'm not buying anything that isn't beautiful, bright gold. My...eh...clients are picky about that.").also { stage++ }
            ...
            7 -> npcl(FaceAnim.FRIENDLY, "Good, good. Just hand it over and I'll see what I can give for it.").also { stage = END_DIALOGUE }
        }
