    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (quest.getStage(player)) {
            ...
            10 -> when (stage) {
                ...
                10 -> {
                    player(FaceAnim.HALF_GUILTY, "Ernest's fiancee. She probably doesn't want to marry a", "chicken.")
                    stage = 11
                }
            ...
            20 -> when (stage) {
                0 ->
                    stage = if (player.inventory.containsItem(OIL_CAN) && player.inventory.containsItem(
                            PRESSURE_GAUGE
