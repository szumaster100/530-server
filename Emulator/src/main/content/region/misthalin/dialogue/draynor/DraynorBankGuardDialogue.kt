        ...
        when (stage) {
            ...
            73 -> {
                if (inBank(player, Items.COINS_995, 50)) {
                    npc("As a bank employee, I suppose I could take the money", "directly from your bank account.").also { stage = 74 }
                } else {
                    npc("Come back when you do.").also { stage = 75 }
                }
            }

            74 -> options("Ok, you can take 50 gp from my bank account.", "Thanks, maybe another day.").also {
                stage = 76
            }
            ...
            79 -> {
                ...
                if (inBank(player, Items.COINS_995, 50) && removeItem(player, Item(Items.COINS_995, 50), Container.BANK)) {
            ...
            21 -> options("Are you going to tell me what happened?", "Alright, I'll stop bothering you now.").also { stage++ }
            22 -> when (buttonId) {
            ...
            52 -> npc("The Bank has already replaced all the stolen items that", "belonged to customers.").also { stage++ }
            ...
            60 -> npc("We are fairly sure we know who the robber was. The", "security recording was damaged in the attack, but it still", "shows his face clearly enough.").also { stage++ }
            ...
            67 -> end()
            68 -> npc("Alright... The bank's magical playback device will feed the", "recorded images into your mind. Just shut your eyes.").also { stage++ }
