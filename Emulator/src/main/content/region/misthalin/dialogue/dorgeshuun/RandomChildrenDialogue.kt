...
class RandomChildrenDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when ((1..5).random()) {
            ...
            2 -> npcl(FaceAnim.OLD_NORMAL, "Are you " + player.name + "? Did you help Zanik save the city?").also { stage = 10 }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npcl(FaceAnim.OLD_NORMAL, "Haha! You look funny! All tall and skinny with tiny eyes!").also { stage = 99 }
            10 -> player(FaceAnim.FRIENDLY, "Yes, that was me!").also { stage++ }
            11 -> npcl(FaceAnim.OLD_NORMAL, "When I'm older I'm going to be an adventurer, just like Zanik!").also { stage = 99 }
