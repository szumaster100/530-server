...
class BrotherJeredDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (isMaster(player, Skills.PRAYER)) {
            ...
            stage = 200
        } else if (inInventory(player, Items.HOLY_ELIXIR_13754, 1) && inInventory(
                player,
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> when (buttonId) {
                ...
                2 -> npcl(FaceAnim.HALF_GUILTY, "Yes! Praise he who brings life to this world.").also {
                    stage = END_DIALOGUE
                }
            }
