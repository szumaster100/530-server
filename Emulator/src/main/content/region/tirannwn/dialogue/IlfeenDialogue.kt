...
class IlfeenDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            10 -> npcl(FaceAnim.HAPPY, "Of course! I remember him from when I was living in the eastern lands. He was just a budding engineer then. I rather liked the young gnome: he was rather loud, but he had a good soul.").also { stage++ }
            11 -> npcl(FaceAnim.HAPPY, "He was very interested in elven magic. Last time we spoke, not too long ago, he was very interested in illusion magic and how to dispel it. I gave him some advice and a few pieces of equipment to help him.").also { stage++ }
            12 -> playerl(FaceAnim.THINKING, "I think Oaknock died of old age a few hundred years ago now.").also { stage++ }
            13 -> npcl(FaceAnim.HALF_GUILTY, "I keep forgetting, a hundred years is a long time for you.").also { stage++ }
            ...
            20 -> npcl(FaceAnim.ASKING, "I am, but you'll need your own seed. I can also chant your shield or bow back to full charges if you have it with you. Would you like me to enchant anything?").also { stage++ }
