...
class ElfTrackerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (!tracksFound) {
            ...
            playerl(FaceAnim.NEUTRAL, "I've found tracks leading off to the west. But they trail off into the trees. Beyond that I am unable to follow.").also { stage = 30 }
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> playerl(FaceAnim.HALF_GUILTY, "No, I'm " + player.name + "! Lord Iorwerth said you might be able to help me.").also { stage++ }
            ...
            10 -> npcl(FaceAnim.ANNOYED, "As I was saying... I have no time for brigands or outlaws.").also { stage = END_DIALOGUE }
            20 -> npcl(FaceAnim.FRIENDLY, "That is Lord Iorwerth's pendant. He must have a lot of faith in you. Now, what is it I can help you with?").also { stage++ }
            21 -> playerl(FaceAnim.ASKING, "I need to find Tyras and kill him. Do you know where his camp is?").also { stage++ }
            22 -> npcl(FaceAnim.FRIENDLY, "Well this was his old camp. After the battle a few days ago they moved. We're yet to find them again.").also { stage++ }
            23 -> player(FaceAnim.ASKING, "Can I help at all?").also { stage++ }
            24 -> npcl(FaceAnim.FRIENDLY, "As it goes I'm not actually tracking them at the moment. I'm currently trying to trace our renegade brethen instead. This here is the best lead we've found so far.").also { stage++ }
            ...
            27 -> npcl(FaceAnim.THINKING, "I tell you what. Now that you're here I may as well give you a hand. I'll search here on the east side. You check out the west end of the camp.").also { stage++ }
            ...
            43 -> npcl(FaceAnim.FRIENDLY, "I'm sure Lord Iorwerth will be pleased to hear that. You should let him know.").also { stage = END_DIALOGUE }
        }
        return true
    }
