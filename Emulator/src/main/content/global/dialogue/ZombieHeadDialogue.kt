...
class ZombieHeadDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "Well if I keep it all bottled up I'll turn into a total head case.").also { stage = 0 }
            ...
            19 -> npcl(FaceAnim.ANNOYED, "Because I used to be able to do a handstand for over an hour while juggling cannon balls with my feet...").also { stage++ }
            ...
            32 -> npcl(FaceAnim.ANNOYED, "Because currently you wave me about by my hair, and it hurts.").also { stage = 0 }
            ...
            39 -> npcl(FaceAnim.ANNOYED, "If I try really hard I might be able to will myself deader...").also { stage = 0 }
        }
    }
}