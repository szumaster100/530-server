    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (dialOpt == 1) {
            ...
            if (correctKeyValue == 4) {
                ...
                npc(FaceAnim.SAD, "Aww, that was the wrong key! You must have popped", "the wrong sort of animal. Try the big lever again; it'll", "tell you which animal to pop.")
                unlock(player!!)
            }
        } else if (dialOpt == 4) {
            when (stage) {
            ...
            when (stage) {
                ...
                1 -> when (buttonID) {
                    ...
                    2 -> player(FaceAnim.NEUTRAL, "How do I get out of here?", "I can't be held captive by a cat!").also { stage = 6 }
                }
                ...
                5 -> player(FaceAnim.NEUTRAL, "How do I get out of here?", "I can't be held captive by a cat!").also { stage++ }
                ...
                10 -> npc(FaceAnim.SAD, "You haven't got a life sentence, so they'll let you out in", "3 minutes, but you should be able to escape much", "faster if you go pull that lever and pop the right balloon", "animals.").also { stage = END_DIALOGUE }
            }
        }
    }
}