    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> {
                ...
                } else playerl(FaceAnim.ANNOYED, "Let me out of here!").also { stage++ }
            }
            ...
            101 -> npcl(FaceAnim.CHILD_NORMAL, "Because I say so! And because I can never have enough servants!").also { stage++ }
            ...
            104 -> npcl(FaceAnim.CHILD_NORMAL, "Talk to my other servants, and hurry it up!").also { stage = END_DIALOGUE }
            200 -> npcl(FaceAnim.CHILD_NORMAL, "Sit down and I'll tell you. It's a question of servant shortage.").also { stage++ }
            201 -> playerl(FaceAnim.NEUTRAL, "Go on.").also { stage++ }
            202 -> npcl(FaceAnim.CHILD_NORMAL, "You are a skilled worker. A human like you is worth a great deal as a slave.").also { stage++ }
            203 -> playerl(FaceAnim.ANGRY, "A slave?? I will have nothing to do with you. Is that clear? Absolutely nothing.").also { stage++ }
            204 -> npcl(FaceAnim.CHILD_NORMAL, "Now be reasonable little human. It's just a matter of time before you will do everything I ask you to. Play along and this can be a very nice place.").also { stage++ }
            205 -> playerl(FaceAnim.ANGRY, "I will not make any deals with you. I'm a human. I will not be pushed, numbered, meowed at, teleported or enslaved. My life is my own.").also { stage++ }
            ...
            302 -> npcl(FaceAnim.CHILD_NORMAL, "Most humans do, that's why I'm wearing this amulet of Man speak... but I do try to train my staff in civilised speech.").also { stage++ }
            303 -> npcl(FaceAnim.CHILD_NORMAL, "Ah, but I suppose things are slightly different in your world... what a dreadful place that must be.").also { stage++ }
            ...
            401 -> npcl(FaceAnim.CHILD_NORMAL, "Oh, you mean the Bob in your world? Nothing. I am an incarnation of Bob here on Scape2009.").also { stage++ }
            402 -> playerl(FaceAnim.NEUTRAL, "What, you mean this is... like some kind of mirror land?").also { stage++ }
            403 -> npcl(FaceAnim.CHILD_NORMAL, " Something like that... somewhere in Scape2009 there must be a human servant called ${player!!.username}.").also { stage++ }
            404 -> npcl(FaceAnim.CHILD_NORMAL, "But you work just as well for me! Now get to work, human! Fish for me!").also { stage = END_DIALOGUE }
            500 -> {
            ...
            601 -> npcl(FaceAnim.CHILD_NORMAL, "Don't you know what kind of fish I like? Talk to my other servants for some advice.").also { stage++ }
            ...
            701 -> npcl(FaceAnim.CHILD_NORMAL, "You heard me! There's the cold fire, by the trees, now get uncooking!").also { stage = END_DIALOGUE }
