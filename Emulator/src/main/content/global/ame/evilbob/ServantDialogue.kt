...
class ServantDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            3 -> playerl(FaceAnim.FRIENDLY, "Away from this place! To " + GameWorld.settings!!.name + " proper!").also { stage++ }

            4 -> npcl(FaceAnim.SAD, "You go, ${player!!.username}, I don't belong there... I belong here, in Scape2009. This is the only place I can ever go...").also { stage++ }

            5 -> options("But I love you!", "Oh alright then.").also { stage++ }
            6 -> when (buttonID) {
                1 -> playerl(FaceAnim.SAD, "But I love you!").also { stage = 100 }
                2 -> playerl(FaceAnim.NEUTRAL, "Oh, alright then, I'll be off! See you around!").also {
                    stage = END_DIALOGUE
                }
            }
            ...
            201 -> playerl(FaceAnim.ANGRY, "Now you listen to me! He's just a little cat! There must be something I can do!").also { stage++ }

            202 -> npcl(FaceAnim.SAD, "F-f-f-fish... give him the f-f-f-fish he likes and he might f- f-f-fall asleep.").also { stage++ }
