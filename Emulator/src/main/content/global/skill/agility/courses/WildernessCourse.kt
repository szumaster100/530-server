            ...
            object : Pulse(1, player) {
                ...
                override fun pulse(): Boolean {
                    when (++counter) {
                        2 -> {
                            val end =
                                if (fail) Location.create(2998, 3924, 0) else if (scenery.id < 2309) Location.create(
                                    2998,
                                    3917,
                                    0
                        ...
                        15 -> player.lock(3)
                        16 -> {
                            val doorLoc = if (scenery.id < 2309) Location(2998, 3917, 0) else Location(2998, 3931, 0)
