...
class AgilityTrainerDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (stages == 1) {
            npcl(FaceAnim.CHILD_NORMAL, "You need to take your headgear off before you try the Deathslide, otherwise you won't be able to get a good enough grip with your teeth.").also { stage = END_DIALOGUE }
        } else {
...
class AgilityTrainerStickDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.CHILD_NORMAL, "Come on, get round that course - I need something to chew!").also { stage = END_DIALOGUE }
        }
    }
}