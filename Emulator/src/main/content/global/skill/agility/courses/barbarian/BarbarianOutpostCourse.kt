...
@Initializable
class BarbarianOutpostCourse @JvmOverloads constructor(player: Player? = null) :
    ...
    override fun handle(player: Player, node: Node, option: String): Boolean {
        ...
        when (id) {
            ...
            1948 -> {
                ...
                val flag = if (node.location == Location(2536, 3553, 0)) 4 else if (node.location == Location(
                        2539,
                        3553,
                        0
                    )
