...
@Initializable
public class SpiritGuthatriceDialogue extends Dialogue {

    @Override
    public Dialogue newInstance(Player player) {
        return new SpiritGuthatriceDialogue(player);
    }

    public SpiritGuthatriceDialogue() {}

    public SpiritGuthatriceDialogue(Player player) {
        super(player);
    }
    ...
    @Override
    public int[] getIds() {
        return new int[]{NPCs.SPIRIT_GUTHATRICE_6877, NPCs.SPIRIT_GUTHATRICE_6878};
    }
}
