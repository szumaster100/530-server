...
@Initializable
public class SpiritZamatriceDialogue extends Dialogue {

    @Override
    public Dialogue newInstance(Player player) {
        return new SpiritZamatriceDialogue(player);
    }

    public SpiritZamatriceDialogue() {}

    public SpiritZamatriceDialogue(Player player) {
        super(player);
    }
    ...
    @Override
    public int[] getIds() {
        return new int[]{NPCs.SPIRIT_ZAMATRICE_6881, NPCs.SPIRIT_ZAMATRICE_6882};
    }
}
