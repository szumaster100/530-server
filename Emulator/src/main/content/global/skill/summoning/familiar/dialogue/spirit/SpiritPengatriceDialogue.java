...
@Initializable
public class SpiritPengatriceDialogue extends Dialogue {

    @Override
    public Dialogue newInstance(Player player) {
        return new SpiritPengatriceDialogue(player);
    }

    public SpiritPengatriceDialogue() {}

    public SpiritPengatriceDialogue(Player player) {
        super(player);
    }
