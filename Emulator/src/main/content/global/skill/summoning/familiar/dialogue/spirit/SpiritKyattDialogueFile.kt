    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (randomConversation == 0) {
            when (stage) {
                ...
                5 -> playerl(FaceAnim.FRIENDLY, "Is it Zamorak? That would explain why he's so cranky.").also { stage++ }
                6 -> npcl(FaceAnim.OLD_DEFAULT, "Please do not make me destroy you before I get my belly rub!").also { stage = END_DIALOGUE }
            }
        }
        ...
        if (randomConversation == 1) {
            when (stage) {
                ...
                3 -> npcl(FaceAnim.OLD_DEFAULT, "I do not have time for your distractions. Leave me be!").also { stage++ }
        ...
        if (randomConversation == 2) {
            when (stage) {
                ...
                1 -> npcl(FaceAnim.OLD_DEFAULT, "Human, leave me be. I'm far too busy to deal with your nonsense.").also { stage++ }
        ...
        if (randomConversation == 3) {
            when (stage) {
                ...
                3 -> npcl(FaceAnim.OLD_DEFAULT, "I am not one of your playful kittens, human. I eat playful kittens for breakfast!").also { stage++ }
                ...
                6 -> npcl(FaceAnim.OLD_DEFAULT, "I will...purrrrr...ooh that's quite nice...destroy...purrrrrrr...you.").also { stage = END_DIALOGUE }
            }
        }
        ...
        if (inInventory(player!!, Items.BALL_OF_WOOL_1759, 1)) {
            when (stage) {
                ...
                4 -> npcl(FaceAnim.OLD_DEFAULT, "Aha! Ball of wool: you are mine now. I will destroy you!").also { stage++ }
                5 -> playerl(FaceAnim.FRIENDLY, "Well I'm not giving it to you, now! I'll never get it back.").also { stage++ }
                6 -> npcl(FaceAnim.OLD_DEFAULT, "Then you leave me no choice but to destroy YOU, human!").also { stage++ }
