...
@Initializable
public class SpiritCoraxatriceDialogue extends Dialogue {

    @Override
    public Dialogue newInstance(Player player) {
        return new SpiritCoraxatriceDialogue(player);
    }

    public SpiritCoraxatriceDialogue() {}

    public SpiritCoraxatriceDialogue(Player player) {
        super(player);
    }
    ...
    @Override
    public int[] getIds() {
        return new int[]{NPCs.SPIRIT_CORAXATRICE_6885, NPCs.SPIRIT_CORAXATRICE_6886};
    }
}
