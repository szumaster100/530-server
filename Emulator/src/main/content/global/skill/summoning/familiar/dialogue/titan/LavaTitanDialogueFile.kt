    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when ((0..4).random()) {
            0 -> when (stage) {
                ...
                1 -> npcl(FaceAnim.CHILD_NORMAL, "It is quite beautiful. The perfect sort of day for a limerick. Perhaps, I could tell you one?").also { stage++ }
                ...
                7 -> npcl(FaceAnim.CHILD_NORMAL, "But at least half a page it did fill.").also { stage = END_DIALOGUE }
            }

            1 -> when (stage) {
                0 -> playerl(FaceAnim.FRIENDLY, "I was just thinking about the River Lum, Titan. Isn't it beautiful?").also { stage++ }
                1 -> npcl(FaceAnim.CHILD_NORMAL, "I had a bad experience with the River Lum once. Would you like me to tell you about it?").also { stage++ }
                2 -> playerl(FaceAnim.FRIENDLY, "Well, okay, but only if it's in the form of a limerick.").also { stage++ }
            ...
            2 -> when (stage) {
                ...
                1 -> npcl(FaceAnim.CHILD_NORMAL, "Money doesn't always bring happiness. I know a limerick about money as it happens. Would you like to hear it?").also { stage++ }
            ...
            3 -> when (stage) {
                0 -> playerl(FaceAnim.FRIENDLY, "I'm quite a warrior, you know, Titan! I was just reminiscing about how I defeated Glough.").also { stage++ }
                1 -> npcl(FaceAnim.CHILD_NORMAL, "Glough, eh? I've heard of that fellow. In fact, I happen to know a limerick about him.").also { stage++ }
                2 -> playerl(FaceAnim.FRIENDLY, "Oh, really? Well, I'm quite busy; perhaps you could tell me some oth").also { stage++ }
            ...
            4 -> when (stage) {
                ...
                1 -> npcl(FaceAnim.CHILD_NORMAL, "Hmm...no, I don't think so. I don't need to eat, you see.").also { stage++ }
                2 -> playerl(FaceAnim.FRIENDLY, "Oh, how awful. Food is delicious, you'd love it!").also { stage++ }
                3 -> npcl(FaceAnim.CHILD_NORMAL, "It's alright. I met a dwarf once who described it all to me. In fact, I wrote a limerick in his honour.").also { stage++ }
                ...
                9 -> npcl(FaceAnim.CHILD_NORMAL, "Then he'd eat it and let out a sigh.").also { stage = END_DIALOGUE }
            }
        }
    }
}