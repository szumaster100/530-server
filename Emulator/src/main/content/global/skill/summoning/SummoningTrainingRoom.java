...
public final class SummoningTrainingRoom extends OptionHandler {
        ...
        switch (option) {
            ...
            case "open":
                if (quest.getStage(player) < 40) {
                    player.getPacketDispatch().sendMessage("The trapdoor appears to be locked.");
                    return true;
            ...
            case "climb-down":
                ...
                if (!scenery.getLocation().equals(Location.create(2927, 3444, 0))) {
                    return false;
                }
                loc = Location.create(2209, 5348, 0);
                break;
            case "climb":
                if (!scenery.getLocation().equals(Location.create(2209, 5349, 0))) {
                    return false;
                }
    ...
    public static final class FluffyCutscene extends CutscenePlugin {
        ...
        public static final class FluffyDialogue extends Dialogue {
            ...
            private static final Graphics GRAPHICS = new Graphics(1522);
