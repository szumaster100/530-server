...
@Initializable
class GeckoDialogue(player: Player? = null) : Dialogue(player) {

    private val babyGecko = intArrayOf(
    ...
    private val adultGecko = intArrayOf(
        NPCs.GECKO_6916,
        NPCs.GECKO_7281,
        NPCs.GECKO_7282,
        NPCs.GECKO_7283,
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            2 -> npc(FaceAnim.CHILD_NORMAL, "Gecko! Gronk gronk.", "(It's hard to keep up with you!)").also {
                stage = END_DIALOGUE
            }
