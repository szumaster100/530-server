...
class PenguinDialogue(player: Player? = null) : Dialogue(player) {
    ...
    private val babyPenguin = intArrayOf(
        NPCs.BABY_PENGUIN_6908,
        NPCs.BABY_PENGUIN_7313,
        NPCs.BABY_PENGUIN_7316
    )
    private val adultPenguin = intArrayOf(
        NPCs.PENGUIN_6909,
        NPCs.PENGUIN_6910,
        NPCs.PENGUIN_7314,
        NPCs.PENGUIN_7315,
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when ((0..3).random()) {
            ...
            2 -> npc(FaceAnim.CHILD_NORMAL, "Awwk...", "(I'm much too warm here...)").also { stage = 6 }
                ...
                if (inZone(player, "snow") || inBorders(player, getRegionBorders(11830)) || inBorders(
                        player,
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            7 -> npc(FaceAnim.CHILD_NORMAL, "Awk! Awkawk awk awk. (Yay! Don't be too long.)").also {
                stage = END_DIALOGUE
            }
