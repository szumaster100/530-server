...
class ClockmakingSpace : OptionHandler() {
    ...
    internal enum class Craftable(val itemId: Int, val craftingLevel: Int, vararg materials: Item) {
        ...
        TOY_SOLDIER(itemId = Items.TOY_SOLDIER_7759, craftingLevel = 13, BuildingUtils.PLANK, Item(Items.CLOCKWORK_8792)),
    ...
    override fun handle(player: Player, node: Node, option: String): Boolean {
        ...
        player.dialogueInterpreter.open(DialogueInterpreter.getDialogueKey(GameAttributes.CON_CLOCKMAKER_DIAL), node.asScenery())
        return true
    }
    ...
    private inner class ClockmakerBenchDialogue : Dialogue {
        ...
        override fun open(vararg args: Any): Boolean {
            ...
            if (decoration != null) {
                when (decoration) {
                    Decoration.CRAFTING_TABLE_1 -> sendDialogueOptions(
                        player,
                        "Select an Option",
                        "Toy Horsey",
                        "Nevermind"
                    ...
                    Decoration.CRAFTING_TABLE_2 -> sendDialogueOptions(
                        player,
                        "Select an Option",
                        "Toy Horsey",
                        "Clockwork Mechanism"
                    ...
                    Decoration.CRAFTING_TABLE_3 -> sendDialogueOptions(
                        player,
                        "Select an Option",
                        "Toy Horsey",
                        "Clockwork Mechanism",
                    ...
                    Decoration.CRAFTING_TABLE_4 -> sendDialogueOptions(
                        player,
                        "Select an Option",
                        "Toy Horsey",
                        "Clockwork Mechanism",
