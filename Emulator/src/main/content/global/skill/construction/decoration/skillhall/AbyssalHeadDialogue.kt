...
class AbyssalHeadDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            12 -> npc(FaceAnim.CHILD_FRIENDLY, "Poor deluded fool. There is no hope for you at all.").also {
                stage = END_DIALOGUE
            }
            ...
            15 -> when (buttonID) {
                ...
                2 -> player(FaceAnim.HALF_GUILTY, "I suppose fear does heighten the senses.").also {
                    stage = 17
                }
            }
