...
class HeraldrySpace : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(
            ...
            ), IntType.SCENERY, "make-helmet", "use"
        ) { player, node ->
            ...
            if(crest == null) {
                sendMessage(player, "You need to set your family crest before you can use the ${getSceneryName(node.id).lowercase()}.")
                return@on true
            }
                ...
                override fun handle(componentID: Int, buttonID: Int) {
                    ...
                    when (stage) {
                        0 -> {
                            ...
                            sendDialogueOptions(
                                player, "What do you want to make?", *when (sceneryID) {
                                    // Pluming stand.
                                    13716 -> arrayOf("Steel helmet", "Runite helmet")
                                    // Shield easel.
                                    13717 -> arrayOf("Steel helmet", "Runite helmet", "Steel heraldic shield", "Runite heraldic shield")
                                    // Banner easel.
                                    else -> arrayOf("Steel helmet", "Runite helmet", "Steel heraldic shield", "Runite heraldic shield", "Heraldic banner")
                                }
                            )
                            stage++
                        }
                        ...
                        1 -> {
                            ...
                            lock(player, 1)
                            val (itemID, animationID, productID) = when (buttonID) {
                                // Steel full helms.
                                1 -> Triple(
                            ...
                            if (buttonID == 5 && (!inInventory(player, Items.BOLT_OF_CLOTH_8790) && !inInventory(player, Items.PLANK_960))) {
                            ...
                            runTask(player, 3) {
                                ...
                                rewardXP(
                                    player, Skills.CRAFTING, when (productID) {
                                        in 8746..8776 -> 40.0
                                        in 8714..8744 -> 42.5
                                        else -> 37.0
                                    }
