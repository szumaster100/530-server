...
class LecternPlugin : OptionHandler() {
    private enum class TeleTabButton(
        ...
        ARDOUGNE(2, 51, 61.0, Item(TeleportTablet.ADDOUGNE_TELEPORT.item), arrayOf(Decoration.TEAK_EAGLE_LECTERN, Decoration.MAHOGANY_EAGLE_LECTERN), SOFT_CLAY, Item(Items.LAW_RUNE_563, 2), Item(Items.WATER_RUNE_555, 2)),
