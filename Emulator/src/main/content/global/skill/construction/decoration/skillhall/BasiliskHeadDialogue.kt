...
class BasiliskHeadDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            24 -> when (buttonID) {
                1 -> playerl(FaceAnim.FRIENDLY, "That's why I won't do it again! There's be no point!").also {
                    stage = 15
                }
            ...
            29 -> npcl(FaceAnim.CHILD_FRIENDLY, "All right then. Apology accepted. Now leave me alone.").also {
                stage = END_DIALOGUE
            }
