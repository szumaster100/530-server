...
class CockatriceHeadDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            10 -> npcl(FaceAnim.CHILD_FRIENDLY, "I don't care! I think I looked better with a body!").also {
                stage = END_DIALOGUE
            }
            ...
            100 -> npc(FaceAnim.CHILD_FRIENDLY, "House owner deaded me! That wasn't very nice!").also {
                stage = END_DIALOGUE
            }
        }
    }
