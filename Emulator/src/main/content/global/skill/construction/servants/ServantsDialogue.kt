...
class ServantDemonButlerDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(
                FaceAnim.OLD_NORMAL,
                DARK_BLUE + "I have learned my trade under the leash of some of the harshest masters of the Demon Dimensions."
            ).also { stage++ }

            2 -> npcl(
                FaceAnim.OLD_NORMAL,
                DARK_BLUE + "I can cook to satisfy the most infernal stomachs, and fly on wings of flame to deposit thine items in the bank or bring planks from the sawmill in seconds."
            ).also { stage++ }
