...
enum class Pickpocket(
    ...
    MAN(intArrayOf(NPCs.MAN_1, NPCs.MAN_2, NPCs.MAN_3, NPCs.WOMAN_4, NPCs.WOMAN_5, NPCs.WOMAN_6, NPCs.MAN_16, NPCs.MAN_24, NPCs.WOMAN_25, NPCs.MAN_170, NPCs.MAN_1086, NPCs.MAN_2675, NPCs.MAN_3224, NPCs.MAN_3225, NPCs.WOMAN_3227, NPCs.MAN_5923, NPCs.WOMAN_5924, NPCs.MAN_7873, NPCs.MAN_7874, NPCs.MAN_7875, NPCs.MAN_7876, NPCs.MAN_7877, NPCs.MAN_7878, NPCs.MAN_7879, NPCs.WOMAN_7880, NPCs.WOMAN_7881, NPCs.WOMAN_7882, NPCs.WOMAN_7883, NPCs.WOMAN_7884, NPCs.WOMAN_7925), 1, 180.0, 240.0, 8.0, 1, 1, 5, "What do you think you're doing?", WeightBasedTable.create(WeightedItem(Items.COINS_995, 3, 3, 1.0, true))),
    ...
    companion object {
        val idMap: Int2ObjectMap<Pickpocket> = Int2ObjectOpenHashMap(Pickpocket.values().size * 5)

        init {
            Pickpocket.values().forEach {
                it.ids.forEach { id ->
                    idMap[id] = it
                }
            }
