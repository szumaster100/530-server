...
enum class Stall(
    ...
    BAKER_STALL(
        full = arrayOf(org.rs.consts.Scenery.BAKER_S_STALL_2561, org.rs.consts.Scenery.BAKERY_STALL_6163, org.rs.consts.Scenery.BAKER_S_STALL_34384),
        empty = arrayOf(org.rs.consts.Scenery.MARKET_STALL_634, org.rs.consts.Scenery.MARKET_STALL_6984, org.rs.consts.Scenery.MARKET_STALL_34381),
        level = 5,
    ...
    FUR_STALL(
        full = arrayOf(org.rs.consts.Scenery.FUR_STALL_34387, org.rs.consts.Scenery.FUR_STALL_2563, org.rs.consts.Scenery.FUR_STALL_4278),
        empty = arrayOf(org.rs.consts.Scenery.MARKET_STALL_34381, org.rs.consts.Scenery.MARKET_STALL_634, org.rs.consts.Scenery.MARKET_STALL_634),
        level = 35,
    ...
    FISH_STALL(
        full = arrayOf(org.rs.consts.Scenery.FISH_STALL_4277, org.rs.consts.Scenery.FISH_STALL_4705, org.rs.consts.Scenery.FISH_STALL_4707),
        empty = arrayOf(org.rs.consts.Scenery.MARKET_STALL_634, org.rs.consts.Scenery.MARKET_STALL_634, org.rs.consts.Scenery.MARKET_STALL_634),
        level = 42,
    ...
    GEM_STALL(
        full = arrayOf(org.rs.consts.Scenery.GEM_STALL_2562, org.rs.consts.Scenery.GEM_STALL_6162, org.rs.consts.Scenery.GEM_STALL_34385),
        empty = arrayOf(org.rs.consts.Scenery.MARKET_STALL_634, org.rs.consts.Scenery.MARKET_STALL_6984, org.rs.consts.Scenery.MARKET_STALL_34381),
        level = 75,
        rewards = arrayOf(
    ...
    companion object {
        var idMap: Int2ObjectMap<Stall> = Int2ObjectOpenHashMap(values().size * 5)

        init {
            Stall.values().forEach { entry ->
                entry.fullIDs.forEach { id ->
