    ...
    override fun defineListeners() {
        onCast(LunarSpells.PLANK_MAKE, ITEM) { player, node ->
            requires(
                player,
                86,
                arrayOf(Item(Items.ASTRAL_RUNE_9075, 2), Item(Items.NATURE_RUNE_561, 1), Item(Items.EARTH_RUNE_557, 15))
            )
            ...
            if (amountInInventory(player, Items.COINS_995) < planks.spellPrice() || !removeItem(
                    player,
