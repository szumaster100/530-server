...
class NetTrapSetting : TrapSetting(
    ...
    override fun returnItems(scenery: core.game.node.scenery.Scenery, wrapper: TrapWrapper, type: Int) {
    ...
    override fun buildObject(player: Player, node: Node): core.game.node.scenery.Scenery {
