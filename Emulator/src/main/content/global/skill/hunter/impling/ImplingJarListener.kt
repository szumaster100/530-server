...
class ImplingJarListener : InteractionListener {
    ...
    override fun defineListeners() {
        on(IMPLING_JARS, IntType.ITEM, "loot") { player, node ->
            val jar = node.asItem()
            val loot = ImplingLoot.forId(jar.id)?.roll()?.firstOrNull() ?: return@on false

            if (freeSlots(player) == 0) {
                sendMessage(player, "You'll need to clear some space in your pack before looting the jar.")
                return@on false
            }
            ...
            if (removeItem(player, jar, Container.INVENTORY)) {
                ...
                sendMessage(player, "You break the jar as you try and open it. You throw the shattered remains away.")
            }
...
enum class ImplingLoot(val jarId: Int, val table: WeightBasedTable) {
    ...
    ECLECTIC_IMPLING(
        Items.ECLECTIC_IMPLING_JAR_11248,
        WeightBasedTable.create(
    ...
    NATURE_IMPLING(
        Items.NATURE_IMPLING_JAR_11250,
        WeightBasedTable.create(
    ...
    MAGPIE_IMPLING(
        Items.MAGPIE_IMPLING_JAR_11252,
        WeightBasedTable.create(
    ...
    PIRATE_IMPLING(
        Items.PIRATE_IMPLING_JAR_13337,
        WeightBasedTable.create(
            WeightedItem(Items.PIRATE_BOOTS_7114, 1, 1, 2.0),
            WeightedItem(Items.GOLD_BAR_2358, 15, 15, 1.50),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_7110, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_7122, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_7128, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_7134, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_13358, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_13360, 1, 1, 2.0),
            WeightedItem(Items.STRIPY_PIRATE_SHIRT_13362, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_7116, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_7126, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_7132, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_7138, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_13364, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_13366, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_LEGGINGS_13368, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_BANDANA_7112, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_BANDANA_7124, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_BANDANA_7130, 1, 1, 2.0),
            WeightedItem(Items.PIRATE_BANDANA_7136, 1, 1, 2.0),
            WeightedItem(Items.BANDANA_AND_EYEPATCH_8924, 1, 1, 2.0),
            WeightedItem(Items.BANDANA_AND_EYEPATCH_8926, 1, 1, 2.0),
            WeightedItem(Items.BANDANA_AND_EYEPATCH_8998, 1, 1, 2.0),
            WeightedItem(Items.BANDANA_AND_EYEPATCH_9000, 1, 1, 2.0),
            WeightedItem(Items.PIECES_OF_EIGHT_8951, 1, 3, 1.0),
            WeightedItem(Items.LEFT_EYEPATCH_13355, 1, 1, 2.0),
        ).insertHardClue(1.0)
    ),

    DRAGON_IMPLING(
        Items.DRAGON_IMPLING_JAR_11256,
        WeightBasedTable.create(
