...
class EnchKeyListener : InteractionListener, Commands {
    ...
    private fun activityListener(attribute: String, treasureProvider: (Player) -> Map<Location, Treasure>) {
    ...
    private fun giveRewards(player: Player, rewards: List<Pair<Int, Int>>) {
        rewards.forEach { (item, amount) ->
            addItemOrDrop(player, item, amount)
        }
    }

    private fun finishActivity(player: Player, attribute: String) {
    ...
    private fun makingTreasures(player: Player): Map<Location, Treasure> {
        val initialTreasure = mapOf(
            EnchKeyTreasure.rellekkaTreasure to Treasure(
                listOf(
        ...
        val randomTreasure = mapOf(
            EnchKeyTreasure.ardougneTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.benchTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.gnomeTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.altarTreasure to Treasure(
                listOf(
                    Items.MITHRIL_ORE_448 to 10,
                    Items.IRON_ORE_441 to 15,
            ...
            EnchKeyTreasure.faladorTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.mudskipperTreasure to Treasure(
                listOf(
                    Items.IRON_ORE_441 to 15,
            ...
            EnchKeyTreasure.swampTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.alkharidTreasure to Treasure(
                listOf(
                    Items.PURE_ESSENCE_7937 to 40,
                    Items.MITHRIL_ORE_448 to 10,
            ...
            EnchKeyTreasure.examTreasure to Treasure(
                listOf(
                    Items.PURE_ESSENCE_7937 to 40,
                    Items.IRON_ORE_441 to 15,
            ...
            EnchKeyTreasure.geTreasure to Treasure(
                listOf(
                    Items.PURE_ESSENCE_7937 to 39,
        ...
        val shuffledLocation = randomTreasure.entries.shuffled(Random(player.hashCode()))
    ...
    private fun meetingTreasures(player: Player): Map<Location, Treasure> {
        return mapOf(
            EnchKeyTreasure.gnomeballfieldTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.shantaypassTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.brimhavenTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.wildernessTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.taibwowannaiTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.feldiphillsTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.agilitypyramidTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.banditcampTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.daemonheimTreasure to Treasure(
                listOf(
                    Items.COINS_995 to 950,
            ...
            EnchKeyTreasure.deathplateauTreasure to Treasure(
                listOf(
            ...
            EnchKeyTreasure.scorpionPitTreasure to Treasure(
                listOf(
    ...
    override fun defineCommands() {
        define(
            ...
            val message = treasures.entries.mapIndexed { index, (location, treasure) ->
                val status = if (index < progress) core.tools.GREEN + "COMPLETED" else core.tools.RED + "PENDING"
