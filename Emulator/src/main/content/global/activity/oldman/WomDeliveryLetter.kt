...
object WomDeliveryLetter {
    ...
    fun getLetterContent(player: Player, npc: Int) {
        ...
        when (test.random()) {
            ...
            NPCs.ABBOT_LANGLEY_801 -> ScrollInterface.scrollSetup(
                player,
            ...
            NPCs.HIGH_PRIEST_216 -> ScrollInterface.scrollSetup(
                player,
                Components.MESSAGESCROLL_220,
                HIGH_PRIEST_LETTER_CONTENT
            )

            NPCs.FATHER_LAWRENCE_640 -> ScrollInterface.scrollSetup(
                player,
                Components.MESSAGESCROLL_220,
                FR_LAWRENCE_LETTER_CONTENT
            )

            NPCs.FATHER_AERECK_456 -> ScrollInterface.scrollSetup(
                player,
                Components.MESSAGESCROLL_220,
