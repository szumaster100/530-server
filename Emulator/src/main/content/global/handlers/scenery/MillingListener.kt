...
class MillingListener : InteractionListener {
    ...
    companion object {
        ...
        private val HOPPERS =
            intArrayOf(Scenery.HOPPER_36881, Scenery.HOPPER_2717, Scenery.HOPPER_24071, Scenery.HOPPER_2716, Scenery.HOPPER_22422)
        private val HOPPER_CONTROLS = intArrayOf(
        ...
        private val FLOUR_BINS = intArrayOf(
    ...
    private fun fillHopper(player: Player, used: Item) {
        ...
        sendMessage(
            player,
            "There is already " + getItemName(getAttribute(player, "milling:hopper", 0)).lowercase() + " in the hopper."
        )
    }
        ...
        if (removeItem(player, EMPTY_POT)) {
            ...
            if (getAttribute(player, "milling:sweetcorn", 0) > 0) {
                ...
                sendMessage(
                    ...
                    ) "You fill a pot with cornflour from the bin." else "You fill a pot with the last of the cornflour in the bin."
                )
                ...
                sendMessage(
                    ...
                    ) "You fill a pot with flour from the bin." else "You fill a pot with the last of the flour in the bin."
                )
            }
