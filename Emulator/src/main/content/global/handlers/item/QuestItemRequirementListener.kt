...
class QuestItemRequirementListener : InteractionListener {
    ...
    private val fremennikIslesEquipment = intArrayOf(
        Items.HELM_OF_NEITIZNOT_10828,
        Items.HELM_OF_NEITIZNOT_E_12680,
        Items.HELM_OF_NEITIZNOT_CHARGED_12681
    )
    ...
    private val fremennikIslesDuringQuestEquipment = intArrayOf(
        Items.YAK_HIDE_ARMOUR_10822,
        Items.YAK_HIDE_ARMOUR_10824,
        Items.FREMENNIK_ROUND_SHIELD_10826
    )
