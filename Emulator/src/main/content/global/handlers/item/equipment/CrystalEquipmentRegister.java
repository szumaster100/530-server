...
public class CrystalEquipmentRegister implements StartupListener {
    ...
    @Override
    public void startup() {
        Integer[] shieldWrapper = convertToIntegerArray(shield);
        Integer[] bowWrapper = convertToIntegerArray(bow);

        EquipmentDegrade.StaticDegrade.registerSet(250, shieldWrapper);
        EquipmentDegrade.StaticDegrade.registerSet(250, bowWrapper);
    }
}
