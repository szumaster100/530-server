                        ...
                        when (stage) {
                                ...
                                3 -> {
                                    if (inEquipmentOrInventory(player, Items.FREMENNIK_SEA_BOOTS_1_14571)) {
                                        ...
                                        sendItemDialogue(
                                            player,
                                            Items.LYRE_3689,
                                            "Your lyre currently teleports you to " + if (getAttribute(
                                                    player,
                                                    LyreTeleport.LYRE_TELEPORT_ALT,
                                                    false
                                                )
                                            ) "Waterbirth Island." else "Relleka."
                                        )
                                        stage = 13
                                    }
                                }
                            ...
                            6 -> when (buttonID) {
                                1 -> {
                                    ...
                                    if (inInventory(player, Items.RAW_BASS_363) && inEquipmentOrInventory(
                                            player,
                                    ...
                                    if (hasAnItem(player, *enchantedLyre).container == player.inventory) {
                                        ...
                                        stage = 0
                                    } else if (inInventory(player, Items.RAW_SHARK_383) && hasAnItem(
                                            player,
                                            Items.ENCHANTED_LYRE_3690
                                        ).container == player.inventory && removeItem(
                                            player,
                                            Items.ENCHANTED_LYRE_3690,
                                            Container.INVENTORY
                            ...
                            7 -> player.dialogueInterpreter.sendItemMessage(
                                Items.FREMENNIK_SEA_BOOTS_1_14571,
