...
enum class Warnings(
    ...
    DAGANNOTH_KINGS_LADDER(3851, Components.CWS_WARNING_4_579, 50),
    LUMBRIDGE_SWAMP_CAVE_ROPE(3863, Components.CWS_WARNING_17_570, 51),
    STRONGHOLD_OF_SECURITY_LADDERS(3854, -1, 52),
    FALADOR_MOLE_LAIR(3853, Components.CWS_WARNING_3_568, 53),
    DROPPED_ITEMS_IN_RANDOM_EVENTS(3856, Components.CWS_WARNING_6_566, 54),
    PLAYER_OWNED_HOUSES(3855, Components.CWS_WARNING_5_563, 55),
    CONTACT_DUNGEON_LADDER(3852, Components.CWS_WARNING_2_562, 56),
    ICY_PATH_AREA(3861, Components.CWS_WARNING_1_574, 57),
    ...
    WILDERNESS_DITCH(3857, Components.WILDERNESS_WARNING_382, 67),
    ...
    RANGING_GUILD(3871, Components.CWS_WARNING_23_564, 70),
    DEATH_PLATEAU(3872, Components.CWS_WARNING_24_581, 71),
    GOD_WARS(3946, Components.CWS_WARNING_25_600, 72),
