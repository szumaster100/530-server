        ...
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when ((0..5).random()) {
                ...
                1 -> when (stage) {
                    ...
                    6 -> playerl(FaceAnim.FRIENDLY, "Wow! I wish I could witness that!").also { stage = END_DIALOGUE }
                }
                ...
                5 -> when (stage) {
                    ...
                    3 -> npcl(FaceAnim.FRIENDLY, "Well, I'm trying to fight TzTok-Jad at the moment.").also { stage++ }
                    ...
                    7 -> npcl(FaceAnim.FRIENDLY, "Thanks. Arghhhh, death to you, foul beast!").also {
                        stage = END_DIALOGUE
                    }
                }
            }
    ...
    class GeneralWartface : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when (stage) {
                ...
                7 -> npcl(
                    FaceAnim.CHILD_NORMAL,
                    "Bentnoze, " + (if (player!!.isMale) "he" else "she") + " is here! I hear " + (if (player!!.isMale) "him" else "her") + " in head!"
                ).also { stage++ }
        ...
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when ((0..1).random()) {
                0 -> when (stage) {
                    ...
                    2 -> playerl(FaceAnim.FRIENDLY, "Err, maybe I'll call back later.").also { stage = END_DIALOGUE }
                }
                ...
                1 -> when (stage) {
                    ...
                    7 -> npcl(FaceAnim.CHILD_NORMAL, "The sardine is leaving the tin?").also { stage = END_DIALOGUE }
                }
            }
        }
    }
    ...
    class MyArm : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when (stage) {
                ...
                5 -> player("Now that's the most weird conversation I've", "had in a long time.").also {
                    stage = END_DIALOGUE
                }
            }
        }
    ...
    class Osman : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when (stage) {
                ...
                3 -> npcl(FaceAnim.FRIENDLY, "Ahh, I'm hallucinating! Must cut back on sq'irks!").also {
                    stage = END_DIALOGUE
                }
            }
        }
