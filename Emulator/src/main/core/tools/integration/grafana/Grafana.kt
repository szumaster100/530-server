            ...
            currentTask = db.runAsync {
                ...
                with(it.prepareStatement(INSERT_TICK_MEAS)) {
                    for (i in 0 until 50) {
                        ...
                        setInt(
                            7,
                            cycleData[i].totalTickTime - (cycleData[i].botPulseTime + cycleData[i].otherPulseTime + cycleData[i].npcTickTime + cycleData[i].playerTickTime + cycleData[i].playerRenderTime + cycleData[i].packetProcessTime)
                        )
