...
object StringUtils {
    ...
    @JvmStatic
    private val anIntArray241 = intArrayOf(
    ...
    fun isPlusN(word: String?): Boolean {
        ...
        return s[0] == 'a' || s[0] == 'e' || s[0] == 'i' || s[0] == 'o' || s[0] == 'u' || (s[0] == 'h' && s.length > 1 && s[1] != 'e')
    }
    ...
    fun getPlayerNameLong(s: String): Long {
        ...
        while (i < s.length && i < 12) {
            val c = s[i]
            l *= 37L
            if (c >= 'A' && c <= 'Z') l += ((1 + c.code) - 65).toLong()
            else if (c >= 'a' && c <= 'z') l += ((1 + c.code) - 97).toLong()
            else if (c >= '0' && c <= '9') l += ((27 + c.code) - 48).toLong()
            i++
        }
    ...
    private fun getByte(c: Char): Byte {
        val charByte = if (c.code > 0 && c < '\u0080' || c >= '\u00a0' && c <= '\u00ff') c.code.toByte()
        else if (c != '\u20AC') {
            if (c != '\u201A') {
                if (c != '\u0192') {
                    if (c == '\u201E') -124
    ...
    @JvmStatic
    private val anIntArray233 = intArrayOf(
    ...
    @JvmStatic
    private val aByteArray235 = byteArrayOf(
    ...
    fun reducedMapping(x: Int): Long {
        var out: Long = -1
        if (x >= 97 && x <= 122) out = (x - 96).toLong()
        else if (x >= 65 && x <= 90) out = (x - 37).toLong()
        else if (x >= 48 && x <= 57) out = (x - +5).toLong()
        else if (x == 32) out = 63L
        return out
    }
    ...
    @JvmStatic
    fun decryptPlayerChat(buffer: IoBuffer, totalChars: Int): String {
        try {
            ...
            while (true) {
                ...
                if (((i_7_.toInt() and 0x40) xor -0x1) != -1) i_4_ = anIntArray241[i_4_]
                else i_4_++
                if ((anIntArray241[i_4_].also { i_8_ = it }) < 0) {
                    s += Char((i_8_ xor -0x1).toByte().toUShort())
                ...
                if (((0x10 and i_7_.toInt()) xor -0x1) == -1) i_4_++
                else i_4_ = anIntArray241[i_4_]
                if ((anIntArray241[i_4_].also { i_8_ = it }) < 0) {
                    s += Char((i_8_ xor -0x1).toByte().toUShort())
                    if (totalChars <= ++charsDecoded) break
                ...
                if (((0x8 and i_7_.toInt()) xor -0x1) != -1) i_4_ = anIntArray241[i_4_]
                else i_4_++
                if ((anIntArray241[i_4_].also { i_8_ = it }) < 0) {
                    s += Char((i_8_ xor -0x1).toByte().toUShort())
                    if (++charsDecoded >= totalChars) break
                ...
                if (((i_7_.toInt() and 0x2) xor -0x1) != -1) i_4_ = anIntArray241[i_4_]
                else i_4_++
                if ((anIntArray241[i_4_].also { i_8_ = it }) < 0) {
                    s += Char((i_8_ xor -0x1).toByte().toUShort())
                    if (totalChars <= ++charsDecoded) break
                ...
                if (((i_7_.toInt() and 0x1) xor -0x1) != -1) i_4_ = anIntArray241[i_4_]
                else i_4_++
                if ((anIntArray241[i_4_].also { i_8_ = it }) < 0) {
                    s += Char((i_8_ xor -0x1).toByte().toUShort())
                    if (++charsDecoded >= totalChars) break
