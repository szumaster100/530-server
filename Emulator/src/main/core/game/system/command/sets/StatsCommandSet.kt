...
val SPIRITUAL_MAGE_IDS =
    intArrayOf(NPCs.SPIRITUAL_MAGE_6221, NPCs.SPIRITUAL_MAGE_6231, NPCs.SPIRITUAL_MAGE_6257, NPCs.SPIRITUAL_MAGE_6278)
val GREEN_DRAGON_IDS =
    intArrayOf(
    ...
    companion object {
        ...
        private fun display(
            ...
            BookInterface.pageSetup(
                player,
                BookInterface.FANCY_BOOK_26,
                queryPlayer.username + "'s Stats",
                FAKE_CONTENT,
            )
                    ...
                    1 -> {
                        when (i) {
                            ...
                            69 ->
                                sendLine(
                                    player,
                                    "Leaf-bladed swords: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            71 ->
                                sendLine(
                                    player,
                                    "Gargoyles: ${GlobalKillCounter.getKills(queryPlayer, GARGOYLE_IDS)}",
                                    i,
                                )
                            72 ->
                                sendLine(
                                    player,
                                    "Granite mauls: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            74 ->
                                sendLine(
                                    player,
                                    "Spiritual mages: ${GlobalKillCounter.getKills(queryPlayer, SPIRITUAL_MAGE_IDS)}",
                                    i,
                                )
                            75 ->
                                sendLine(
                                    player,
                                    "Dragon boots: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            77 ->
                                sendLine(
                                    player,
                                    "Abyssal demons: ${GlobalKillCounter.getKills(
                                        queryPlayer,
                            ...
                            78 ->
                                sendLine(
                                    player,
                                    "Abyssal whips: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            80 ->
                                sendLine(
                                    player,
                                    "Dark beasts: ${GlobalKillCounter.getKills(queryPlayer, NPCs.DARK_BEAST_2783)}",
                                    i,
                                )
                            81 ->
                                sendLine(
                                    player,
                                    "Dark bows: ${GlobalKillCounter.getRareDrops(queryPlayer, Items.DARK_BOW_11235)}",
                                    i,
                                )
                            ...
                            82 ->
                                sendLine(
                                    player,
                                    "Green Dragons: ${GlobalKillCounter.getKills(queryPlayer, GREEN_DRAGON_IDS)}",
                                    i,
                                )
                            83 ->
                                sendLine(
                                    player,
                                    "Blue Dragons: ${GlobalKillCounter.getKills(queryPlayer, BLUE_DRAGON_IDS)}",
                                    i,
                                )
                            84 ->
                                sendLine(
                                    player,
                                    "Red Dragons: ${GlobalKillCounter.getKills(queryPlayer, RED_DRAGON_IDS)}",
                                    i,
                                )
                            85 ->
                                sendLine(
                                    player,
                                    "Black Dragons: ${GlobalKillCounter.getKills(queryPlayer, BLACK_DRAGON_IDS)}",
                                    i,
                                )
                            ...
                            87 ->
                                sendLine(
                                    player,
                                    "Bronze Dragons: ${GlobalKillCounter.getKills(queryPlayer, BRONZE_DRAGON_IDS)}",
                                    i,
                                )
                            88 ->
                                sendLine(
                                    player,
                                    "Iron Dragons: ${GlobalKillCounter.getKills(queryPlayer, IRON_DRAGON_IDS)}",
                                    i,
                                )
                            89 ->
                                sendLine(
                                    player,
                                    "Steel Dragons: ${GlobalKillCounter.getKills(queryPlayer, STEEL_DRAGON_IDS)}",
                                    i,
                                )
                            90 ->
                                sendLine(
                                    player,
                                    "Mithril Dragons: ${GlobalKillCounter.getKills(queryPlayer, MITHRIL_DRAGON_IDS)}",
                                    i,
                                )
                            91 ->
                                sendLine(
                                    player,
                                    "Skeletal Wyverns: ${GlobalKillCounter.getKills(queryPlayer, SKELETAL_WYVERN_IDS)}",
                                    i,
                                )
                            ...
                            93 ->
                                sendLine(
                                    player,
                                    "Draconic visages: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                    ...
                    2 -> {
                        when (i) {
                            97 ->
                                sendLine(
                                    player,
                                    "Ahrim's hood: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            68 ->
                                sendLine(
                                    player,
                                    "Ahrim's staff: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            69 ->
                                sendLine(
                                    player,
                                    "Ahrim's robetop: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            70 ->
                                sendLine(
                                    player,
                                    "Ahrim's robeskirt: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            72 ->
                                sendLine(
                                    player,
                                    "Dharok's helm: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            73 ->
                                sendLine(
                                    player,
                                    "Dharok's greataxe: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            74 ->
                                sendLine(
                                    player,
                                    "Dharok's platebody: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            75 ->
                                sendLine(
                                    player,
                                    "Dharok's platelegs: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            77 ->
                                sendLine(
                                    player,
                                    "Guthan's helm: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            78 ->
                                sendLine(
                                    player,
                                    "Guthan's warspear: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            79 ->
                                sendLine(
                                    player,
                                    "Guthan's platebody: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            80 ->
                                sendLine(
                                    player,
                                    "Guthan's chainskirt: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            82 ->
                                sendLine(
                                    player,
                                    "Karil's coif: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            83 ->
                                sendLine(
                                    player,
                                    "Karil's crossbow: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            84 ->
                                sendLine(
                                    player,
                                    "Karil's leathertop: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            85 ->
                                sendLine(
                                    player,
                                    "Karil's leatherskirt: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            87 ->
                                sendLine(
                                    player,
                                    "Torag's helm: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            88 ->
                                sendLine(
                                    player,
                                    "Torag's hammers: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            89 ->
                                sendLine(
                                    player,
                                    "Torag's platebody: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            90 ->
                                sendLine(
                                    player,
                                    "Torag's platelegs: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            92 ->
                                sendLine(
                                    player,
                                    "Verac's helm: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            93 ->
                                sendLine(
                                    player,
                                    "Verac's flail: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            94 ->
                                sendLine(
                                    player,
                                    "Verac's brassard: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
                            ...
                            95 ->
                                sendLine(
                                    player,
                                    "Verac's plateskirt: ${GlobalKillCounter.getRareDrops(
                                        queryPlayer,
