...
class ItemKitsCommandSet : CommandSet(Privilege.ADMIN) {
    ...
    override fun defineCommands() {
        ...
        define(name = "runekit", privilege = Privilege.ADMIN, usage = "::runekit", description = "Gives 1k of each Rune type.") { player, _ ->
        ...
        define(name = "spinningkit", privilege = Privilege.ADMIN, usage = "::spinningkit", description = "Spinning items.") { player, _ ->
        ...
        define(name = "summoningkit", privilege = Privilege.ADMIN, usage = "::orekit", description = "Ores.") { player, _ ->
