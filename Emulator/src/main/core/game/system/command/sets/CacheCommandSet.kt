...
class CacheCommandSet : CommandSet(Privilege.ADMIN) {
    ...
    override fun defineCommands() {
        ...
        define(name = "dumpsprite", privilege = Privilege.ADMIN, usage = "::dumpsprite [spriteId] [outputDir]", description = "Dumps sprite data to .txt and .png.") { p, args ->
            /*
             * Unused.
             */
            return@define
        ...
        define(name = "writesprite", privilege = Privilege.ADMIN, usage = "::writesprite [spriteId] [directory] [name]", description = "Writes sprite data to .png.") { p, args ->
            /*
             * Unused.
             */
            return@define
        ...
        define(name = "dumpidk", privilege = Privilege.ADMIN, usage = "::dumpidk", description = "Dumps identity kits data to a .json file.") { p, _ ->
        ...
        define(name = "dumpitems", privilege = Privilege.ADMIN, usage = "::dumpitems", description = "Dumps item definitions data to a .json file.") { p, _ ->
            val gson = GsonBuilder().setPrettyPrinting().create()
        ...
        define(name = "dumpcs2", privilege = Privilege.ADMIN, usage = "::dumpcs2", description = "Dumps CS2 mapping data to a .csv file.") { p, _ ->
        ...
        define(name = "dumpstructs", privilege = Privilege.ADMIN, usage = "::dumpstructs", description = "Dumps structs data to a .json file.") { player, _ ->
            try {
        ...
        define(name = "dumpdatamaps", privilege = Privilege.ADMIN, usage = "::dumpdatamaps", description = "Dumps data maps configurations to a .json file.") { player, _ ->
            ...
            containers.forEach { cID ->
                ...
                fileIndexes.forEach { fID ->
                    ...
                    file?.let {
                        ...
                        dataMap["valueType"] = when (def.valueType) {
                            'K' -> "Normal"
                            'J' -> "Struct Pointer"
                            else -> "Unknown"
                        }
        ...
        define(name = "dumpnpcs", privilege = Privilege.ADMIN, usage = "::dumpnpcs", description = "Dumps NPC definitions data to a .json file.") { p, _ ->
