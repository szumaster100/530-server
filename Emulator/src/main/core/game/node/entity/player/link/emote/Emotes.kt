...
enum class Emotes(val buttonId: Int, val animation: Int? = -1, val graphics: Int? = -1, val lockedMessage: String? = null) {
    ...
    BECKON(buttonId = 10, animation = Animations.BECKON_864) {
        override fun play(player: Player) {
            ...
            when {
                ...
                anyInEquipment(player, Items.HARD_HAT_10862, Items.BUILDERS_SHIRT_10863, Items.BUILDERS_TROUSERS_10864, Items.BUILDERS_BOOTS_10865, Items.PLAIN_SATCHEL_10877, Items.GREEN_SATCHEL_10878, Items.RED_SATCHEL_10879, Items.BLACK_SATCHEL_10880, Items.GOLD_SATCHEL_10881, Items.RUNE_SATCHEL_10882) -> forceEmote(player, Animations.EMOTE_BECKON_5845, -1)
            ...
            submitWorldPulse(
                object : Pulse(1, player) {
                    ...
                    override fun pulse(): Boolean {
                        when (counter++) {
                            1 -> forceEmote(player, Animations.GIVE_THANKS_BEGIN_10994, org.rs.consts.Graphics.RANDOM_EVENT_PUFF_OF_SMOKE_86)
                            3 -> player.appearance.transformNPC(NPCs.THANKSGIVING_TURKEY_8499).also { forceEmote(player, Animations.HUMAN_TURKEY_DANCE_10996, -1) }
                            13 -> player.appearance.transformNPC(NPCs.TURKEY_8501)
                            16 -> player.appearance.transformNPC(-1).also { forceEmote(player, Animations.GIVE_THANKS_END_10995, org.rs.consts.Graphics.RANDOM_EVENT_PUFF_OF_SMOKE_86) }
                        }
                        return false
                    }
                }
    ...
    companion object {
        private val SKILLCAPE_INFO = arrayOf(
            intArrayOf(Items.ATTACK_CAPE_9747, Items.ATTACK_CAPET_9748, org.rs.consts.Graphics.ATTACK_SKILLCAPE_823, 4959),
            intArrayOf(Items.STRENGTH_CAPE_9750, Items.STRENGTH_CAPET_9751, org.rs.consts.Graphics.STRENGTH_SKILLCAPE_828, 4981),
            intArrayOf(Items.DEFENCE_CAPE_9753, Items.DEFENCE_CAPET_9754, org.rs.consts.Graphics.DEFENCE_SKILLCAPE_824, 4961),
            intArrayOf(Items.RANGING_CAPE_9756, Items.RANGING_CAPET_9757, org.rs.consts.Graphics.RANGED_SKILLCAPE_832, 4973),
            intArrayOf(Items.PRAYER_CAPE_9759, Items.PRAYER_CAPET_9760, org.rs.consts.Graphics.PRAYER_SKILLCAPE_829, 4979),
            intArrayOf(Items.MAGIC_CAPE_9762, Items.MAGIC_CAPET_9763, org.rs.consts.Graphics.MAGIC_SKILLCAPE_813, 4939),
            intArrayOf(Items.RUNECRAFT_CAPE_9765, Items.RUNECRAFT_CAPET_9766, org.rs.consts.Graphics.RC_SKILLCAPE_817, 4947),
            intArrayOf(Items.HITPOINTS_CAPE_9768, Items.HITPOINTS_CAPET_9769, org.rs.consts.Graphics.HP_SKILLCAPE_MALE_833, 4971),
            intArrayOf(Items.AGILITY_CAPE_9771, Items.AGILITY_CAPET_9772, org.rs.consts.Graphics.AGILITY_SKILLCAPE_830, 4977),
            intArrayOf(Items.HERBLORE_CAPE_9774, Items.HERBLORE_CAPET_9775, org.rs.consts.Graphics.HERBLORE_SKILLCAPE_835, 4969),
            intArrayOf(Items.THIEVING_CAPE_9777, Items.THIEVING_CAPET_9778, org.rs.consts.Graphics.THIEVING_SKILLCAPE_826, 4965),
            intArrayOf(Items.CRAFTING_CAPE_9780, Items.CRAFTING_CAPET_9781, org.rs.consts.Graphics.CRAFTING_SKILLCAPE_818, 4949),
            intArrayOf(Items.FLETCHING_CAPE_9783, Items.FLETCHING_CAPET_9784, org.rs.consts.Graphics.FLETCHING_SKILLCAPE_812, 4937),
            intArrayOf(Items.SLAYER_CAPE_9786, Items.SLAYER_CAPET_9787, org.rs.consts.Graphics.SLAYER_ACCOMPLISHMENT_CAPE_1656, 4967),
            intArrayOf(Items.CONSTRUCT_CAPE_9789, Items.CONSTRUCT_CAPET_9790, org.rs.consts.Graphics.CON_SKILLCAPE_820, 4953),
            intArrayOf(Items.MINING_CAPE_9792, Items.MINING_CAPET_9793, org.rs.consts.Graphics.MINING_SKILLCAPE_814, 4941),
            intArrayOf(Items.SMITHING_CAPE_9795, Items.SMITHING_CAPET_9796, org.rs.consts.Graphics.SMITHING_SKILLCAPE_815, 4943),
            intArrayOf(Items.FISHING_CAPE_9798, Items.FISHING_CAPET_9799, org.rs.consts.Graphics.FISHING_SKILLCAPE_819, 4951),
            intArrayOf(Items.COOKING_CAPE_9801, Items.COOKING_CAPET_9802, org.rs.consts.Graphics.COOKING_SKILLCAPE_821, 4955),
            intArrayOf(Items.FIREMAKING_CAPE_9804, Items.FIREMAKING_CAPET_9805, org.rs.consts.Graphics.FIREMAKING_SKILLCAPE_831, 4975),
            intArrayOf(Items.WOODCUTTING_CAPE_9807, Items.WOODCUT_CAPET_9808, org.rs.consts.Graphics.WC_SKILLCAPE_822, 4957),
            intArrayOf(Items.FARMING_CAPE_9810, Items.FARMING_CAPET_9811, org.rs.consts.Graphics.FARMING_SKILLCAPE_825, 4963),
            intArrayOf(Items.SUMMONING_CAPE_12169, Items.SUMMONING_CAPET_12170, org.rs.consts.Graphics.SUMMONING_SKILLCAPE_EMOTE_1515, 8525),
            intArrayOf(Items.QUEST_POINT_CAPE_9813, -1, org.rs.consts.Graphics.QUEST_SKILLCAPE_816, 4945),
            intArrayOf(Items.HUNTER_CAPE_9948, Items.HUNTER_CAPET_9949, org.rs.consts.Graphics.HUNTER_SKILLCAPE_EMOTE_907, 5158)
        )
        ...
        private fun forceEmote(player: Player, animation: Int?, graphic: Int?) {
        ...
        private fun isEligibleForSalute(player: Player): Boolean {
            return !player.achievementDiaryManager.hasCompletedTask(DiaryType.FALADOR, 1, 8) &&
                ...
                player.direction == Direction.SOUTH && anyInEquipment(player, Items.INITIATE_SALLET_5574, Items.INITIATE_HAUBERK_5575, Items.INITIATE_CUISSE_5576)
        }
