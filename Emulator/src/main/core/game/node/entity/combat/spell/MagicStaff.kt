...
enum class MagicStaff(val runeId: Int, vararg val staves: Int) {
    ...
    EARTH_RUNE(Items.EARTH_RUNE_557, Items.LAVA_BATTLESTAFF_3053, Items.MYSTIC_LAVA_STAFF_3054, Items.LAVA_BATTLESTAFF_3055, Items.MYSTIC_LAVA_STAFF_3056, Items.STAFF_OF_EARTH_1385, Items.EARTH_BATTLESTAFF_1399, Items.MYSTIC_EARTH_STAFF_1407, Items.MYSTIC_MUD_STAFF_6563, Items.MUD_BATTLESTAFF_6562);
