...
class DialogueBuilder(var target: DialogueBuilderFile, var clauseIndex: Int = -1) {
    ...
    fun playerl(value: String): DialogueBuilder {
        target.data[clauseIndex].nodes.add(PlayerLNode(FaceAnim.NEUTRAL, value))
        return this
    }
    ...
    fun player(vararg values: String): DialogueBuilder {
        target.data[clauseIndex].nodes.add(PlayerNode(FaceAnim.NEUTRAL, values as Array<String>))
        return this
    }
    ...
    fun npcl(value: String): DialogueBuilder {
        target.data[clauseIndex].nodes.add(NpcLNode(FaceAnim.NEUTRAL, value))
        return this
    }
    ...
    fun npc(vararg values: String): DialogueBuilder {
        target.data[clauseIndex].nodes.add(NpcNode(FaceAnim.NEUTRAL, values as Array<String>))
        return this
    }
