...
class SantaHolidayRandomDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(FaceAnim.HAPPY, "Merry Christmas, ${player!!.username}! Would you like to know if you are on the nice or naughty list?").also { stage = 10 }
            ...
            20 ->
                if (getAttribute(HolidayRandoms.getEventNpc(player!!)!!, "playerisnice", false)) {
                    npcl(FaceAnim.HAPPY, "Let me check my list... ${player!!.username}.. You are on the nice list!").also { stage = 30 }
                } else {
                    npcl(FaceAnim.SAD, "Let me check my list... ${player!!.username}.. You are on the naughty list!").also { stage = 40 }
                }

            30 -> npcl(FaceAnim.HAPPY, "Since you have been a good ${if (player!!.isMale) "boy" else "girl"} this year, you get a gift. Merry Christmas, ${player!!.username}!").also { stage = 31 }
            ...
            40 -> npcl(FaceAnim.NEUTRAL, "If you work on being a good ${if (player!!.isMale) "boy" else "girl"} from now on you will make it on the nice list!").also { stage = 41 }
