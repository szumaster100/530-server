...
public class ItemDefsEditor extends JDialog {
   ...
   private final JTextField modelIDField;
   private final JTextField nameField;
   private final JTextField modelZoomField;
   private final JTextField groundOptionsField;
   private final JTextField inventoryOptionsField;
   private final JTextField femaleModelId2Field;
   private final JTextField maleModelId1Field;
   private final JTextField maleModelId2Field;
   private final JTextField maleModelId3Field;
   private final JTextField femaleModelId1Field;
   private final JTextField femaleModelId3Field;
   private final JTextField teamIdField;
   private final JTextField notedItemIdField;
   private final JTextField switchNotedItemField;
   private final JTextField lendedItemIdField;
   private final JTextField switchLendedItemField;
   private final JTextField changedModelColorsField;
   private final JTextField changedTextureColorsField;
   private final JCheckBox membersOnlyCheck;
   ...
   public void save() {
      ...
      this.defs.cost = Integer.valueOf(this.price.getText()).intValue();
